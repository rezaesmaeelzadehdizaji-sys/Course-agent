...
function buildToesSection() {
  return {
    ...
    children: [
      ...
      para("Pick a bird up, flip it, look at the underside of the foot. The skin should be smooth and yellow. What you are checking for is footpad dermatitis, FPD or pododermatitis if your veterinarian writes it down. It runs from a bit of darkening on the surface to a deep crater that bleeds when you press it. Three scores [26,28]:"),
...
function buildLegsSection() {
  return {
    ...
    children: [
      ...
      para([{text:'Hot, swollen joints in several birds: ', bold:true},{text:"Septic arthritis. Send two or three fresh birds to your veterinarian before it gets through the barn."}]),
...
function buildSkinSection() {
  return {
    ...
    children: [
      ...
      para([{text:'Cyanosis or jaundice in more than a couple of birds: ', bold:true},{text:"Same-day call to your veterinarian. Bag two or three fresh dead birds, chill them, get them off to post-mortem before the weekend."}]),
