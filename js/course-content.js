    ...
    // ====================================================
    {
      ...
      subsections: {
        ...
        whyItMatters: {
          heading: "Why It Matters",
          paragraphs: [
            "Feather condition is directly linked to production efficiency. Feathers are the primary insulating layer for poultry. Birds with compromised feather coverage must expend more metabolic energy maintaining body temperature, reducing feed conversion efficiency. The energetic cost of thermoregulation through bare skin is well established in the literature, though the exact FCR penalty varies with ambient temperature and extent of feather loss [NEEDS SOURCE — specific FCR penalty range requires verification from controlled studies]. (Riber et al., 2018).",
            "In laying hen operations, feather pecking can escalate rapidly from feather damage to cannibalism, resulting in mortality and significant flock-level welfare deterioration. Once blood is drawn at a pecking site, other birds are attracted to the wound, and cannibalism can spread through a flock within hours. Feather pecking is therefore both a welfare indicator and a welfare risk that demands prompt intervention (Decina et al., 2019).",
        ...
        abnormalFindings: {
          ...
          paragraphs: [
            ...
            "Broken or frayed feathers across the flock (bilateral, symmetrical): Suggests ectoparasite pressure — most commonly northern fowl mite (Ornithonyssus sylviarum) in Canada, or red mite (Dermanyssus gallinae) in housing with persistent residual populations. Red mite feeds primarily at night (though it can occasionally feed during daytime when populations are high); inspect cracks, crevices, and perch supports for mite aggregations at night for best detection.",
