...
function buildSection1() {
  return {
    ...
    children: [
      ...
      para('Poultry manure is one of the most nitrogen- and phosphorus-dense organic materials available to Canadian crop farmers [3]. Handled well, it is a genuine asset. A typical broiler litter analysis run on material removed from the barn shows 2.5 to 3.5 percent nitrogen, 2.0 to 3.5 percent phosphorus pentoxide, and 1.8 to 3.0 percent potassium oxide [3]. Applied at the right rate to the right fields at the right time, litter reduces fertilizer costs, improves soil organic matter, and builds long-term soil health.'),
...
function buildSection3() {
  return {
    ...
    children: [
      ...
      para('A 20,000-bird barn running a 6 to 8-week cycle produces roughly 20 to 33 tonnes of litter at whole-house cleanout, depending on litter depth and moisture [3,5]. Send that litter for analysis and you will typically see 2.5 to 3.5 percent total nitrogen, 2.0 to 3.5 percent phosphorus pentoxide, and 1.8 to 3.0 percent potassium oxide [3]. At current fertilizer prices, that is real money for the crop farmer who receives it, and applied properly over time it builds soil rather than depletes it.'),
