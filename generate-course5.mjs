...
function buildSection2() {
  return {
    ...
    children: [
      ...
      bullet([{ text: 'Line pressure: ', bold: true }, { text: 'Maintain nipple drinker line pressure within the range specified by your equipment manufacturer. The CPC Learning Centre Managing the Nipple Drinker Line bulletin explains that most broiler nipple systems are calibrated to deliver water at 10 to 30 centimeters of water column at the nipple, adjusted progressively upward as birds age through the grow-out. Excess pressure causes constant dripping and wet litter; insufficient pressure reduces intake during hot weather [7,21].' }]),
...
function buildSection5() {
  return {
    ...
    children: [
      ...
      para('Commercial poultry barns have large roof areas, often south-facing, that are well-suited to solar panel installation. Under Ontario\'s net metering program and similar programs in other provinces, surplus electricity generated on the farm is credited against the bill at the same rate it would be charged, and farms with larger roof installations have reported significant reductions in monthly electricity costs [18]. The federal Agricultural Clean Technology (ACT) Program provides non-repayable contributions covering up to 50% of eligible project costs for on-farm solar and other renewable energy investments [19].'),
      ...
      ...photo(photoBuf('photo5_1.jpg'), 'Photo 5.1: Solar photovoltaic panels installed on a farm building roof. South-facing barn roofs with adequate structural load capacity are well-suited for commercial solar installations. Under provincial net metering programs, surplus electricity generated on the farm is credited against the hydro bill, and the federal Agricultural Clean Technology Program covers up to 50% of eligible project costs [18,19]. Photo: Robin Stott / geograph.org.uk, CC BY-SA 2.0.', 640, 427),
      pageBreak(),
    ],
  };
}
...
function buildSection6() {
  return {
    ...
    children: [
      ...
      para('Consumer expectations around poultry production are shifting. Organic poultry output in Canada rose 12.7% between 2018 and 2021, and industry reporting consistently identifies demand for ethical and sustainable sourcing as a growth driver in premium chicken segments [20]. Most consumers cannot visit a farm and verify conditions themselves. They rely on the programs and certifications their retailer or processor uses, and those programs increasingly require documented farm-level compliance.'),
