...
function buildSection1() {
  return {
    ...
    children: [
      ...
      para('Ammonia is the most significant air pollutant from commercial poultry operations, and it affects you, your birds, and your neighbors [8]. Inside the barn, 25 ppm is the threshold where welfare effects start. The airway cilia that sweep pathogens out of the respiratory tract slow down and stop working, immune defenses drop, and birds\' eyes and airways become irritated and more vulnerable to infection. You can often smell it before it reaches that level, but the biological effects are already happening. Above 50 ppm, the production losses are direct and measurable: documented studies report body weight reductions of 15 to 20 percent in flocks held at sustained high ammonia levels compared to well-ventilated controls [8]. Chronic low-level exposure is also a health concern for anyone working in the barn every day [8].'),
      para('Outside the barn, ammonia emissions contribute to acid deposition and ecosystem nitrogen loading [8]. Your neighbors will notice odor from your operation before your inspector does. In some regions, community complaints about large poultry operations have pushed regulators to tighten rules on stocking density, manure storage, and application timing.'),
