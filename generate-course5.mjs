...
function buildSection2() {
  return {
    ...
    children: [
      ...
      para('Feed represents 60 to 70 percent of the total cost of broiler production [5]. That single number explains why feed efficiency is the most watched metric in the industry, and why even small improvements in feed conversion ratio (FCR) show up directly in profitability. A 0.1-point improvement in FCR on a 20,000-bird barn at current feed prices represents a meaningful reduction in cost per kilogram of gain.'),
...
function buildSection5() {
  return {
    ...
    children: [
      ...
      para('Commercial poultry barns have large roof areas, often south-facing, that are well-suited to solar panel installation. Under Ontario\'s net metering program and similar programs in other provinces, surplus electricity generated on the farm is credited against the bill at the same rate it would be charged, and farms with larger roof installations have reported significant reductions in monthly electricity costs [18]. The federal Agricultural Clean Technology Program can help pay for on-farm solar and other renewable energy projects, with non-repaid funding that usually covers around forty percent of eligible costs for most farms [19].'),
