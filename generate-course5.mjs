...
function buildIntroSection() {
  return {
    ...
    children: [
      ...
      h2('Course Agenda'),
      bullet('Welcome and Introduction: what sustainability means on a working farm and why it matters for poultry farmers right now.'),
      bullet('Environmental Impact of Poultry Farming: water, soil, and air management, and the common environmental challenges of commercial production.'),
      bullet('Efficient Use of Resources: cutting feed waste, saving water, and getting smarter about energy use on the farm.'),
      bullet('Manure and Waste Management: putting litter to work as fertilizer, reducing odor and pollution, and handling storage safely.'),
      bullet('Animal Welfare and Flock Health: how healthy birds connect to sustainable production, and how housing, ventilation, and stress reduction fit into it.'),
      bullet('Low-Cost Sustainable Solutions: composting and reuse of materials, making better use of natural light and airflow, and the basics of affordable renewable energy.'),
      bullet('Economic Benefits of Sustainability: where the real cost savings show up, how sustainable practices strengthen your market position, and what long-term resilience looks like.'),
      bullet('Farmer Self-Assessment: taking an honest look at your own operation and finding the improvements that will actually make a difference.'),
      bullet('Q and A and Sharing Experiences: your practical challenges and what has actually worked for other farmers.'),
      bullet('Summary and Key Takeaways.'),
...
function buildSection1() {
  return {
    ...
    children: [
      ...
      para('Ammonia is the most significant air pollutant from commercial poultry operations, and it affects you, your birds, and your neighbors [8]. Inside the barn, 25 ppm is the threshold where welfare effects start. The airway cilia that sweep pathogens out of the respiratory tract slow down and stop working, immune defenses are reduced, and birds\' eyes and airways become irritated and more vulnerable to infection. You can often smell it before it reaches that level, but the biological effects are already happening. Above 50 ppm, the production losses are direct and measurable: studies document body weight reductions of 15 to 20 percent in flocks held at that level compared to well-ventilated controls [6,8]. You usually smell ammonia well before it reaches those levels, but chronic low-level exposure in workers is also a health concern over time.'),
...
function buildSection3() {
  return {
    ...
    children: [
      ...
      para('A typical broiler barn running 20,000 birds on a 6 to 8-week cycle will produce approximately 20 to 33 tonnes of litter at whole-house cleanout, depending on litter depth and moisture content [3,5]. Broiler litter removed from the barn and sent for analysis typically shows 2.5 to 3.5 percent total nitrogen, 2.0 to 3.5 percent phosphorus pentoxide, and 1.8 to 3.0 percent potassium oxide [3]. At current synthetic fertilizer prices, properly utilized litter has real agronomic value that reduces fertilizer costs for the fields it goes on and builds long-term soil health.'),
...
function buildSection4() {
  return {
    ...
    children: [
      ...
      bullet([{ text: 'Light management: ', bold: true }, { text: 'Use a slow dimming of the lights at the end of the day so birds can settle down calmly and you see less panicking and piling injuries. Giving them some proper dark time lets them rest, which is good for both bird welfare and growth, and avoiding sudden light changes, especially during catching, helps prevent injuries that hurt carcass quality [4].' }]),
      ...
      ...image(figBuf('fig4_3.png'), 'Figure 4.3: Footpad dermatitis scoring guide based on the Welfare Quality Assessment Protocol. Score 0 (left): healthy, intact tissue with no lesions or only minimal discoloration. Score 1 (center): mild lesion with superficial discoloration and hyperkeratosis. Score 2 (right): severe lesion with epidermal involvement, blood scabs, hemorrhage, and pronounced swelling. Score 2 at the plant signals a litter management failure 2 to 3 weeks prior in the grow-out [6,12].'),
...
function buildSection6() {
  return {
    ...
    children: [
      ...
      para('Consumer expectations around poultry production are shifting. Demand for organic and premium chicken segments has grown consistently, and industry reporting consistently identifies ethical and sustainable sourcing as a key driver in those segments [20]. Most consumers cannot visit a farm and verify conditions themselves. They rely on the programs and certifications their retailer or processor uses, and those programs increasingly require documented farm-level compliance.'),
...
async function main() {
  ...
  const entriesWithAnchor = [
    ...
    { lvl: 2, text: 'Course Agenda',                                             page: 3  },
    { lvl: 2, text: 'Learning Objectives',                                       page: 4  },
    { lvl: 2, text: 'Important Notes',                                           page: 5  },
    { lvl: 1, text: 'Section 1: Environmental Impact of Poultry Farming',        page: 6  },
    { lvl: 2, text: '1.1  Understanding the Environmental Footprint',            page: 6  },
    { lvl: 2, text: '1.2  Water: Use and Contamination Risk',                    page: 6  },
    { lvl: 2, text: '1.3  Soil: Nutrients, Runoff, and Land Management',         page: 7  },
    { lvl: 2, text: '1.4  Air Quality: Ammonia, Dust, and Odor',                 page: 8  },
    { lvl: 1, text: 'Section 2: Efficient Use of Resources',                     page: 9  },
    { lvl: 2, text: '2.1  Reducing Feed Waste',                                  page: 9  },
    { lvl: 2, text: '2.2  Water-Saving Practices',                               page: 10 },
    { lvl: 2, text: '2.3  Smart Energy Use on the Farm',                         page: 11 },
    { lvl: 1, text: 'Section 3: Manure and Waste Management',                    page: 12 },
    { lvl: 2, text: '3.1  Turning Manure into Fertilizer',                       page: 12 },
    { lvl: 2, text: '3.2  Reducing Pollution and Managing Odors',                page: 13 },
    { lvl: 2, text: '3.3  Safe Storage and Handling',                            page: 14 },
    { lvl: 1, text: 'Section 4: Animal Welfare and Flock Health',                page: 15 },
    { lvl: 2, text: '4.1  Healthy Birds as a Sustainability Pillar',             page: 15 },
    { lvl: 2, text: '4.2  Housing and Ventilation',                              page: 16 },
    { lvl: 2, text: '4.3  Reducing Flock Stress',                                page: 17 },
    { lvl: 1, text: 'Section 5: Low-Cost Sustainable Solutions',                 page: 18 },
    { lvl: 2, text: '5.1  Composting and Reuse of Materials',                    page: 18 },
    { lvl: 2, text: '5.2  Natural Light and Airflow',                            page: 19 },
    { lvl: 2, text: '5.3  Affordable Renewable Energy: Solar and Biogas',        page: 20 },
    { lvl: 1, text: 'Section 6: Economic Benefits of Sustainability',             page: 22 },
    { lvl: 2, text: '6.1  Lowering Production Costs',                            page: 22 },
    { lvl: 2, text: '6.2  Market Value and Consumer Trust',                      page: 23 },
    { lvl: 2, text: '6.3  Long-Term Farm Resilience',                            page: 23 },
    { lvl: 1, text: 'Section 7: Farmer Self-Assessment',                         page: 24 },
    { lvl: 2, text: '7.1  Evaluating Your Current Practices',                    page: 24 },
    { lvl: 2, text: '7.2  Identifying Areas for Improvement',                    page: 25 },
    { lvl: 2, text: '7.3  A Simple Sustainability Action Plan',                  page: 26 },
    { lvl: 1, text: 'Summary and Key Takeaways',                                 page: 27 },
    { lvl: 1, text: 'Recommended Peer-Reviewed Journals',                        page: 28 },
