...
function buildSection2() {
  return {
    ...
    children: [
      ...
      bullet([{ text: 'Line pressure: ', bold: true }, { text: 'Maintain nipple drinker line pressure within the range specified by your equipment manufacturer. Most broiler nipple systems (Lubing, Ziggity, Roxell) are calibrated to deliver water at 10 to 30 centimeters of water column at the nipple, adjusted progressively upward as birds age through the grow-out. Excess pressure causes constant dripping and wet litter; insufficient pressure reduces intake during hot weather [7].' }]),
