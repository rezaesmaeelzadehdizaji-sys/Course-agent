...
function buildSection1() {
  return {
    ...
    children: [
      ...
      para('Broilers are one of the most feed-efficient animals in commercial production, and that kind of efficiency matters to the farm budget and to the environment [4,5]. On one farm, a little wasted feed, a small water leak or poor litter use might not seem like much. But those little losses add up quickly over millions of birds in Canada; higher costs, more waste and greater impact on the environment. That is why farmers are asked to use feed, water, energy and litter wisely, and manage manure, bird mortalities and wash water properly [1,2].'),

      h2('1.1  Understanding the Environmental Footprint'),
      para('Global livestock agriculture contributes roughly 14.5% of all human-caused greenhouse gas emissions, and the poultry sector accounts for about 8% of that total [2]. Per kilogram of meat, broilers produce far less greenhouse gas than beef, pork, or lamb [13]. But being cleaner than beef is not the same as having no footprint, especially at Canadian production volumes.'),
      ...
      para('Leaking drinker lines are more than just a nuisance. A single loose nipple connection can drip hundreds of liters per day without anyone noticing, and wet litter is one of the most common and expensive problems in broiler production. A dripping nipple is a direct line to a litter problem [7,12].'),
      ...image(photoBuf('Photo1-3-leaking nipple-wet-litter.png'), 'Photo 1.2: A nipple drinker dripping onto the litter floor in a commercial broiler barn, creating a saturated dark patch directly beneath the line. A single loose connection can run for days undetected, raising local ammonia and footpad risk for every bird in the area. Daily water meter readings catch this before it becomes a litter and performance problem [7,12]. Source: CPC Short Courses.'),

      h2('1.3  Soil: Nutrients, Runoff, and Land Management'),
      para('Poultry manure is one of the most nitrogen- and phosphorus-dense organic materials available to Canadian crop farmers [3]. Handled well, it is a genuine asset. A typical broiler litter analysis run on material removed from the barn shows 2.5 to 3.5 percent nitrogen, 2.0 to 3.5 percent phosphorus pentoxide, and 2.0 to 3.5 percent potassium oxide [3]. Applied at the right rate to the right fields at the right time, litter reduces fertilizer costs, improves soil organic matter, and builds long-term soil health.'),
      ...
      para('Ammonia is the single biggest air quality problem in a poultry barn, and it affects your birds, your own health, and the people around your operation [8]. By the time you can smell it, it is already working against you. Around 25 ppm, the birds\' airways start to get irritated, their natural defenses weaken, and they become more prone to respiratory disease. Keep levels high and you will see it in your performance: studies report body weight losses of 15 to 20 percent in flocks exposed to sustained high ammonia compared to well-ventilated barns [8]. Anyone spending long hours in a barn with a persistent ammonia problem is also taking on a real health risk over time [8].'),
      para('It is not just a barn problem. Ammonia that leaves your building travels. Neighbours smell it before an inspector ever shows up, and in some regions persistent odor complaints have pushed regulators to tighten rules on stocking density, storage, and when litter can be applied [8].'),
      para('Dust from dry litter and feathers is the other piece of this. It carries bacteria and irritants that can drift well past the barn walls. You can cut it down with good litter management, but you cannot eliminate it completely. Ventilation is your main tool for keeping both ammonia and dust under control [9,11].'),
...
function buildSection2() {
  return {
    ...
    children: [
      ...
      para('Feed represents 60 to 70 percent of the total cost of broiler production [5]. That single number explains why feed efficiency is the most watched metric in the industry, and why even small improvements in feed conversion ratio (FCR) show up directly in profitability. A 0.1-point improvement in FCR on a 20,000-bird barn at current feed prices cuts real money off your cost per kilogram.'),
      ...
      bullet([{ text: 'Phase feeding: ', bold: true }, { text: 'Feeding a diet suited to the growth stage the flock is actually in stops you from overfeeding expensive amino acids and phosphorus later in the grow-out. Most integrators provide phase-feeding schedules; follow them [5].' }]),
      ...
      ...image(photoBuf('Photo2.2-feeder correct height.png'), 'Photo 2.1: Feeder height comparison. Too low (left): feed spills over the rim onto the litter floor, one of the most common and most correctable feed waste points in a broiler barn. Shoulder level (right): no spill, no waste. Feeder height must be checked and adjusted weekly as birds grow [4,11]. Source: CPC Short Courses.'),
      ...
      para('Heating and ventilation are your two biggest energy costs in a broiler barn, and both have real room to improve without major spending [9].'),
      bullet([{ text: 'Brooder management: ', bold: true }, { text: 'Pre-heat the barn and get floor temperature to target before chicks arrive. Chilling them down on day one sets back their immune system and their starter performance for the whole grow-out [4].' }]),
      ...
      bullet([{ text: 'Lighting: ', bold: true }, { text: 'LED lighting uses 75 to 85 percent less energy than incandescent bulbs for the same light output, and poultry-grade LED systems are dimmable and long-lasting. The CPC Learning Centre Lighting Program Guidelines for Broilers recommends LED over incandescent and CFL (Compact Fluorescent) systems specifically for their energy efficiency, dimming compatibility, and long service life. Payback on a full barn conversion has been documented in Canadian operations in future [15,16,22].' }]),
...
function buildSection3() {
  return {
    ...
    children: [
      ...
      para('A 20,000-bird barn running a 6 to 8-week cycle produces roughly 20 to 33 tonnes of litter at whole-house cleanout, depending on litter depth and moisture [3,5]. Send that litter for analysis and you will typically see 2.5 to 3.5 percent total nitrogen, 2.0 to 3.5 percent phosphorus pentoxide, and 2.0 to 3.5 percent potassium oxide [3]. At current fertilizer prices, that is real money for the crop farmer who receives it, and applied properly over time it builds soil rather than depletes it.'),
      ...
      para('Odor and ammonia from litter storage and land application are the most common reasons neighbours complain about poultry operations in Canada. Getting it right keeps you on the right side of both the regulator and the people who live nearby [8]. A few practical steps make a real difference:'),
      ...
      bullet([{ text: 'Compost before land application: ', bold: true }, { text: 'Composting raw litter kills pathogens, cuts odor during application, and holds nutrients better so less ammonia escapes when you spread it [3]. Well-composted litter is also easier to spread uniformly.' }]),
      bullet([{ text: 'Litter amendments: ', bold: true }, { text: 'Products such as alum (aluminum sulfate) and other acidifying amendments cut ammonia in the barn by lowering litter pH, and lock up phosphorus in applied litter so less runs off. Less ammonia means better air quality, drier litter, and better bird performance [8,12].' }]),
...
function buildSection4() {
  return {
    ...
    children: [
      ...
      para('A sick bird is the most expensive animal on your farm. It eats feed and drinks water but converts neither into what you need. If it requires medication, that is a real cost. If it dies, that is a total loss of every input you put in since placement. Good welfare management and sound production management are not two separate tracks. On a well-run farm, they are the same decisions, made in the same morning walk [6,11]. This section looks at flock health through the sustainability lens: how keeping birds healthy protects the feed, water, and money you have already put into them. The full welfare framework, the on-farm welfare indicators, and how to score and act on each one are covered in Course 13 (Poultry Welfare) in this series.'),
...
function buildSection5() {
  return {
    ...
    children: [
      ...
      para('The biggest gains in sustainability on most farms come from changing how you manage things, not from buying new equipment. The management changes cost nothing or close to it, and most of them improve production performance at the same time. The modest investments, LED lighting, fan speed controllers, and litter amendments, pay back quickly [15,16]. The larger capital options, solar and biogas, take longer but have become genuinely accessible for Canadian farms as equipment costs have fallen and federal grant programs have expanded [17,18].'),
      ...
      para('A covered mortality composting bin in a dedicated area beside the barn can manage routine day-to-day mortalities on the farm. Each layer should be covered with dry litter or another carbon source, the pile should be monitored to ensure active composting temperatures are reached, and the material should be moved at the right stage so the process finishes properly. When well managed, this approach can reduce labor, improve daily mortality handling, and help control odor, although farms facing higher disease pressure or stricter biosecurity demands may prefer an incinerator for faster carcass disposal [24].'),
      ...
      para('In Canada\'s climate, you still cannot count on natural air alone for commercial broilers, so good mechanical ventilation is needed year round to control heat, moisture and ammonia and to keep birds meeting welfare and performance targets [6].'),
      ...
      para('Anaerobic digestion is a process that takes organic material such as poultry litter and carcasses, breaks it down without oxygen and turns it into biogas you can use for heat or electricity, plus a leftover liquid residue you can spread on fields as fertilizer [3,14]. The technology itself works and there are Canadian farms running digesters, but the money side is trickier than solar, because digesters cost a lot to build and only pay off when you can use or sell the energy and other byproducts in a steady, reliable way.'),
      ...photo(photoBuf('photo5_1.jpg'), 'Photo 5.1: Solar photovoltaic panels installed on a farm building roof. South-facing barn roofs with adequate structural load capacity are well-suited for commercial solar installations. Under provincial net metering programs, surplus electricity generated on the farm is credited against the hydro bill, and the federal Agricultural Clean Technology Program covers 40% of eligible project costs for most applicants [17,18]. Photo: Robin Stott / geograph.org.uk, CC BY-SA 2.0.', 640, 427),
      pageBreak(),
    ],
  };
}
...
function buildSection6() {
  return {
    ...
    children: [
      ...
      bullet([{ text: 'Input cost volatility: ', bold: true }, { text: 'Feed prices, energy costs, and water rates all move around. Farms that already use less per kilogram of gain feel those price spikes less [5].' }]),
      ...
      bullet([{ text: 'Antimicrobial resistance: ', bold: true }, { text: 'The rules on antibiotics in food animals get a little tighter every year. Farms that have already cut their dependence through better management will handle the next tightening better than farms that have not started [10].' }]),
...
function buildSummarySection() {
  return {
    ...
    children: [
      ...
      bullet([{ text: 'Animal welfare and production efficiency align: ', bold: true }, { text: 'Birds that are uncomfortable, overcrowded, or poorly ventilated do not perform well. Managing housing, ventilation, stocking density, and access to feed and water for their welfare is the same thing as managing for better FCR and lower mortality [6,12].' }]),
      bullet([{ text: 'Renewable energy is accessible now: ', bold: true }, { text: 'Solar PV is operating on Canadian poultry farms today, with net metering programs in place across provinces and federal and provincial programs available to support on-farm energy investments. The time to evaluate feasibility is before energy prices rise further, not after [17,18].' }]),
