...
function buildSection2() {
  return {
    ...
    children: [
      ...
      bullet([{ text: 'Lighting: ', bold: true }, { text: 'LED lighting uses 75 to 85 percent less energy than incandescent bulbs for the same light output, and poultry-grade LED systems are dimmable and long-lasting. The CPC Learning Centre Lighting Program Guidelines for Broilers recommends LED over incandescent and CFL (Compact Fluorescent) systems specifically for their energy efficiency, dimming compatibility, and long service life. Payback on a full barn conversion has been documented in Canadian operations at 12 to 24 months [15,17,23].' }]),
