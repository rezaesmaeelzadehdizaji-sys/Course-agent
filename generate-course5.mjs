...
function buildSection2() {
  return {
    ...
    children: [
      ...
      bullet([{ text: 'Line pressure: ', bold: true }, { text: 'Maintain nipple drinker line pressure within the range specified by your equipment manufacturer. The CPC Learning Centre Managing the Nipple Drinker Line bulletin explains that pressure starts at approximately 5 centimeters of water column for day-old chicks and is adjusted progressively upward to 25 to 45 centimeters as birds approach market weight. Excess pressure causes constant dripping and wet litter; insufficient pressure reduces intake during hot weather [7,21].' }]),
      ...
      bullet([{ text: 'Lighting: ', bold: true }, { text: 'LED lighting uses 75 to 85 percent less energy than incandescent bulbs for the same light output, and poultry-grade LED systems are dimmable and long-lasting. The CPC Learning Centre Lighting Program Guidelines for Broilers recommends LED over incandescent and CFL systems specifically for their energy efficiency, dimming compatibility, and long service life. Payback on a full barn conversion has been documented in Canadian operations at 12 to 24 months [15,17,23].' }]),
