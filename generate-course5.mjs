...
function buildSection5() {
  return {
    ...
    children: [
      ...
      para('A covered mortality composting bin in a dedicated area beside the barn can manage routine day-to-day mortalities on the farm. Each layer should be covered with dry litter or another carbon source, the pile should be monitored to ensure active composting temperatures are reached, and the material should be moved at the right stage so the process finishes properly. When well managed, this approach can reduce labour, improve daily mortality handling, and help control odour, although farms facing higher disease pressure or stricter biosecurity demands may prefer an incinerator for faster carcass disposal [24].'),
