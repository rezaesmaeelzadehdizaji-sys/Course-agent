...
function buildSection4() {
  return {
    ...
    children: [
      ...
      ...image(photoBuf('photo4-3-aaap_fpd_scoring_2022.png'), 'Photo 4.2: Footpad dermatitis scoring guide (AAAP, 2022). Score 0: normal color, no lesions (pass). Score 1: hyperkeratosis with lesions covering less than half the footpad (pass). Score 2: lesions covering more than half the footpad with hemorrhage or swelling (fail). Score 2 at the plant signals a litter management failure 2 to 3 weeks prior in the grow-out [6,12]. Source: American Association of Avian Pathologists, 2022.'),
