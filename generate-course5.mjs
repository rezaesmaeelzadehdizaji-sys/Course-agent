...
function buildSection5() {
  return {
    ...
    children: [
      ...
      bullet('Put in an application to the federal Agricultural Clean Technology Program for cost-share help, and check if any provincial programs, like Ontario\'s Agricultural Stewardship Initiative, can also chip in on energy upgrades [19].'),
