...
function buildSection5() {
  return {
    ...
    children: [
      ...
      para('Commercial poultry barns have large roof areas, often south-facing, that are well-suited to solar panel installation. Under Ontario\'s net metering program and similar programs in other provinces, surplus electricity generated on the farm is credited against the bill at the same rate it would be charged, and farms with larger roof installations have reported significant reductions in monthly electricity costs [18]. The federal Agricultural Clean Technology (ACT) Program has provided non-repayable contributions for on-farm solar and other renewable energy investments, covering 40% of eligible project costs for most applicants [19].'),
