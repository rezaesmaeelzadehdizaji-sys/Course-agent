...
function buildSection2() {
  return {
    ...
    children: [
      ...
      bullet([{ text: 'Lighting: ', bold: true }, { text: 'LED lighting uses 75 to 85 percent less energy than incandescent bulbs for the same light output, and poultry-grade LED systems are dimmable and long-lasting. The CPC Learning Centre Lighting Program Guidelines for Broilers recommends LED over incandescent and CFL (Compact Fluorescent) systems specifically for their energy efficiency, dimming compatibility, and long service life. Payback on a full barn conversion has been documented in Canadian operations in future [15,17,23].' }]),
...
function buildSection5() {
  return {
    ...
    children: [
      ...
      ...photo(photoBuf('photo5_1.jpg'), 'Photo 5.1: Solar photovoltaic panels installed on a farm building roof. South-facing barn roofs with adequate structural load capacity are well-suited for commercial solar installations. Under provincial net metering programs, surplus electricity generated on the farm is credited against the hydro bill, and the federal Agricultural Clean Technology Program covers 40% of eligible project costs for most applicants [18,19]. Photo: Robin Stott / geograph.org.uk, CC BY-SA 2.0.', 640, 427),
      pageBreak(),
    ],
  };
}
...
function buildSummarySection() {
  return {
    ...
    children: [
      ...
      bullet([{ text: 'Renewable energy is accessible now: ', bold: true }, { text: 'Solar PV is operating on Canadian poultry farms today, with net metering programs in place across provinces and federal and provincial programs available to support on-farm energy investments. The time to evaluate feasibility is before energy prices rise further, not after [18,19].' }]),
