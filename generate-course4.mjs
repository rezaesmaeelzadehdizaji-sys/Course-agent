...
function buildSection1() {
  return {
    ...
    children: [
      ...
      ...image(imgBuf(1), 'Figure 1.1: Salmonella classification in commercial poultry. Paratyphoid serovars (SE, ST) are the primary food safety concern. Pullorum disease and fowl typhoid are reportable diseases in Canada.'),
      ...
      para('Human salmonellosis typically presents as an acute gastrointestinal illness beginning 6 to 72 hours after ingestion of contaminated food. Symptoms include nausea and vomiting, abdominal cramping and diarrhea (which may be bloody), fever (38 to 39 degrees Celsius), and headache. In healthy adults, illness is usually self-limiting, resolving within 4 to 7 days [2].'),
...
function buildSection4() {
  return {
    ...
    children: [
      ...
      ...image(imgBuf(4), 'Figure 4.1: Between-flock cleanout and disinfection protocol. Each step builds on the previous; skipping any step significantly reduces effectiveness. Dry cleanout and full drying before disinfectant application are the two most commonly skipped steps.'),
...
function buildSection5() {
  return {
    ...
    children: [
      ...
      ...image(imgBuf(2), 'Figure 5.1: Temperature control for Salmonella safety. Refrigeration slows growth but does not kill bacteria. The danger zone (4 to 60 degrees Celsius) allows rapid multiplication. Cooking to 74 degrees Celsius throughout the product destroys Salmonella completely.'),
      bullet([{ text: 'Refrigeration: ', bold: true }, { text: 'Fresh poultry meat must be kept at or below 4 degrees Celsius at all times after processing. Refrigeration slows Salmonella growth greatly but does not eliminate it.' }]),
      bullet([{ text: 'Freezing: ', bold: true }, { text: 'Frozen poultry should be stored at or below -18 degrees Celsius. Freezing does not kill Salmonella; frozen poultry must still be handled and cooked correctly.' }]),
      bullet([{ text: 'Cooking temperature: ', bold: true }, { text: 'All poultry products must reach an internal temperature of at least 74 degrees Celsius (165 degrees Fahrenheit) throughout the product to ensure Salmonella destruction [2,9]. This applies to all cuts, including wings and thighs close to the bone.' }]),
      bullet([{ text: 'Cold chain maintenance: ', bold: true }, { text: 'Do not allow poultry products to sit at room temperature for more than 2 hours. After cooking, maintain hot food above 60 degrees Celsius, or cool rapidly to below 4 degrees Celsius within 2 hours.' }]),
...
function buildSection6() {
  return {
    ...
    children: [
      ...
      bullet('All poultry products must reach 74 degrees Celsius internal temperature to ensure Salmonella destruction.'),
