...
function buildSection2() {
  return {
    ...
    children: [
      ...
      bullet([{ text: 'Blood Cards: ', bold: true }, { text: 'Collect blood from 12 to 24 representative birds with a wing-vein prick. Fill the circles on the filter card. Air-dry the cards completely at room temperature before bagging them. Damp cards will mold and destroy the proteins the lab needs for serology [1].' }]),
...
function buildSection3() {
  return {
    ...
    children: [
      ...
      para('An early and accurate diagnostic result allows you to lock down your farm immediately. You can stop visitors, cancel feed deliveries or manure hauling, adjust your exhaust fan directions, and warn neighboring growers to increase their biosecurity. Early diagnosis is the only way to contain a highly contagious disease and prevent a localized problem from becoming a regional quarantine [5]. For the full biosecurity protocols that back up this rapid response, see Course 2 (Biosecurity) in this series.'),
...
function buildSection4() {
  return {
    ...
    children: [
      ...
      h2('4.2 Interpreting Lab Reports: Deciphering Mean Titers and Uniformity'),
      para('When your serology report comes back, focus on two numbers first: the Mean Titer and the Coefficient of Variation (%CV). Together they tell you whether your vaccination program actually worked and which birds have real protection [1].'),
      bullet([{ text: 'Mean Titer: ', bold: true }, { text: 'The average antibody level across the blood samples you submitted. Your vet or vaccine manufacturer will give you the target range. Fall below that range and the birds have no real protection.' }]),
      bullet([{ text: 'Coefficient of Variation (%CV): ', bold: true }, { text: 'How spread out the antibody levels are across the flock. A low %CV means birds are all sitting at similar levels. A high %CV means the flock is split: some birds are well-protected, others have barely any coverage.' }]),
      ...image(figBuf('fig9_4.png'), 'Figure 4.1: Titer distribution histograms comparing Excellent (CV < 30%) and Poor (CV > 81%) uniformity. Source: CPC Short Courses.'),
      ...
      ...image(figBuf('fig9_5.png'), 'Figure 4.2: Decision tree to troubleshoot management factors before submitting laboratory samples. Source: CPC Short Courses.'),
...
function buildReferencesSection() {
  return {
    ...
    children: [
      ...
      numberedRef('Aviagen. Water Quality for Poultry. Huntsville, AL: Aviagen Group Ltd.; 2025.'),
...
async function main() {
  ...
  const entriesWithAnchor = [
    ...
    { lvl: 1, text: 'Section 1: Why Poultry Diagnostics Matter in Modern Farming',                    page: 5  },
    { lvl: 2, text: '1.1 The Role of Diagnostics in Flock Health and Farm Viability',                  page: 5  },
    { lvl: 2, text: '1.2 Common Misconceptions: Cost vs. Investment, Diagnostics vs. Autopsy',         page: 6  },
    { lvl: 1, text: 'Section 2: What Poultry Diagnostics Involves',                                    page: 7  },
    { lvl: 2, text: '2.1 Types of Diagnostic Tests',                                                   page: 7  },
    { lvl: 2, text: '2.2 Sample Collection and Handling',                                              page: 8  },
    ...
    { lvl: 2, text: '3.2 Stopping Disease Transmission and Protecting Neighboring Barns',              page: 12 },
    { lvl: 2, text: '3.3 Enhancing Performance: Uncovering Subclinical Disease',                       page: 12 },
    { lvl: 1, text: 'Section 4: Using Diagnostics for Decision-Making',                                page: 14 },
    { lvl: 2, text: '4.1 When to Call for Support: Knowing Your Baseline',                             page: 14 },
    { lvl: 2, text: '4.2 Interpreting Lab Reports: Deciphering Mean Titers and Uniformity',            page: 15 },
    { lvl: 2, text: '4.3 Field Challenge vs. Vaccine Response, and the Value of Paired Samples',        page: 16 },
    { lvl: 2, text: '4.4 Management Errors vs. Infections',                                            page: 17 },
    { lvl: 1, text: 'Section 5: Case Studies and Practical Examples',                                  page: 18 },
    { lvl: 2, text: '5.1 Case Study A: Catching Subclinical Gumboro (IBD)',                            page: 18 },
    { lvl: 2, text: '5.2 Case Study B: How Delayed Action on Water Decline Cost a Broiler Flock',      page: 19 },
