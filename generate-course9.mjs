...
function buildSection2() {
  return {
    ...
    children: [
      ...
      ...image(figBuf('Blood sampleing.png'), 'Photo 2.3: Red-top blood tubes, syringes, and dried blood spot cards set up for flock serology sampling in a commercial broiler barn. Source: CPC Short Courses.'),
