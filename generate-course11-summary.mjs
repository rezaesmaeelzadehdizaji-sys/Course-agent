...
const children = [
  ...
  subItem('Bacterial: Colibacillosis, Necrotic Enteritis, Airsacculitis, Yolk sac infection, Staphylococcosis', 1),
  subItem('Viral: IBV, IBD, Newcastle Disease, Avian Influenza, Inclusion Body Hepatitis, Reovirus arthritis', 1),
  subItem('Parasitic: Coccidiosis (species-specific lesion sites), internal worms', 1),
  subItem('Metabolic: Ascites, Sudden Death Syndrome, skeletal disorders, Dehydration and Visceral Gout', 1),
  subItem('Fungal: Aspergillosis', 1),
  ...
  subItem('Viral: Marek\'s Disease, IBV, Newcastle Disease, ILT, aMPV in layers', 1),
  subItem('Nutritional and metabolic: FLHS, calcium deficiency', 1),
  numbered('Common Diseases in Ducks and Geese', 0),
  subItem('Viral: Duck viral enteritis (duck plague), Duck virus hepatitis, Derzsy\'s disease', 1),
  subItem('Bacterial and toxic: Riemerellosis, Botulism', 1),
  numbered('Common Diseases in Turkeys', 0),
  subItem('Hemorrhagic enteritis, Blackhead (histomoniasis)', 1),
  numbered('Cross-Species Disease Concerns', 0),
  subItem('Pigeon paramyxovirus (PPMV-1)', 1),
  ...
  subItem('Case 2: Layer flock with mortality and production drop (egg peritonitis, Marek\'s)', 1),
  ...
  bullet('All disease-specific findings in this course are supported by verifiable references from the Merck Veterinary Manual, Diseases of Poultry (14th ed.), university extension services, and CPC Learning Centre disease profiles.'),
