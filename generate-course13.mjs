...
function buildSection5() {
  return {
    ...
    children: [
      ...
      para('There is a name for what heat and other chronic stressors do inside the bird: oxidative stress. Under heat, crowding, or poor feed, the bird\'s cells make damaging molecules faster than their natural defenses can clear them, and that damage quietly wears down the gut lining and the immune system before you ever see a sick bird. It is a big part of why thermal stress ends up cutting feed intake and growth and raising mortality [15]. Keeping birds in their comfort zone is one of the most direct welfare and performance tools you have. For how oxidative stress works and how the bird defends against it, see Course 6 (Poultry Anatomy and Physiology) in this series.'),
...
(async () => {
  ...
  const entriesWithAnchor = [
    ...
    { lvl: 1, text: 'Section 6: Handling, Transport, and Slaughter',                               page: 25 },
    { lvl: 2, text: '6.1 Calm Handling on the Farm',                                              page: 25 },
    { lvl: 2, text: '6.2 Catching and Loading for Transport',                                     page: 25 },
    { lvl: 2, text: '6.3 From Farm to Plant: Reducing Pre-Slaughter Stress',                      page: 26 },
    { lvl: 1, text: "Section 7: The Farmer's Daily Welfare Role",                                  page: 29 },
    { lvl: 2, text: '7.1 Daily Welfare Walk-Through',                                             page: 29 },
    { lvl: 2, text: '7.2 Recording and Reporting Problems',                                       page: 29 },
    { lvl: 2, text: '7.3 Building a Welfare-Competent Team',                                      page: 30 },
    { lvl: 1, text: 'Recommended Peer-Reviewed Journals',                                          page: 31 },
