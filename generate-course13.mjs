...
function buildSection3(gaitBuf) {
  return {
    ...
    children: [
      ...
      ...photo(figBuf('free run.jpg'), 'Photo 3.2: The three main laying hen housing systems in Canada. Left: conventional (battery) cages, being phased out by 2036. Center: a barn or floor system. Right: a multi-tier aviary. Cage-free systems let hens move and behave more naturally, but the added height and hard landings raise the risk of keel bone fractures. Source: Egg Farmers of Alberta (eggs.ab.ca).', 5.8),
...
function buildSection4() {
  return {
    ...
    children: [
      ...
      para('Enriched cages provide perches, nest boxes, and scratch pads, which reduce the behavioral frustration common in conventional battery cages. Cage-free systems (aviary, floor, free-run, free-range) allow greater expression of natural behavior but introduce new welfare challenges:'),
      bullet('Keel bone fractures, driven by both weak bones (osteoporosis from high lay) and collisions in multi-tier systems (53 to 100% of hens in cage-free flocks by end of lay) [10].'),
...
function buildSection5() {
  return {
    ...
    children: [
      ...
      bullet('Litter amendments (lime, acidifying agents) can help control moisture and reduce ammonia in problem areas.'),
