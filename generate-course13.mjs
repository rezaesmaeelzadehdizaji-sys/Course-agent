...
function buildSection4() {
  return {
    ...
    children: [
      ...
      bullet('Keel bone fractures from flying, collision, and landing in multi-tier systems (52-73% prevalence in cage-free systems) [10].'),
...
function buildSection7() {
  return {
    ...
    children: [
      ...
      bullet('Dead bird count and condition: remove and record all dead birds. Necropsy birds that show any unusual condition. Do not guess.'),
...
function buildReferencesSection() {
  return {
    ...
    children: [
      ...
      numberedRef('Lay DC Jr, Fulton RM, Hester PY, Karcher DM, Kjaer JB, Mench JA, et al. Hen welfare in different housing systems. Poult Sci. 2011;90(1):278-294. doi:10.3382/ps.2010-00962.'),
