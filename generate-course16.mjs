...
function buildSection2() {
  return {
    ...
    children: [
      ...
      ...image(figBuf('early_disease_detection_flock.png'), 'Photo 2.1: The daily walk and the daily record go together. Mortality, treatments, and barn conditions are easiest to keep accurate when they are written down in the barn the same day, not reconstructed from memory later. Source: CPC Short Courses.'),
