...
async function main() {
  ...
  const entriesWithAnchor = [
    ...
    { lvl: 2, text: '2.6 Safety and Compliance', page: 9 },
    { lvl: 1, text: 'Section 3: Preparing for an Audit', page: 10 },
    { lvl: 2, text: '3.1 Reviewing Records and Documentation', page: 10 },
    { lvl: 2, text: '3.2 Conducting Internal Pre-Audit Checks', page: 11 },
    { lvl: 2, text: '3.3 Fixing Common Deficiencies Before Inspection', page: 11 },
    { lvl: 2, text: '3.4 Assigning Responsibilities to Farm Staff', page: 11 },
    { lvl: 1, text: 'Section 4: During the Audit', page: 13 },
    { lvl: 2, text: '4.1 Hosting Inspectors Professionally', page: 13 },
    { lvl: 2, text: '4.2 Providing Clear and Accurate Information', page: 13 },
    { lvl: 2, text: '4.3 Demonstrating Procedures and Practices', page: 13 },
    { lvl: 2, text: '4.4 Addressing Questions Calmly and Accurately', page: 14 },
    { lvl: 1, text: 'Section 5: After the Audit', page: 15 },
    { lvl: 2, text: '5.1 Understanding Audit Reports', page: 15 },
    { lvl: 2, text: '5.2 Implementing Corrective Actions', page: 16 },
    { lvl: 2, text: '5.3 Continuous Improvement and Preparation for Future Audits', page: 16 },
    { lvl: 1, text: 'Section 6: Practical Tips for Staying Audit-Ready', page: 17 },
    { lvl: 2, text: '6.1 Daily Routines That Maintain Audit Readiness', page: 17 },
    { lvl: 2, text: '6.2 Checklists for Record-Keeping, Hygiene, and Welfare', page: 17 },
    { lvl: 2, text: '6.3 Staff Training and Accountability', page: 18 },
    { lvl: 1, text: 'Recommended Peer-Reviewed Journals', page: 19 },
