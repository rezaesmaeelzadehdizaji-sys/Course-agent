...
function buildSection1() {
  return {
    ...
    children: [
      ...
      ...image(figBuf('Fig 1.png'), 'Figure 1.1: The layers of oversight on a Canadian poultry farm. The rules are set nationally, delivered and audited by your provincial board, with the federal regulator and your buyers adding their own checks. Source: CPC Short Courses.'),
