  ...
  sections: [
    ...
    // ── BODY ─────────────────────────────────────────────────
    {
      ...
      children: [
        ...
        p('T-FLAWS is a barn-entry checklist developed by the CPC Learning Centre as a practical adaptation of the standard FLAWS management framework used across the poultry industry [8]. The addition of Temperature as a standalone first checkpoint reflects how critical thermal management is, particularly in the first week of a flock [1,11].'),
        ...
        p('The same applies at the other end. Heat stress later in the flock suppresses feed intake, elevates mortality, and cuts your feed conversion ratio [5]. Birds cannot tell you they are too hot. They show you.'),
        ...
        p('Target temperatures at bird level for broilers [3,10]:'),
        tempTable(),
        ...
        p('A bird that cannot find feed or reach it comfortably does not grow. Feed access is the engine of production, and it is also one of the most reliable early-warning signals in your barn. Birds reduce feed intake before they show any other visible sign of stress or illness [1,10].'),
        ...
        p('Feed management is not just about keeping the bins full. It is about making sure every bird in every corner of your barn can reach good quality feed without competition, waste, or physical barriers. Use feeder trays at 1 per 100 to 150 chicks for the first few days [10]. When you get this right, birds grow more evenly and there are fewer surprises at weigh-out.'),
        ...
        labeled('Feeder height:', 'The lip of the feeder should sit at back level as the bird stands. Too high and smaller birds cannot reach it. Too low and feed is wasted into the litter [10]. The CPC Broiler Management Bulletin recommends adjusting feeder height at a minimum of once per week as birds grow [10].'),
        ...
        labeled('Feed quality:', 'Look at the feed and smell it. Caked or wet feed near drinker lines means moisture is getting in, usually from a leaking nipple or condensation on the line. Mold or an off-smell is a storage problem. Wet feed is also the most common reason an auger stalls or bridges in the bin [10].'),
        labeled('Access:', 'Every bird needs a clear run at a feeder. If you see the same birds getting pushed off every time they approach, you do not have enough feeder space. Some pecking-order sorting is normal and works itself out over time, but birds being consistently kept away from feed is a management problem that needs fixing [12,13].'),
        ...
        h2('What to Do'),
        b('Adjust feeder height at minimum once per week; keep a record of adjustments with date and bird age [10]'),
        ...
        p('Good lighting in the first week is not about brightness for its own sake. It is about making sure every chick finds feed and water within the first few hours. That single factor shapes the entire flock\'s performance. Below are the CPC broiler lighting guidelines [11].'),
        lightingTable(),
        new Paragraph({ spacing: { before: 80, after: 0 } }),
        ...
        callout('In the first few days after your chicks arrive, they need to find feed fast. The CPC team recommends a simple and effective approach: direct your LEDs over the feed trays rather than lighting the whole barn evenly [11]. The bright spot acts like a signal, pulling chicks straight toward the feed. It is a small adjustment that can make a real difference in how quickly a new flock gets off to a strong start [11].'),

        ...imgBlock(IMG.cpcled, 'jpg', 5.8, 'Photo 3.1: In the first few days after placement, directing LEDs over the feed trays draws chicks straight to feed. The bright spot gives newly placed birds a clear cue to start eating right away. Source: CPC Short Courses [11].'),
        ...
        b('Measure lux intensity with an LED-compatible light meter if available, particularly after replacing bulbs or retrofitting LED fixtures; use an LED-specific meter for accuracy [11]'),
        ...
        b('Consult CPC Lighting Program Guidelines for Broilers, the breed management handbook (Ross or Cobb) and the National Farm Animal Care Council (NFACC) for your light schedule; your integrator may have additional requirements specific to your contract [1,3,11]'),
        b('After installing LED fixtures, verify lux levels with an LED-specific light meter and compare to your target intensity, not just a visual assessment [11]'),
        ...
        p('The job of ventilation is to pull out heat, moisture, ammonia, carbon dioxide, and dust, and bring in fresh air at the right temperature and speed for the birds in front of you [1,4]. Minimum ventilation has to run every hour of every day, including cold Canadian winters. Turning down fans to cut heating costs in January is one of the most common management mistakes in this business. You pay for it weeks later in respiratory disease, bad litter, and feed conversion that does not add up [4].'),
        p('Air quality is not a comfort issue. It is a health, welfare, and money issue. Getting it right matters as much as any vaccine or feed additive on your farm [4].'),

        h2('Key Air Quality Indicators'),
        labeled('Ammonia:', 'This is one of the most practical things you can track during your daily barn walk. Above 10 ppm at bird level, ammonia starts quietly weakening your birds\' immune defense [4]. By 15 to 20 ppm, that stress is real, even if you cannot see it yet in performance [4]. Push past 25 ppm and you will start seeing visible eye damage: irritation, swelling, and birds that are far more vulnerable to any respiratory bug that comes through the barn [4]. At 50 ppm and above, the airways themselves take a hit. The rule is simple: do not wait for a meter reading. If you can smell it when you walk in, it is already too high.'),
        ...
        labeled('Line cleanliness and biofilm:', 'Biofilm develops on the inside of drinker lines within days of a flock placement. It is a slimy buildup you cannot always see, but it harbors bacteria and reduces water quality at the point of consumption [2,9]. Flush lines with high pressure at 1 minute per 60 feet of line before each flock placement. During the flock, run an acidifier through the lines weekly to break down biofilm. The CPC Drinking Water Management guide lists several validated options including citric acid (200 grams per gallon stock solution) and chlorine-based products [9]. Flush lines 12 hours after administering vaccines, vitamins, or antibiotics.'),
        labeled('Water quality at the nipple:', 'Test at the nipple, not just at the header tank. CPC water quality targets: pH 6.0 to 8.0 (optimal 6.8 to 7.5), total dissolved solids at or below 500 mg/L, total coliforms at zero per 100 mL [9]. Annual water analysis from a certified lab is recommended as a baseline.'),
        ...
        h2('What to Do'),
        b('Flush drinker lines at the beginning of every flock and at regular intervals during production [2,9]'),
        b('Run a water acidifier through lines weekly during the flock to prevent biofilm buildup; consult your veterinarian for product selection [9]'),
        b('Adjust line height daily in the first week and at least weekly after that; the CPC guide recommends raising lines so birds drink at a 45-degree angle from day 3, and nearly straight up by day 10 [9]'),
        b('Test water quality at the nipple, not just at the header tank, at minimum once per flock; test for pH, total dissolved solids, coliform count [2,9]'),
        ...
        b('Record daily water consumption and flag any drop of more than 10 percent for the same day of age versus previous flocks [1,9]'),
        b('Disinfect your well annually; use unscented household bleach (5 to 6% chlorine) or UV systems following the CPC Drinking Water Management dosing guide for well diameter [9]'),
        ...
        p('Keep your water lines clean. Run an acidifier through them weekly to break down biofilm, the slimy buildup inside drinker lines that you cannot always see but that harbors bacteria [2,9]. Flush lines thoroughly after every flock before placing a new one.'),
        ...
        b('Apply a litter amendment product only if recommended by your veterinarian and consistent with your production protocol; some amendments alter ammonia chemistry without addressing the root cause [6]'),
        b('Ensure full cleanout, disinfection, and complete dry-down between every flock [6,7]'),
        b('Do not place a new flock on litter that does not meet your pre-placement quality targets, regardless of schedule pressure [6]'),
        b('Maintain stocking density within NFACC limits; adjust for seasonal conditions, and plan density reductions in summer months when ventilation capacity is most stressed [3]'),
        ...
        new Paragraph({ spacing: { before: 80, after: 80 }, children: [
          run('[2]', { bold: true }), run('  Aviagen. Aviagen Brief: Water Quality. Aviagen Group Ltd., Huntsville, AL, USA.'),
        ]}),
        new Paragraph({ spacing: { before: 80, after: 80 }, children: [
          run('[3]', { bold: true }), run('  National Farm Animal Care Council (NFACC). Code of Practice for the Care and Handling of Hatching Eggs, Breeders, Chickens, and Turkeys. NFACC, Lacombe, AB, Canada, 2016.'),
        ]}),
        new Paragraph({ spacing: { before: 80, after: 80 }, children: [
          run('[4]', { bold: true }), run('  Bestman M, Ruis M, Heijmans J, van Middelkoop K. Poultry Signals: A Practical Guide for Bird-Focused Poultry Farming. Roodbont Publishers, Zutphen, Netherlands, 2012.'),
        ]}),
        new Paragraph({ spacing: { before: 80, after: 80 }, children: [
          run('[5]', { bold: true }), run('  Daghir NJ (ed). Poultry Production in Hot Climates, 2nd ed. CABI, Wallingford, UK, 2008.'),
        ]}),
        new Paragraph({ spacing: { before: 80, after: 80 }, children: [
          run('[6]', { bold: true }), run('  Aviagen. Biosecurity Best Practice in the Broiler House. Aviagen Group Ltd., Huntsville, AL, USA.'),
        ]}),
        new Paragraph({ spacing: { before: 80, after: 80 }, children: [
          run('[7]', { bold: true }), run('  Canadian Food Inspection Agency (CFIA). National Avian On-Farm Biosecurity Standard. CFIA, Ottawa, ON, Canada, 2009.'),
        ]}),
        new Paragraph({ spacing: { before: 80, after: 80 }, children: [
          run('[8]', { bold: true }), run('  CPC Learning Centre. T-FLAWS Barn Management Framework. Canadian Poultry Consultants Ltd., Canada. [Unpublished proprietary framework; confirmed by CPC, personal communication, 2026.]'),
        ]}),
        new Paragraph({ spacing: { before: 80, after: 80 }, children: [
          run('[9]', { bold: true }), run('  CPC Learning Centre. Drinking Water Management. Integrated Poultry Health Management Series. Canadian Poultry Consultants Ltd., Canada, 2011.'),
        ]}),
        new Paragraph({ spacing: { before: 80, after: 80 }, children: [
          run('[10]', { bold: true }), run('  CPC Learning Centre. Broiler Management. CPC Technical Bulletin, Flock Management Series. Canadian Poultry Consultants Ltd., Canada.'),
        ]}),
        new Paragraph({ spacing: { before: 80, after: 80 }, children: [
          run('[11]', { bold: true }), run('  CPC Learning Centre. Broiler Lighting Program Guidelines for Broilers 2026. Canadian Poultry Consultants Ltd., Canada, 2026.'),
        ]}),
        new Paragraph({ spacing: { before: 80, after: 80 }, children: [
          run('[12]', { bold: true }), run('  Grethen KJ, Gomez Y, Toscano MJ. Coup in the coop: Rank changes in chicken dominance hierarchies over maturation. Behav Processes. 2023;210:104904. https://doi.org/10.1016/j.beproc.2023.104904'),
        ]}),
        new Paragraph({ spacing: { before: 80, after: 80 }, children: [
          run('[13]', { bold: true }), run('  Jacob J. Normal behaviors of chickens in small and backyard poultry flocks. University of Kentucky Cooperative Extension Service. Available from: https://poultry.extension.org/articles/poultry-behavior/normal-behaviors-of-chickens-in-small-and-backyard-poultry-flocks/'),
        ]}),
        new Paragraph({ spacing: { before: 80, after: 80 }, children: [
          run('[14]', { bold: true }), run('  Lott BD, Simmons JD, May JD. Water intake: a good measure of broiler performance. Avian Advice. University of Arkansas Cooperative Extension Service; 2003. Available from: https://www.thepoultrysite.com/articles/water-intake-a-good-measure-of-broiler-performance'),
        ]}),
        new Paragraph({ spacing: { before: 80, after: 80 }, children: [
          run('[15]', { bold: true }), run('  Edge CK. Evaluation of water needs for modern commercial broiler production [dissertation]. Auburn (AL): Auburn University; 2022. (Water:feed ratios reported as 1.62 to 2.06 kg water per kg feed; a 2:1 ratio is commonly assumed in the broiler industry.)'),
        ]}),
      ],
    },
  ],
