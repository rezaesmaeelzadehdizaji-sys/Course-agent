...
// ── TOC entries ───────────────────────────────────────────────
const tocEntries = [
  { lvl: 1, text: 'Introduction to T-FLAWS', page: 4 },
  { lvl: 2, text: 'What Is T-FLAWS?', page: 4 },
  { lvl: 2, text: 'Who Is This Course For?', page: 4 },
  { lvl: 2, text: 'How to Use This Checklist', page: 4 },
  { lvl: 1, text: 'T: Temperature', page: 6 },
  { lvl: 2, text: 'Why Temperature Matters', page: 6 },
  ...
  { lvl: 1, text: 'S: Sanitation & Space', page: 23 },
  { lvl: 2, text: 'Sanitation', page: 23 },
  { lvl: 2, text: 'Space:', page: 24 },
  { lvl: 2, text: 'Litter Management', page: 24 },
  { lvl: 2, text: 'Stocking Density', page: 25 },
  { lvl: 2, text: 'What Farmers See', page: 25 },
  { lvl: 2, text: 'What to Do', page: 26 },
  { lvl: 1, text: 'Using T-FLAWS as a System', page: 27 },
  { lvl: 1, text: 'Where to Keep Learning', page: 29 },
  { lvl: 2, text: 'Key Scientific Journals', page: 29 },
  { lvl: 2, text: 'Key Institutional Resources', page: 29 },
  ...
  sections: [
      ...
      children: [
        ...
        new Paragraph({
          ...
          children:  [run(
            ...
            'veterinarian or regulatory authority. The CPC team reviews and updates this series. If you spot something that needs correcting, tell us at admin@canadianpoultry.ca.',
    ...
    // ── BODY ─────────────────────────────────────────────────
    {
      ...
      children: [
        ...
        p('T-FLAWS is a barn-entry checklist developed by the CPC Learning Centre as a practical adaptation of the standard FLAWS management framework used across the poultry industry [1]. The addition of Temperature as a standalone first checkpoint reflects how critical thermal management is, particularly in the first week of a flock [2,3].'),
        ...
        p('Temperature is the first thing you assess when you enter the barn, and it is also the most likely factor to be wrong at placement. A day-old chick cannot regulate its own body temperature. It depends entirely on the environment you provide [2].'),
        p('The consequences of getting temperature wrong in the first week are lasting. Cold chicks do not eat or drink properly. Their gut development falls behind, their immune system is compromised, and their seven-day weight, an important early performance milestone, will reflect the failure [2]. Research shows that while seven-day weight correlates with flock direction, measurements from week three onward are the more reliable predictors of final body weight, but by then the gap from a cold start has already compounded. A cold start is one of the most expensive mistakes in broiler production, and it is entirely preventable.'),
        p('The same applies at the other end. Heat stress later in the flock suppresses feed intake, elevates mortality, and cuts your feed conversion ratio [4]. Birds cannot tell you they are too hot. They show you.'),

        h2('Target Ranges by Bird Age'),
        p('Always check temperature at chick level, not at the ceiling sensor. Your barn controller reads what the sensor sees, and on a cold night or over a cold floor, that reading can be 3 to 5 degrees higher than what the birds are actually experiencing [2]. That gap is enough to stunt a whole flock in the first week.'),
        p('Target temperatures at bird level for broilers [5,6]:'),
        tempTable(),
        ...
        p('Pre-heat the barn at least 24 to 48 hours before placement, including the floor. The litter surface at chick level needs to reach 30 degrees Celsius before the first bird arrives [2]. Warm air over a cold floor is not enough for day-olds. They lose heat through the floor just as fast as through the air.'),
        ...
        b('Pre-warm the barn and litter at least 24 to 48 hours before every placement [2]'),
        ...
        p('A bird that cannot find feed or reach it comfortably does not grow. Feed access is the engine of production, and it is also one of the most reliable early-warning signals in your barn. Birds reduce feed intake before they show any other visible sign of stress or illness [2,6].'),
        ...
        p('Feed management is not just about keeping the bins full. It is about making sure every bird in every corner of your barn can reach good quality feed without competition, waste, or physical barriers. Use feeder trays at 1 per 100 to 150 chicks for the first few days [6]. When you get this right, birds grow more evenly and there are fewer surprises at weigh-out.'),
        ...
        labeled('Feeder height:', 'The lip of the feeder should sit at back level as the bird stands. Too high and smaller birds cannot reach it. Too low and feed is wasted into the litter [6]. The CPC Broiler Management Bulletin recommends adjusting feeder height at a minimum of once per week as birds grow [6].'),
        ...
        labeled('Feed quality:', 'Look at the feed and smell it. Caked or wet feed near drinker lines means moisture is getting in, usually from a leaking nipple or condensation on the line. Mold or an off-smell is a storage problem. Wet feed is also the most common reason an auger stalls or bridges in the bin [6].'),
        labeled('Access:', 'Every bird needs a clear run at a feeder. If you see the same birds getting pushed off every time they approach, you do not have enough feeder space. Some pecking-order sorting is normal and works itself out over time, but birds being consistently kept away from feed is a management problem that needs fixing [7,8,9,10,11].'),
        ...
        h2('What to Do'),
        b('Adjust feeder height at minimum once per week; keep a record of adjustments with date and bird age [6]'),
        ...
        b('Monitor daily feed consumption using bin meters or manual records and compare to breed target consumption curves [2]'),
        ...
        b('In the first 48 hours, check crop fill at 2, 4, 8, 12, 24, and 48 hours post-placement: target 75% of crops full at 2 hours, 80% at 4 hours, 95% at 24 hours, and 100% by 48 hours. A bird with an empty crop at 24 hours is already behind [2]'),
        ...
        p('Good lighting in the first week is not about brightness for its own sake. It is about making sure every chick finds feed and water within the first few hours. That single factor shapes the entire flock\'s performance. Below are the CPC broiler lighting guidelines [3].'),
        lightingTable(),
        new Paragraph({ spacing: { before: 80, after: 0 } }),
        ...
        callout('In the first few days after your chicks arrive, they need to find feed fast. The CPC team recommends a simple and effective approach: direct your LEDs over the feed trays rather than lighting the whole barn evenly [3]. The bright spot acts like a signal, pulling chicks straight toward the feed. It is a small adjustment that can make a real difference in how quickly a new flock gets off to a strong start [3].'),

        ...imgBlock(IMG.cpcled, 'jpg', 5.8, 'Photo 3.1: In the first few days after placement, directing LEDs over the feed trays draws chicks straight to feed. The bright spot gives newly placed birds a clear cue to start eating right away. Source: CPC Short Courses [3].'),
        ...
        b('Measure lux intensity with an LED-compatible light meter if available, particularly after replacing bulbs or retrofitting LED fixtures; use an LED-specific meter for accuracy [3]'),
        ...
        b('Consult CPC Lighting Program Guidelines for Broilers, the breed management handbook (Ross or Cobb) and the National Farm Animal Care Council (NFACC) for your light schedule; your integrator may have additional requirements specific to your contract [2,5,3]'),
        b('After installing LED fixtures, verify lux levels with an LED-specific light meter and compare to your target intensity, not just a visual assessment [3]'),
        ...
        p('The job of ventilation is to pull out heat, moisture, ammonia, carbon dioxide, and dust, and bring in fresh air at the right temperature and speed for the birds in front of you [2,12]. Minimum ventilation has to run every hour of every day, including cold Canadian winters. Turning down fans to cut heating costs in January is one of the most common management mistakes in this business. You pay for it weeks later in respiratory disease, bad litter, and feed conversion that does not add up [12].'),
        p('Air quality is not a comfort issue. It is a health, welfare, and money issue. Getting it right matters as much as any vaccine or feed additive on your farm [12].'),

        h2('Key Air Quality Indicators'),
        labeled('Ammonia:', 'This is one of the most practical things you can track during your daily barn walk. Above 10 ppm at bird level, ammonia starts quietly weakening your birds\' immune defense [12]. By 15 to 20 ppm, that stress is real, even if you cannot see it yet in performance [12]. Push past 25 ppm and you will start seeing visible eye damage: irritation, swelling, and birds that are far more vulnerable to any respiratory bug that comes through the barn [12]. At 50 ppm and above, the airways themselves take a hit. The rule is simple: do not wait for a meter reading. If you can smell it when you walk in, it is already too high.'),
        ...
        labeled('Carbon dioxide:', [
          ...co2r(), run(' above 3,000 ppm indicates the minimum ventilation rate is insufficient for the current stocking density and bird size [2]. '),
        ...
        b('Check inlet opening positions and adjust for outside temperature and wind conditions according to your barn management system [2]'),
        ...
        b('Do not shut down minimum ventilation in cold weather; adjust heater output to compensate for increased fresh air, not fan speed [2]'),
        ...
        labeled('Water temperature:', 'Birds back off warm water fast. On a hot day, press a nipple and feel what comes out. If it is warm to the touch, intake will drop. Target 10 to 14 degrees Celsius at the nipple [15]. In summer, check that above-ground supply lines are insulated, and know that some operations need active chilling systems by mid-season.'),
        labeled('Consumption records:', 'If your system has water meters, check daily volume against the breed target curve. The Ross Broiler Management Handbook provides expected water intake by day of age at a given temperature [2]. Any deviation greater than 10 percent in either direction needs an explanation.'),
        labeled('Line cleanliness and biofilm:', 'Biofilm develops on the inside of drinker lines within days of a flock placement. It is a slimy buildup you cannot always see, but it harbors bacteria and reduces water quality at the point of consumption [15,16]. Flush lines with high pressure at 1 minute per 60 feet of line before each flock placement. During the flock, run an acidifier through the lines weekly to break down biofilm. The CPC Drinking Water Management guide lists several validated options including citric acid (200 grams per gallon stock solution) and chlorine-based products [16]. Flush lines 12 hours after administering vaccines, vitamins, or antibiotics.'),
        labeled('Water quality at the nipple:', 'Test at the nipple, not just at the header tank. CPC water quality targets: pH 6.0 to 8.0 (optimal 6.8 to 7.5), total dissolved solids at or below 500 mg/L, total coliforms at zero per 100 mL [16]. Annual water analysis from a certified lab is recommended as a baseline.'),
        ...
        h2('What to Do'),
        b('Flush drinker lines at the beginning of every flock and at regular intervals during production [15,16]'),
        b('Run a water acidifier through lines weekly during the flock to prevent biofilm buildup; consult your veterinarian for product selection [16]'),
        b('Adjust line height daily in the first week and at least weekly after that; the CPC guide recommends raising lines so birds drink at a 45-degree angle from day 3, and nearly straight up by day 10 [16]'),
        b('Test water quality at the nipple, not just at the header tank, at minimum once per flock; test for pH, total dissolved solids, coliform count [15,16]'),
        ...
        b('Record daily water consumption and flag any drop of more than 10 percent for the same day of age versus previous flocks [2,16]'),
        b('Disinfect your well annually; use unscented household bleach (5 to 6% chlorine) or UV systems following the CPC Drinking Water Management dosing guide for well diameter [16]'),
        ...
        p('Keep your water lines clean. Run an acidifier through them weekly to break down biofilm, the slimy buildup inside drinker lines that you cannot always see but that harbors bacteria [15,16]. Flush lines thoroughly after every flock before placing a new one.'),
        ...
        b('Apply a litter amendment product only if recommended by your veterinarian and consistent with your production protocol; some amendments alter ammonia chemistry without addressing the root cause [17]'),
        b('Ensure full cleanout, disinfection, and complete dry-down between every flock [17,18]'),
        b('Do not place a new flock on litter that does not meet your pre-placement quality targets, regardless of schedule pressure [17]'),
        b('Maintain stocking density within NFACC limits; adjust for seasonal conditions, and plan density reductions in summer months when ventilation capacity is most stressed [5]'),
        ...
        new Paragraph({ spacing: { before: 100, after: 80 }, children: [
          run('1.', { bold: true }), run('  CPC Learning Centre. T-FLAWS Barn Management Framework. Canadian Poultry Consultants Ltd., Canada. [Unpublished proprietary framework; confirmed by CPC, personal communication, 2026.]'),
        ]}),
        new Paragraph({ spacing: { before: 80, after: 80 }, children: [
          run('2.', { bold: true }), run('  Aviagen. Ross Broiler Management Handbook. Aviagen Group Ltd., Huntsville, AL, USA, 2025.'),
        ]}),
        new Paragraph({ spacing: { before: 80, after: 80 }, children: [
          run('3.', { bold: true }), run('  CPC Learning Centre. Broiler Lighting Program Guidelines for Broilers 2026. Canadian Poultry Consultants Ltd., Canada, 2026.'),
        ]}),
        new Paragraph({ spacing: { before: 80, after: 80 }, children: [
          run('4.', { bold: true }), run('  Daghir NJ (ed). Poultry Production in Hot Climates, 2nd ed. CABI, Wallingford, UK, 2008.'),
        ]}),
        new Paragraph({ spacing: { before: 80, after: 80 }, children: [
          run('5.', { bold: true }), run('  National Farm Animal Care Council (NFACC). Code of Practice for the Care and Handling of Hatching Eggs, Breeders, Chickens, and Turkeys. NFACC, Lacombe, AB, Canada, 2016.'),
        ]}),
        new Paragraph({ spacing: { before: 80, after: 80 }, children: [
          run('6.', { bold: true }), run('  CPC Learning Centre. Broiler Management. CPC Technical Bulletin, Flock Management Series. Canadian Poultry Consultants Ltd., Canada.'),
        ]}),
        new Paragraph({ spacing: { before: 80, after: 80 }, children: [
          run('7.', { bold: true }), run('  Grethen KJ, Gomez Y, Toscano MJ. Coup in the coop: Rank changes in chicken dominance hierarchies over maturation. Behav Processes. 2023;210:104904. https://doi.org/10.1016/j.beproc.2023.104904'),
        ]}),
        new Paragraph({ spacing: { before: 80, after: 80 }, children: [
          run('8.', { bold: true }), run('  Jacob J. Normal behaviors of chickens in small and backyard poultry flocks. University of Kentucky Cooperative Extension Service. Available from: https://poultry.extension.org/articles/poultry-behavior/normal-behaviors-of-chickens-in-small-and-backyard-poultry-flocks/'),
        ]}),
        new Paragraph({ spacing: { before: 80, after: 80 }, children: [
          run('9.', { bold: true }), run('  Leighton GM, Drury JP, Small J, Miller ET. Unfamiliarity generates costly aggression in interspecific avian dominance hierarchies. Nature Communications. 2024;15:335. https://doi.org/10.1038/s41467-023-44613-0'),
        ]}),
        new Paragraph({ spacing: { before: 80, after: 80 }, children: [
          run('10.', { bold: true }), run('  Miller ET, Bonter DN, Eldermire C, Freeman BG, Greig EI, Harmon LJ, Lisle C, Hochachka WM. Fighting over food unites the birds of North America in a continental dominance hierarchy. Behavioral Ecology. 2017;28(6):1454-1463. https://doi.org/10.1093/beheco/arx108'),
        ]}),
        new Paragraph({ spacing: { before: 80, after: 80 }, children: [
          run('11.', { bold: true }), run('  Francis ML, Plummer KE, Lythgoe BA, Macallan C, Currie TE, Blount JD. Effects of supplementary feeding on interspecific dominance hierarchies in garden birds. PLoS One. 2018;13(9):e0202152. https://doi.org/10.1371/journal.pone.0202152'),
        ]}),
        new Paragraph({ spacing: { before: 80, after: 80 }, children: [
          run('12.', { bold: true }), run('  Pottguter R. Poultry Signals: A Practical Guide for Poultry Farming. Roodbont Publishers, Zutphen, Netherlands, 2009.'),
        ]}),
        new Paragraph({ spacing: { before: 80, after: 80 }, children: [
          run('13.', { bold: true }), run('  Lott BD, Simmons JD, May JD. Water intake: a good measure of broiler performance. Avian Advice. University of Arkansas Cooperative Extension Service; 2003. Available from: https://www.thepoultrysite.com/articles/water-intake-a-good-measure-of-broiler-performance'),
        ]}),
        new Paragraph({ spacing: { before: 80, after: 80 }, children: [
          run('14.', { bold: true }), run('  Edge CK. Evaluation of water needs for modern commercial broiler production [dissertation]. Auburn (AL): Auburn University; 2022. (Water:feed ratios reported as 1.62 to 2.06 kg water per kg feed; a 2:1 ratio is commonly assumed in the broiler industry.)'),
        ]}),
        new Paragraph({ spacing: { before: 80, after: 80 }, children: [
          run('15.', { bold: true }), run('  Aviagen. Water Quality in Poultry Production. Aviagen Group Ltd., Huntsville, AL, USA, 2025.'),
        ]}),
        new Paragraph({ spacing: { before: 80, after: 80 }, children: [
          run('16.', { bold: true }), run('  CPC Learning Centre. Drinking Water Management. Integrated Poultry Health Management Series. Canadian Poultry Consultants Ltd., Canada, 2011.'),
        ]}),
        new Paragraph({ spacing: { before: 80, after: 80 }, children: [
          run('17.', { bold: true }), run('  Aviagen. Best Practices in Biosecurity for Ross Broiler Operations. Aviagen Group Ltd., Huntsville, AL, USA.'),
        ]}),
        new Paragraph({ spacing: { before: 80, after: 80 }, children: [
