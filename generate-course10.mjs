...
function buildSection3() {
  return {
    ...
    children: [
      ...
      ...image(figBuf('livers-chicken.png'), 'Photo 3.5: Two chicken livers showing the normal color range. Both have the typical two-lobed shape with smooth, sharp edges. Color runs from a deep reddish-brown (left) to a paler tan-orange (right), depending on how much fat the liver is carrying. Source: CPC Short Courses.', 4.8),
