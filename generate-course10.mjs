...
function buildIntroSection() {
  return {
    ...
    children: [
      ...
      para('One thing to be clear about from the start. A full necropsy is a skilled job, and your veterinarian has spent years learning to read a bird on the table. The proper place to do it is a dedicated necropsy room: an isolated, biosecure space built to keep pathogens away from your live birds. That work belongs to your veterinarian first. Whenever you can manage it, the right move is to send the dead bird or the samples to your veterinarian or the diagnostic lab, or to have your veterinarian come out to the farm in person. Opening a bird yourself in the barn is the fallback, for the times when you cannot get samples away fast enough or no veterinarian can get to you. This course builds the eye and the routine for those moments, and it makes you a sharper partner for your veterinarian the rest of the time.'),
...
function buildSection3() {
  return {
    ...
    children: [
      ...
      bullet([{ text: 'Lungs, airway, and air sacs: ', bold: true }, { text: 'A pair of bright pink, spongy organs pressed up against the ribs along the back. In a healthy bird they sit flush against the back wall and spring back when pressed. They should not be firm, dark, or wet [3]. Leading into them is the windpipe, or trachea, a pale, open tube with a clean, moist lining. The point where it divides to enter the lungs is the syrinx, the bird\'s voice box. Birds also carry a set of air sacs, thin clear membranes that run off the lungs and reach through the chest and belly and even into some bones. In a healthy bird they are so thin and see-through you can barely spot them, and they should be clean and dry. Any cloudiness, foam, yellow coating, or fluid on those membranes is one of the first signs of a respiratory problem, so always take a moment to check them.' }]),
      ...image(figBuf('photo3_5.jpg'), 'Photo 3.4: (1) The syrinx exposed at the point where the windpipe (trachea) splits to enter the lungs, with the heart just above it. (2) A pair of lungs lifted out: healthy lungs are light and spongy and spring back when pressed, and in the bird they sit tucked up high against the ribs. (3) The abdominal air sacs: in a healthy bird these membranes are thin and transparent and should be free of foam, fibrin, veins, fluid, or exudate. Source: Cobb Post Mortem Guide, Breeders, 2022 (panels 1 and 3); Li W, Tang Q, Dai N, et al. Scientific Reports. 2020;10:6340 (panel 2).', 5.9),
      ...
      ...image(figBuf('necrospy liver final.png'), 'Photo 3.5: Two chicken livers showing the normal color range. Both have the typical two-lobed shape with smooth, sharp edges. Color runs from a deep reddish-brown (left) to a paler tan-orange (right), depending on how much fat the liver is carrying. Source: CPC Short Courses.', 4.8),
      bullet([{ text: 'Spleen and immune organs: ', bold: true }, { text: 'The spleen is a small, round, dark red to purple organ, about the size of a cherry, sitting near the junction of the proventriculus and gizzard. Normal is small and firm, and a spleen swollen to two or three times that size points to a problem [3,4]. The spleen is part of the bird\'s immune system, along with two other organs worth knowing. The thymus and the bursa of Fabricius are the primary immune organs: this is where the bird builds and trains its immune cells, which is why they matter most in young birds. The spleen is a secondary immune organ, where those cells go to work filtering the blood and answering infection. The thymus runs as a chain of pale lobules down both sides of the neck, and the bursa of Fabricius is a round pouch just above the vent. Both are largest in young birds and shrink as the bird matures, so judge their size against the bird\'s age.' }]),
...
function buildSection8() {
  return {
    ...
    children: [
      ...
      para('One last reminder, the same one we opened with. A full necropsy is your veterinarian\'s job first. Whenever you can, send the dead bird or the samples to your veterinarian or the diagnostic lab, or have your veterinarian come out to the farm in person. Opening a bird yourself in the barn is the fallback, for the times when your veterinarian cannot visit in person, or you cannot get the mortalities to the lab or to your veterinarian\'s clinic. This course builds the eye and the routine for those moments, and it makes you a sharper partner for your veterinarian the rest of the time.'),
    ],
  };
}
