...
function buildBody() {
  return [
    ...
    spacer(60),
    ...image(figBuf('Blunt force.jpg'), 'Photo 3.6: The tool has to be big enough and heavy enough to knock a bird out in one blow. A heavy mallet (top) or a solid club (middle), each about a foot long (bottom), delivers a reliable single strike. A light or short object risks a missed or partial blow. Source: CPC Short Courses.', 5.0),
    spacer(60),
