...
function buildBody() {
  return [
    ...
    para('Humane euthanasia means ending a bird\'s suffering by ending its life quickly, with no chance of it coming back, and with as little pain and fear as possible. The word itself means a good death, and that is exactly the point: when a bird cannot recover, the kindest thing you can do is take its pain away for good. The AVMA Guidelines put it the same way, describing euthanasia as a humane death that relieves suffering, brought about by rapid loss of consciousness, followed by cardiac or respiratory arrest, and ultimately complete loss of brain function [1]. The key word is rapid. A slow or incomplete procedure is not euthanasia. It is prolonged suffering by a different name.'),
    ...
    spacer(80),
    callout('Chick Placement Rule', 'Any chick that cannot stand, has an obvious deformity preventing it from reaching feed or water, or is clearly below half the expected weight of its pen-mates must be euthanized within the first handling pass. Do not place it and hope. At the hatchery the NFACC Code puts a hard clock on this: injured or malformed chicks that are suffering must be euthanized within 1 hour after flock processing is finished [2]. Once the chicks are on your floor, the prompt-euthanasia rule above is what applies, and the first handling pass is what prompt means at placement.', 'EBF2FA', MED_BLUE),
    spacer(80),
    ...
    dataTable(
      ...
      [
        ...
        ['CO2 euthanasia', 'Trained farm worker', 'Small groups, individual birds, hatchery culls', 'Immerse birds in a prefilled, sealed chamber, filled fuller for chicks. Continue until all reflexes cease.'],
    ...
    para([{ text: 'Large numbers of compromised chicks at placement.', bold: true }, { text: ' A CO2 chamber handles several chicks at once and is faster than working through them one at a time when you have a lot to get through. With no CO2 on hand, use manual cervical dislocation, one chick at a time. For chicks under seven days, rest the chin on a narrow, firm edge and press down firmly on the back of the neck until you feel the skull separate [5]. The real risk with a big batch is fatigue, because a tired operator gets sloppy and the technique starts to fail. Bring in a second trained person so you can share the work and swap out, and never rush a single bird [5].' }]),
...
async function main() {
  ...
  const tocEntries = [
    ...
    { lvl: 2, text: '3.3  Mechanical Cervical Dislocation (KED Devices)', page: '12' },
    { lvl: 2, text: '3.4  Non-Penetrating Captive Bolt', page: '13' },
    { lvl: 2, text: '3.5  CO2 Euthanasia', page: '14' },
    { lvl: 2, text: '3.6  Blunt Force Trauma', page: '16' },
    { lvl: 2, text: '3.7  Decapitation', page: '17' },
    { lvl: 2, text: '3.8  Methods That Are NOT Acceptable', page: '18' },
    { lvl: 1, text: '4. Practical Steps for Each Approved Method', page: '20' },
    { lvl: 2, text: '4.1  Equipment Required', page: '20' },
    { lvl: 2, text: '4.2  Worker Safety and Biosecurity', page: '20' },
    { lvl: 2, text: '4.3  Differences by Bird Age and Size', page: '21' },
    { lvl: 1, text: '5. Verification of Death', page: '23' },
    { lvl: 2, text: '5.1  Why Verification Matters', page: '23' },
    { lvl: 2, text: '5.2  The Three-Check Protocol', page: '23' },
    { lvl: 2, text: '5.3  When Euthanasia Fails', page: '24' },
    { lvl: 1, text: '6. Carcass Disposal', page: '25' },
    { lvl: 2, text: '6.1  Approved Disposal Methods', page: '25' },
    { lvl: 2, text: '6.2  Biosecurity During Disposal', page: '26' },
    { lvl: 1, text: '7. Record-Keeping and Staff Training', page: '27' },
    { lvl: 2, text: '7.1  Documentation for Welfare Audits', page: '27' },
    { lvl: 2, text: '7.2  Ensuring All Staff Are Competent', page: '27' },
    { lvl: 2, text: '7.3  Regular Refresher Training', page: '28' },
    { lvl: 1, text: '8. Workshop: Practical Demonstration', page: '29' },
    { lvl: 2, text: '8.1  Workshop Overview', page: '29' },
    { lvl: 2, text: '8.2  Common Mistakes and How to Avoid Them', page: '29' },
    { lvl: 2, text: '8.3  Handling Difficult Situations', page: '30' },
    { lvl: 1, text: 'Recommended Journals and Resources', page: '31' },
