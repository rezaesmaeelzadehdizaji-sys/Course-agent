...
async function main() {
  ...
  const tocEntries = [
    ...
    { lvl: 2, text: '4.3  Differences by Bird Age and Size', page: '17' },
    { lvl: 1, text: '5. Verification of Death', page: '18' },
    { lvl: 2, text: '5.1  Why Verification Matters', page: '18' },
    { lvl: 2, text: '5.2  The Three-Check Protocol', page: '18' },
    { lvl: 2, text: '5.3  When Euthanasia Fails', page: '19' },
    { lvl: 1, text: '6. Carcass Disposal', page: '20' },
    { lvl: 2, text: '6.1  Approved Disposal Methods', page: '20' },
    { lvl: 2, text: '6.2  Biosecurity During Disposal', page: '20' },
    { lvl: 1, text: '7. Record-Keeping and Staff Training', page: '22' },
    { lvl: 2, text: '7.1  Documentation for Welfare Audits', page: '22' },
    { lvl: 2, text: '7.2  Ensuring All Staff Are Competent', page: '22' },
    { lvl: 2, text: '7.3  Regular Refresher Training', page: '23' },
    { lvl: 1, text: '8. Workshop: Practical Demonstration', page: '24' },
    { lvl: 2, text: '8.1  Workshop Overview', page: '24' },
    { lvl: 2, text: '8.2  Common Mistakes and How to Avoid Them', page: '24' },
    { lvl: 2, text: '8.3  Handling Difficult Situations', page: '25' },
    { lvl: 1, text: 'Recommended Journals and Resources', page: '26' },
    { lvl: 1, text: 'References', page: '27' },
  ];
