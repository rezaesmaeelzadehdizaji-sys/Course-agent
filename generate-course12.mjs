...
async function main() {
  ...
  const tocEntries = [
    ...
    { lvl: 2, text: '4.1  Equipment Required', page: '15' },
    { lvl: 2, text: '4.2  Worker Safety and Biosecurity', page: '15' },
    { lvl: 2, text: '4.3  Differences by Bird Age and Size', page: '16' },
    { lvl: 1, text: '5. Verification of Death', page: '17' },
    { lvl: 2, text: '5.1  Why Verification Matters', page: '17' },
    { lvl: 2, text: '5.2  The Three-Check Protocol', page: '17' },
    { lvl: 2, text: '5.3  When Euthanasia Fails', page: '18' },
    { lvl: 1, text: '6. Carcass Disposal', page: '19' },
    { lvl: 2, text: '6.1  Approved Disposal Methods', page: '19' },
    { lvl: 2, text: '6.2  Biosecurity During Disposal', page: '19' },
    { lvl: 1, text: '7. Record-Keeping and Staff Training', page: '21' },
    { lvl: 2, text: '7.1  Documentation for Welfare Audits', page: '21' },
    { lvl: 2, text: '7.2  Ensuring All Staff Are Competent', page: '21' },
    { lvl: 2, text: '7.3  Regular Refresher Training', page: '22' },
    { lvl: 1, text: '8. Workshop: Practical Demonstration', page: '23' },
    { lvl: 2, text: '8.1  Workshop Overview', page: '23' },
    { lvl: 2, text: '8.2  Common Mistakes and How to Avoid Them', page: '23' },
    { lvl: 2, text: '8.3  Handling Difficult Situations', page: '24' },
