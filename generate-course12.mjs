...
async function main() {
  ...
  const tocEntries = [
    ...
    { lvl: 2, text: '3.3  Mechanical Cervical Dislocation (KED Devices)', page: '10' },
    { lvl: 2, text: '3.4  Non-Penetrating Captive Bolt', page: '11' },
    { lvl: 2, text: '3.5  CO2 Euthanasia', page: '12' },
    { lvl: 2, text: '3.6  Blunt Force Trauma for Neonatal Chicks', page: '12' },
    { lvl: 2, text: '3.7  Methods That Are NOT Acceptable', page: '13' },
    { lvl: 1, text: '4. Practical Steps for Each Approved Method', page: '14' },
    { lvl: 2, text: '4.1  Equipment Required', page: '14' },
    { lvl: 2, text: '4.2  Worker Safety and Biosecurity', page: '14' },
    { lvl: 2, text: '4.3  Differences by Bird Age and Size', page: '15' },
    { lvl: 1, text: '5. Verification of Death', page: '16' },
    { lvl: 2, text: '5.1  Why Verification Matters', page: '16' },
    { lvl: 2, text: '5.2  The Three-Check Protocol', page: '16' },
    { lvl: 2, text: '5.3  When Euthanasia Fails', page: '17' },
    { lvl: 1, text: '6. Carcass Disposal', page: '18' },
    { lvl: 2, text: '6.1  Approved Disposal Methods', page: '18' },
    { lvl: 2, text: '6.2  Biosecurity During Disposal', page: '18' },
    { lvl: 1, text: '7. Record-Keeping and Staff Training', page: '20' },
    { lvl: 2, text: '7.1  Documentation for Welfare Audits', page: '20' },
    { lvl: 2, text: '7.2  Ensuring All Staff Are Competent', page: '20' },
    { lvl: 2, text: '7.3  Regular Refresher Training', page: '21' },
    { lvl: 1, text: '8. Workshop: Practical Demonstration', page: '22' },
    { lvl: 2, text: '8.1  Workshop Overview', page: '22' },
    { lvl: 2, text: '8.2  Common Mistakes and How to Avoid Them', page: '22' },
    { lvl: 2, text: '8.3  Handling Difficult Situations', page: '23' },
