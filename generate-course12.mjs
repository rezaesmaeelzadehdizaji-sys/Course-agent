...
function buildBody() {
  return [
    ...
    spacer(60),
    ...image(figBuf('Blunt force.jpg'), 'Photo 3.6: The tool has to be big enough and heavy enough to knock a bird out in one blow. A heavy pipe (top) or a solid wooden club (middle), each about a foot long (bottom), delivers a reliable single strike. A light or short object risks a missed or partial blow. Source: Poultry Industry Council, Practical Guidelines for On-Farm Euthanasia of Poultry, 2nd ed., 2016 [5].', 5.0),
    spacer(60),
...
async function main() {
  ...
  const tocEntries = [
    ...
    { lvl: 1, text: '5. Verification of Death', page: '21' },
    { lvl: 2, text: '5.1  Why Verification Matters', page: '21' },
    { lvl: 2, text: '5.2  The Three-Check Protocol', page: '21' },
    { lvl: 2, text: '5.3  When Euthanasia Fails', page: '22' },
    { lvl: 1, text: '6. Carcass Disposal', page: '23' },
    { lvl: 2, text: '6.1  Approved Disposal Methods', page: '23' },
    { lvl: 2, text: '6.2  Biosecurity During Disposal', page: '23' },
    { lvl: 1, text: '7. Record-Keeping and Staff Training', page: '25' },
    { lvl: 2, text: '7.1  Documentation for Welfare Audits', page: '25' },
    { lvl: 2, text: '7.2  Ensuring All Staff Are Competent', page: '25' },
    { lvl: 2, text: '7.3  Regular Refresher Training', page: '26' },
    { lvl: 1, text: '8. Workshop: Practical Demonstration', page: '27' },
    { lvl: 2, text: '8.1  Workshop Overview', page: '27' },
    { lvl: 2, text: '8.2  Common Mistakes and How to Avoid Them', page: '27' },
    { lvl: 2, text: '8.3  Handling Difficult Situations', page: '28' },
    { lvl: 1, text: 'Recommended Journals and Resources', page: '29' },
