...
async function main() {
  ...
  children.push(bullet('The CPC team reviews and updates this series. If you spot something that needs correcting, tell us at admin@canadianpoultry.ca.'));
