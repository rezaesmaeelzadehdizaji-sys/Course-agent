...
- **Content confirmed:** Service technician weekly visit schedule, production chain role, cumulative mortality 3–5%, spot weighing protocols (30–50 birds), normal daily gain targets for commercial broilers.
- **Notes:** Official USDA APHIS government document. Publicly available. No author listed (institutional authorship). No publication year in document; cited without year (institutional/ongoing).
- **Status:** VERIFIED
...
- **Notes:** Live government webpage; cited date included per CLAUDE.md rule. Institutional authorship (CFIA).
- **Status:** VERIFIED
...
## Fabrication Pattern Checklist (from CLAUDE.md)

- [ ] Fabricated author list with real title: NOT PRESENT — all author lists verified
- [ ] Wrong chapter title in real book: NOT APPLICABLE — no book chapters cited
