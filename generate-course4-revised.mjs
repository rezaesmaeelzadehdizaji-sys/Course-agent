...
function buildSection3() {
  return {
    ...
    children: [
      ...
      para("Under CFIA's Pathogen Reduction Monitoring Program (PRMP), chicken processing plants have to test chicken meat every week for Salmonella and Campylobacter to make sure their food safety system is working properly [3]. Your integrator coordinates this. Treat that result as real information, not paperwork. It tells you whether your biosecurity is working and whether a specific barn is carrying a heavier load than the rest. When a positive comes back, use it. Pull out your cleanout records, visitor logs, and pest control sheets. Find where the gap was. Fix it. Write down what you changed. Then call your vet about what to add to the next cycle."),
      pageBreak(),
    ],
  };
}
