...
function buildSection6() {
  return {
    ...
    children: [
      ...
      bullet('The three serovars of greatest food safety concern in Canadian poultry are Salmonella Enteritidis, Salmonella Typhimurium, and Salmonella Heidelberg.'),
