  ...
  return {
    ...
    children: [
      ...
      para([
        ...
        { text: 'has', bold: true },
        { text: ' shown resistance to commonly used antibiotics, which creates downstream treatment problems in human medicine [2,7].' },
      ]),
      ...
      bullet([{ text: 'Survives drying: ', bold: true }, { text: 'Dried fecal dust can carry live Salmonella. This is why ' }, { text: 'dry-sweeping', bold: true }, { text: ' before washing matters. You ' }, { text: 'must', bold: true }, { text: ' remove that material physically before disinfectant can reach the surface [5].' }]),
...
function buildSection2() {
  return {
    ...
    children: [
      ...
      para('Salmonella does not appear out of nowhere. It comes in on something you can usually trace, and once it sets up in the barn environment it is not leaving without a real cleanout [1,5]. This section outlines the major introduction routes Salmonella uses to enter and persist on poultry farms.'),
  ...
  return {
    ...
    children: [
      ...
      para([
        ...
        { text: ' is layering. You stack several controls so that when one fails, the next one catches it. That is what this section is built around [1,5].' },
      ]),
      ...
      para("When birds get stressed; during catching, loading, transport, feed withdrawal, or when they are fighting another disease, the good bugs in the gut are knocked off balance and Salmonella can flare up again, even in older birds [12]. That is why we often see Salmonella levels go up right before slaughter. Diseases that weaken the immune system, like infectious bursal disease (IBD) or infectious bronchitis, make this problem worse because the bird has less strength to control germs in the gut. For the full profiles of those diseases, see Course 7 (Common Poultry Diseases) in this series."),
      para("If you are using pelleted feed, look for probiotic products based on Bacillus species. These bugs form tough spores that survive pelleting heat and storage much better than products based on more fragile bacteria [12]. Work with your veterinarian to choose a product and program that match your flock type, feed (mash or pellets), and timing of placement and thinning."),
      ...
      para('Vaccination brings colonization down and cuts the odds of transovarian transmission, but it does not clear Salmonella out of a flock. Treat it as one layer of a program, not a replacement for biosecurity and management. Your integrator or provincial veterinarian will tell you which schedule fits your production type and the current regulations [3].'),
      ...
      para([
        ...
        { text: 'must', bold: true },
        { text: ' test chicken meat every week for Salmonella and Campylobacter to make sure their food safety system is working properly [3]. Your integrator coordinates this. Treat ' },
  ...
  return {
    ...
    children: [
      ...
      para([
        ...
        { text: ' the barn. Everything that comes after, your biosecurity, your CE product, your vaccination, is fighting uphill against whatever Salmonella load you left in the building. A proper cleanout breaks that cycle [1,5].' },
      ]),
