...
function buildIntroSection() {
  return {
    ...
    children: [
      h1('Introduction'),
      para([
        { text: 'Salmonella is the kind of problem that hides in a healthy-looking flock. The birds eat, the birds drink, mortality is normal, your morning walk turns up nothing unusual. Then the swab results come back from the plant and your week is suddenly very different [1]. That is the part that makes Salmonella so hard. You cannot watch a bird and tell whether it is shedding. ' },
        { text: 'So', bold: true },
        { text: ' everything in your program ' },
        { text: 'must', bold: true },
        { text: ' work ' },
        { text: 'whether or not', bold: true },
        { text: ' you ever see a sick bird.' },
      ]),
      ...
      para([
        { text: 'What this course does is walk you through what Salmonella ' },
        { text: 'is', bold: true },
        { text: ', how it gets into a barn, and what works to keep it out. Biosecurity, hygiene, cleanout, pre-harvest management, records, and the rules you ' },
        { text: 'must', bold: true },
        { text: ' follow. By the end you will know where the high-risk doors are on your operation and exactly what to do at each one before the sampling truck arrives.' },
      ]),
      ...
      bullet([{ text: 'Keep the records that demonstrate your food safety program is ' }, { text: 'working and', bold: true }, { text: ' protect you if a flock tests positive.' }]),
      bullet('Know exactly when to report to CFIA, and what happens if you do not.'),
      bullet('Make confident decisions on your farm that protect your product quality and the trust of the people eating what you grow.'),
      pageBreak(),
    ],
  };
}
...
function buildSection1() {
  return {
    ...
    children: [
      ...
      h2('1.1 What Salmonella Is'),
      para([
        { text: 'Salmonella is not one bug. It is a big family, more than 2,600 different variants called serovars, and most of them do not matter in poultry production [1]. The three that matter most to you in Canada are Salmonella Enteritidis (SE), Salmonella Typhimurium (ST), and Salmonella Heidelberg (SH). Together they account for ' },
        { text: 'most of the', bold: true },
        { text: ' human illness traced back to Canadian poultry. Heidelberg ' },
        { text: 'has', bold: true },
        { text: ' shown resistance to commonly used antibiotics, which creates downstream treatment problems in human medicine [2,3].' },
      ]),
      ...
      bullet([{ text: 'Host-adapted serovars (Pullorum, Gallinarum): ', bold: true }, { text: 'These cause visible, serious disease in your birds: high mortality and sick flocks. Both are federally reportable. If you suspect either one, stop what you are doing and call CFIA immediately [4].' }]),
      bullet([{ text: 'Arizonosis: ', bold: true }, { text: 'Caused by Salmonella arizonae, primarily a concern in turkey flocks. Less common in Canada [5].' }]),
      ...
      bullet([{ text: 'Survives in the barn environment: ', bold: true }, { text: 'In dry litter, dust, soil, and on equipment surfaces, Salmonella can stay alive for weeks to months. A barn that looks clean is not necessarily safe [1,6].' }]),
      ...
      bullet([{ text: 'Survives drying: ', bold: true }, { text: 'Dried fecal dust can carry live Salmonella. This is why ' }, { text: 'dry-sweeping', bold: true }, { text: ' before washing matters. You ' }, { text: 'must', bold: true }, { text: ' remove that material physically before disinfectant can reach the surface [6].' }]),
      ...
      para("In a layer flock, SE has an extra trick. It can colonize the hen's reproductive tract and get inside the egg before the shell forms. The route is called transovarian transmission [1,7]. The shell looks perfectly clean and uncracked, but the inside is already contaminated. That is why SE in a laying flock is taken so seriously, and why the egg safety steps later in this course are not optional."),
      h2('1.4 How Salmonella Affects Humans'),
      para([
        { text: 'When a person gets sick from contaminated poultry, it comes on fast. Symptoms hit 6 to 72 hours after eating, cramping, diarrhea that can turn bloody, nausea, fever around 38 to 39°C, generally a ' },
        { text: 'bad few days', bold: true },
        { text: '. A healthy adult usually clears it in four to seven days [2].' },
      ]),
...
function buildSection2() {
  return {
    ...
    children: [
      ...
      para('Salmonella does not appear out of nowhere. It comes in on something you can usually trace, and once it sets up in the barn environment it is not leaving without a real cleanout [1,6]. This section outlines the major introduction routes Salmonella uses to enter and persist on poultry farms.'),
      h2('2.1 Pathogen Exposure from Feed, Water, and Equipment'),
      h3('Feed'),
      para('Feed is one of the most direct routes onto the farm. Animal-origin ingredients (meat and bone meal, feather meal, fish meal) can carry the bug, and while most mills heat-treat finished feed, that protection is gone the minute the bag is opened or the bin is exposed to the elements [6]. Post-mill contamination during transport and storage is a real, documented risk. Things to watch for:'),
      ...
      para("When you get your annual water test back, the numbers that matter most for Salmonella risk are total coliforms (target zero per 100 mL) and E. coli (target zero). The CPC Learning Centre water quality standards also flag pH: your drinking water should stay between 6.0 and 8.0, with 6.8 to 7.5 considered ideal for production performance [8]. A pH outside that range does not just affect palatability. It affects biofilm chemistry and how long pathogens survive in the line. Test your well at least twice a year and after any flooding or infrastructure work [8]."),
      h3('Equipment and Litter'),
      para([
        { text: 'Equipment moves quietly between barns and farms, and it carries the bug with it. Egg flats, chick delivery boxes, feed trucks, litter handling gear, dead bird bins [1,6]. None of it looks contaminated. Any of it can be. And the litter itself builds up a load week by week as the flock ages. By the time you are pushing slaughter weight, the litter is a real reservoir on its own, ' },
        { text: 'separate', bold: true },
        { text: ' from the birds.' },
      ]),
      h2('2.2 Carriers: Poultry and Wildlife'),
      ...
      bullet([{ text: 'Darkling beetles (Alphitobius diaperinus): ', bold: true }, { text: 'These are the most significant insect pest in broiler barns worldwide. Adults are 6 to 10 mm long and complete their full life cycle in about 42 days. A single female produces up to 2,000 eggs in her lifetime [9]. Beetles and their larvae (lesser mealworms) are confirmed vectors for Salmonella, E. coli, and Campylobacter, and have been specifically identified as one of the main routes by which Salmonella gets back into the barn after a thorough cleanout and disinfection [9]. They burrow into insulation and wall cracks, which is why they survive most cleanout protocols. Severe infestations can destroy up to 25% of insulation per year and push energy costs up to 60% higher [9]. The CPC Learning Centre recommends rotating insecticide classes after every two consecutive flocks and applying treatment within 24 hours of depopulation, when beetle populations are at their peak along side walls and under feed lines [9].' }]),
      ...
      h2('2.3 Threats from Staff and Guests'),
      para("The most mobile carrier on your farm is whoever walked through the door this morning. Every worker, technician, veterinarian, and visitor who was on another poultry farm earlier that day can bring Salmonella in on their boots, coveralls, and hands, and almost nobody knows when it is happening [1,6]. Where this goes wrong:"),
...
function buildSection3() {
  return {
    ...
    children: [
      ...
      para([
        { text: 'There is no single product or program that gets rid of Salmonella on its own. Anyone who tells you otherwise is trying to sell you something. The thing that ' },
        { text: 'works', bold: true },
        { text: ' is layering. You stack several controls so that when one fails, the next one catches it. That is what this section is built around [1,6].' },
      ]),
      h2('3.1 Introduction to Biosecurity'),
      para('Biosecurity is the wall around the barn. It is not one thing; it is a list of things you do every day. Who comes in. What vehicles cross the line. What equipment moves between farms. What chicks land on placement day. Every one of those is a possible introduction route [1,6].'),
      ...
      bullet('Require visitors who have been at another poultry operation to observe a minimum downtime period, typically 24 to 72 hours depending on risk level, and always change into farm-dedicated clothing and footwear before entering your barns [10,11,12].'),
      ...
      para('Start with the feed supplier. Ask whether their program covers heat treatment of finished feed, post-processing contamination controls, and routine environmental Salmonella testing. If they cannot show you the paperwork, get a different supplier [6]. On the farm side, every bag and bin gets sealed and covered. No leftover feed sitting between flocks. Zero rodent access to any feed storage, ever.'),
      para('Water: test well water for total coliform and E. coli at least once a year, and treat the well with chlorine periodically to keep it free from bacterial contamination [8]. Run an in-line treatment system between flocks, and keep water acidified during the grow-out. The CPC Learning Centre Drinking Water Management guide recommends a full biofilm purge before every placement using an approved product, with at least 12 hours of contact time for chemical cleaners, followed by a high-pressure flush at one minute per 60 feet of line [8]. During the flock, flush lines weekly at high pressure and always flush 12 hours after giving vaccines, vitamins, or antibiotics through the water to prevent residue buildup in the line [8]. Check nipple flow rate against your system specification. The standard is 25 mL per minute at nipple level. A flow rate that falls below target is often the first sign of biofilm buildup restricting the system, long before you can see it [8].'),
      h2('3.3 Competitive Exclusion'),
      para("The CPC Learning Centre Introduction to Probiotics guide explains competitive exclusion simply: get the right bacteria into the chick before Salmonella does. A chick's gastrointestinal tract is completely sterile at hatch. It takes about two weeks for gut microflora to develop and close to three weeks before the immune system is fully functional [13]. That window is when Salmonella can walk into an empty barn and colonize birds that have nothing to push back with. Competitive exclusion products fill that gap by seeding the gut with a fully developed adult microflora right at placement."),
      para("The concept goes back to 1973, when Nurmi and Rantala showed that dosing newly hatched chicks with gut bacteria from healthy adults blocked Salmonella from establishing in the intestine [13]. A commercial CE product prepared from adult poultry delivers that same protection regardless of breed, strain, or sex. CE is most effective when applied at or before first exposure, which means at hatch or on arrival, before the barn environment has a chance to challenge a sterile gut [1,13]."),
      para("When birds get stressed; during catching, loading, transport, feed withdrawal, or when they are fighting another disease, the good bugs in the gut are knocked off balance and Salmonella can flare up again, even in older birds [13]. That is why we often see Salmonella levels go up right before slaughter. Diseases that weaken the immune system, like infectious bursal disease (IBD) or infectious bronchitis, make this problem worse because the bird has less strength to control germs in the gut. For the full profiles of those diseases, see Course 7 (Common Poultry Diseases) in this series."),
      para("If you are using pelleted feed, look for probiotic products based on Bacillus species. These bugs form tough spores that survive pelleting heat and storage much better than products based on more fragile bacteria [13]. Work with your veterinarian to choose a product and program that match your flock type, feed (mash or pellets), and timing of placement and thinning."),
      h2('3.4 Vaccination: How Much Help Can It Offer'),
      para('SE vaccines are available in Canada and are standard in layer and breeder operations, where the contamination of the egg itself is the main concern [1,14].'),
      ...
      bullet([{ text: 'Killed vaccines: ', bold: true }, { text: 'Injected at or near transfer to the layer barn, as a booster after the live series. Associated with lower rates of egg contamination [1,14].' }]),
      para('Vaccination brings colonization down and cuts the odds of transovarian transmission, but it does not clear Salmonella out of a flock. Treat it as one layer of a program, not a replacement for biosecurity and management. Your integrator or provincial veterinarian will tell you which schedule fits your production type and the current regulations [4].'),
      ...
      para([
        { text: "Under CFIA's Pathogen Reduction Monitoring Program (PRMP), chicken processing plants " },
        { text: 'must', bold: true },
        { text: ' test chicken meat every week for Salmonella and Campylobacter to make sure their food safety system is working properly [4]. Your integrator coordinates this. Treat ' },
        { text: 'those results', bold: true },
        { text: ' as real information, not paperwork. It tells you whether your biosecurity is working and whether a specific barn is carrying a heavier load than the rest. When a positive comes back, use it. Pull out your cleanout records, visitor logs, and pest control sheets. Find where the gap was. Fix it. Write down what you changed. Then call your veterinarian about what to add to the next cycle.' },
      ]),
      pageBreak(),
    ],
  };
...
function buildSection4() {
  return {
    ...
    children: [
      ...
      para('A biosecurity plan is only as good as the people doing it. If the workers, including you, are skipping basic hygiene some of the time, the plan is worthless. Salmonella moves on hands, boots, coveralls, and equipment, and every shortcut becomes a new way for it to spread [6,15].'),
      h2('4.1 Handwashing'),
      para([
        { text: 'Your hands touch birds, equipment, litter, and your own face in a way nothing else on the farm does. That makes them the fastest transfer route for Salmonella you have, and the easiest one to interrupt. The procedure is the same one you have heard a hundred times, but it ' },
        { text: 'must', bold: true },
        { text: ' be done:' },
      ]),
      ...
      h2('4.3 Proper Housing and Litter Management Between Flocks'),
      h3('Barn Cleanout and Disinfection'),
      para([
        { text: 'Cleanout is the one window in the flock cycle where you can ' },
        { text: 'reset', bold: true },
        { text: ' the barn. Everything that comes after, your biosecurity, your CE product, your vaccination, is fighting uphill against whatever Salmonella load you left in the building. A proper cleanout breaks that cycle [1,6].' },
      ]),
      ...
      h3('Waste Management'),
      para('Litter coming out of a positive flock is a contamination hazard the second it leaves the barn. Cover it, contain it, keep it well away from barn entrances, water sources, and the neighbors. Fresh untreated manure from a positive flock does not go onto fields that grow produce eaten raw. The downstream risk is not theoretical [6,15].'),
      para([{ text: 'Dead birds:', bold: true }, { text: ' pull them every day and process them immediately. Mortality piling up in the barn or in a bin is a Salmonella amplifier and an audit flag at the same time. Two reasons to keep on top of it.' }]),
      pageBreak(),
    ],
  };
}
...
function buildSection5() {
  return {
    ...
    children: [
      ...
      para([
        { text: 'The plant does the ' },
        { text: 'killing,', bold: true },
        { text: ' but the farm decides how much Salmonella shows up on the truck. The colonization level in your flock at loading is what drives carcass contamination at slaughter. Your test results, your relationship with the integrator, and your market access all trace back to what you did in the barn in the days before pickup [4,7].' },
      ]),
      h2('5.1 On-Farm Handling and Pre-Harvest Preparation'),
      para('The window from final feed withdrawal to loading is the worst time for Salmonella in your flock. Withdrawal stress, the chaos of catching, the stress of transport, all of it pushes carrier birds to shed at higher rates. And feathers smeared with fecal material during catching go straight onto the processing line [1,6]. Whatever you do in those 24 to 48 hours shows up in your carcass numbers.'),
      bullet([{ text: 'Feed withdrawal timing: ', bold: true }, { text: 'Follow your processor\'s specified feed withdrawal guidelines. Excessive withdrawal time causes intestinal damage that increases contamination risk during processing [7].' }]),
      ...
      h2('5.2 Temperature Control for Meat and Eggs'),
      ...
      bullet([{ text: 'Cooking: ', bold: true }, { text: '74°C (165°F) throughout the product kills Salmonella [2,15]. That means the thickest part of the thigh, the joint inside a wing, everywhere. A surface reading 80°C while the bone runs 68°C is not safe.' }]),
      ...
      para('The CPC Learning Centre Hatching Egg Care guide traces shell contamination to a simple physical mechanism and understanding it makes every handling rule obvious. A freshly laid egg is at 41 to 42°C. The moment it leaves the hen it starts cooling to the room temperature around it. That cooling causes the egg contents to contract, and the contraction pulls air through the shell pores. If bacteria are sitting on the shell surface at that moment, they get drawn straight through into the membranes [16]. The shell looks clean. The inside is not. This is the same mechanism that makes washing eggs dangerous when the wash water is cooler than the egg: the temperature differential drives the pull-through actively [7]. Every handling decision in the list below exists to break one part of that chain.'),
      bullet('Keep nesting areas clean and dry. Wet, soiled nests dramatically increase the risk of shell contamination.'),
      bullet('Collect eggs frequently. Four to six collections per day is the CPC Learning Centre standard for optimal protection; two per day is the minimum [16]. Every extra hour an egg sits in a warm, bacteria-loaded nest is another window for contamination. In hot weather, collect more often.'),
      bullet('Watch for sweating. When eggs stored in a cool room are moved into warmer air, moisture condenses on the shell surface. That moisture creates ideal conditions for bacteria to penetrate the pores at exactly the moment the egg is warming up and contracting inward [16]. If you pre-warm eggs before grading or shipping in summer, increase the storage room temperature gradually and maintain relative humidity around 75% to minimize condensation.'),
      bullet('Remove floor eggs promptly. Floor eggs have a much higher rate of fecal shell contamination and must not be sold as Grade A. If they are clean and uncracked, they can be separated and handled accordingly but never wash them: washing removes the protective cuticle and turns a surface contamination problem into an internal one [16].'),
      bullet([{ text: 'Do not wash eggs ', bold: true }, { text: 'unless you are licensed and equipped to do so under CFIA-approved conditions. Washing with water cooler than the egg creates a negative pressure differential that actively pulls surface bacteria into the egg through the shell pores [7].' }]),
      bullet('Cool eggs promptly after collection. Store at or below 10 degrees Celsius for graded eggs, or below 13 degrees Celsius for ungraded eggs pending grading [4].'),
      bullet('Use clean, sanitized egg flats or crates. Reusable plastic egg flats must be washed and disinfected between uses.'),
      h2('5.4 Protection from Contamination During Direct Sales'),
...
function buildSection6() {
  return {
    ...
    children: [
      ...
      para([
        { text: 'Salmonella control in Canada is not optional. It is in federal law, in provincial regulation, and in the program rules of every major commodity organization you sell into. Knowing which rules apply to you, what records you ' },
        { text: 'must', bold: true },
        { text: ' keep, and when to call CFIA matters as much as anything you do in the barn [4,15].' },
      ]),
      h2('6.1 Regulatory Framework in Canada'),
      bullet([{ text: 'Canadian Food Inspection Agency (CFIA): ', bold: true }, { text: 'Oversees the Safe Food for Canadians Regulations and administers the Pathogen Reduction Monitoring Program (PRMP) for raw poultry. The PRMP tracks Salmonella levels through pre-harvest and processing surveillance. A positive result on your flock does not stay between you and the plant. Depending on the level, it can trigger extra interventions at slaughter that affect your throughput [4]. For more information, see Course 17 (Regulatory Framework in Poultry Production) in this series.' }]),
      bullet([{ text: 'Chicken Farmers of Canada (CFC): ', bold: true }, { text: 'Their On-Farm Food Safety (OFFS) Program requires documented biosecurity and Salmonella control for every broiler producer. A third-party auditor will come to your farm and check whether your records and practices match your program. Write down what you do, then do what you wrote [4]. For more information, see Course 17 (Regulatory Framework in Poultry Production) in this series.' }]),
      bullet([{ text: 'Egg Farmers of Canada (EFC): ', bold: true }, { text: 'The Start Clean, Stay Clean program sets the Salmonella control and flock testing requirements for commercial egg producers. If you produce eggs commercially, this is your program and these are your obligations [4]. For more information, see Course 17 (Regulatory Framework in Poultry Production) in this series.' }]),
      bullet([{ text: 'Reportable diseases: ', bold: true }, { text: 'Salmonella Pullorum and Salmonella Gallinarum are reportable diseases under federal and most provincial regulations. Any suspected case must be reported to your provincial veterinarian or the CFIA immediately [4].' }]),
      h2('6.2 Documentation and Record-Keeping'),
      ...
      bullet([{ text: 'Record water and feed consumption at the same time every day. ' }, { text: 'Measure', bold: true }, { text: ' do not estimate.' }]),
      ...
      bullet('When something looks wrong, call your veterinarian. Early investigation costs much less than a full-flock Salmonella event at the plant.'),
      bullet('When submitting birds to a diagnostic lab, submit 10 to 12 birds so the pathologist has a representative sample to work from. One or two birds is not enough to establish a pattern [17].'),
      para('Become an auditor of your own operation, not just a daily inspector. The difference is that an auditor is looking for gaps in the system, not just confirming everything looks fine today [17].'),
      h2('6.4 Key Takeaways: Ensuring Safe Products for Your Customers'),
      ...
      bullet([{ text: 'In Canada, Salmonella Enteritidis, Salmonella Typhimurium, and Salmonella Heidelberg are the three serovars your food safety program ' }, { text: 'must', bold: true }, { text: ' be built around.' }]),
      bullet([{ text: 'No single intervention gets rid of Salmonella on its own. Biosecurity, water and feed management, competitive exclusion, vaccination where it fits, hygiene, and monitoring all ' }, { text: 'must', bold: true }, { text: ' work together. Take one layer out and the rest carry more risk.' }]),
...
function buildReferencesSection() {
  const refs = [
    ...
    '3.  World Health Organization. Critically important antimicrobials for human medicine. 6th revision. Geneva: WHO; 2019.',
    '4.  Canadian Food Inspection Agency. Pathogen Reduction Monitoring Program (PRMP) for raw poultry [Internet]. Ottawa: Government of Canada; 2023 [cited 2026 Apr]. Available from: inspection.canada.ca',
    '5.  Swayne DE, Boulianne M, Logue CM, McDougald LR, Nair V, Suarez DL, editors. Diseases of Poultry. 14th ed. Hoboken (NJ): Wiley-Blackwell; 2020.',
    '6.  Bell DD, Weaver WD. Commercial Chicken Meat and Egg Production. 5th ed. Norwell (MA): Springer; 2002.',
    '7.  Tablante NL. Common Poultry Diseases and Their Prevention. College Park (MD): University of Maryland Extension; 2017.',
    '8.  Leslie M. Drinking Water Management [Technical Bulletin]. Canadian Poultry Consultants Ltd.; 2011. Available from: cpclearningcentre.ca',
    '9.  Kehler L. Darkling beetles [Technical Bulletin]. CPC Learning Centre. Available from: cpclearningcentre.ca',
    '10.  Hatch House HQ. New research update: Rethinking downtime as a biosecurity measure [Internet]. 2026 Feb 5 [cited 2026 May 27]. Available from: https://www.hatchhousehq.com/articles/new-research-update-rethinking-downtime-as-a-biosecurity-measure',
    '11.  California Department of Food and Agriculture. Poultry facility biosecurity risk assessment guide [Internet]. Sacramento: CDFA; [cited 2026 May 11]. Available from: https://www.cdfa.ca.gov/ahfss/animal_health/biospecies/pdfs/CDFAPoultryFacilitybiosecurityRiskAssessmentGuide.pdf',
    '12.  Chicken Farmers of Canada. Free Range On-Farm Food Safety Program and Animal Care Program manual [Internet]. Ottawa: Chicken Farmers of Canada; 2021 [cited 2026 May 27]. Available from: https://www.chickenfarmers.ca/wp-content/uploads/2021/08/Free-Range-OFFSP-and-ACP-Manual-2021.pdf',
    '13.  CPC Learning Centre. An Introduction to Probiotics [Technical Bulletin]. CPC Learning Centre. Available from: cpclearningcentre.ca',
    '14.  Dinev I. CEVA Handbook of Poultry Diseases. Vol 1. Libourne: CEVA Sante Animale; 2014.',
    '15.  National Farm Animal Care Council (NFACC). Code of Practice for the Care and Handling of Hatching Eggs, Breeders, Chickens and Turkeys. Lacombe (AB): NFACC; 2016.',
    '16.  CPC Learning Centre. Hatching Egg Care [Technical Bulletin]. CPC Learning Centre. Available from: cpclearningcentre.ca',
    '17.  CPC Learning Centre. Spotting Disease Early [Technical Bulletin]. CPC Learning Centre. Available from: cpclearningcentre.ca',
  ];
...
async function main() {
  ...
  const entriesWithAnchor = [
    ...
    { lvl: 1, text: 'Section 1: Understanding Salmonella', page: 6 },
    { lvl: 2, text: '1.1  What Salmonella Is', page: 6 },
    { lvl: 2, text: '1.2  The Biology of Salmonella', page: 7 },
    { lvl: 2, text: '1.3  How Salmonella Affects Birds', page: 7 },
    { lvl: 2, text: '1.4  How Salmonella Affects Humans', page: 8 },
    { lvl: 2, text: '1.5  Common Sources and How Salmonella Spreads', page: 9 },
    { lvl: 1, text: 'Section 2: Risks on the Poultry Farm', page: 10 },
    { lvl: 2, text: '2.1  Pathogen Exposure from Feed, Water, and Equipment', page: 10 },
    { lvl: 2, text: '2.2  Carriers: Poultry and Wildlife', page: 11 },
    { lvl: 2, text: '2.3  Threats from Staff and Guests', page: 12 },
    { lvl: 1, text: 'Section 3: Prevention and Control Measures', page: 13 },
    { lvl: 2, text: '3.1  Introduction to Biosecurity', page: 13 },
    { lvl: 2, text: '3.2  Feed and Water Safety', page: 14 },
    { lvl: 2, text: '3.3  Competitive Exclusion', page: 14 },
    { lvl: 2, text: '3.4  Vaccination: How Much Help Can It Offer', page: 15 },
    { lvl: 2, text: '3.5  Rodent and Pest Control', page: 15 },
    { lvl: 2, text: '3.6  Salmonella Monitoring and Testing', page: 16 },
    { lvl: 1, text: 'Section 4: Good Hygiene Practices', page: 17 },
    { lvl: 2, text: '4.1  Handwashing', page: 17 },
    { lvl: 2, text: '4.2  Boots, Coveralls, and Barn Attire', page: 17 },
    { lvl: 2, text: '4.3  Proper Housing and Litter Management Between Flocks', page: 18 },
    { lvl: 1, text: 'Section 5: Safe Processing and Storage', page: 22 },
    { lvl: 2, text: '5.1  On-Farm Handling and Pre-Harvest Preparation', page: 22 },
    { lvl: 2, text: '5.2  Temperature Control for Meat and Eggs', page: 22 },
    { lvl: 2, text: '5.3  Egg Safety: On-Farm Practices for Layer Operations', page: 23 },
    { lvl: 2, text: '5.4  Protection from Contamination During Direct Sales', page: 24 },
    { lvl: 1, text: 'Section 6: Farmer Responsibilities and Consumer Safety', page: 25 },
    { lvl: 2, text: '6.1  Regulatory Framework in Canada', page: 25 },
    { lvl: 2, text: '6.2  Documentation and Record-Keeping', page: 25 },
    { lvl: 2, text: '6.3  Daily Flock Walks and Monitoring', page: 26 },
    { lvl: 2, text: '6.4  Key Takeaways: Ensuring Safe Products for Your Customers', page: 27 },
    { lvl: 1, text: 'Recommended Peer-Reviewed Journals', page: 29 },
