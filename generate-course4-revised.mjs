...
async function main() {
  ...
  const entriesWithAnchor = [
    ...
    { lvl: 2, text: '1.1  What Salmonella Is', page: 5 },
    ...
    { lvl: 2, text: '1.5  Common Sources and How Salmonella Spreads', page: 7 },
    { lvl: 1, text: 'Section 2: Risks on the Poultry Farm', page: 8 },
    { lvl: 2, text: '2.1  Pathogen Exposure from Feed, Water, and Equipment', page: 8 },
    { lvl: 2, text: '2.2  Carriers: Poultry and Wildlife', page: 9 },
    { lvl: 2, text: '2.3  Threats from Staff and Guests', page: 10 },
    { lvl: 1, text: 'Section 3: Prevention and Control Measures', page: 10 },
    { lvl: 2, text: '3.1  Introduction to Biosecurity', page: 10 },
    { lvl: 2, text: '3.2  Feed and Water Safety', page: 11 },
    { lvl: 2, text: '3.3  Competitive Exclusion', page: 11 },
    { lvl: 2, text: '3.4  Vaccination: How Much Help Can It Offer', page: 12 },
    ...
    { lvl: 2, text: '4.2  Boots, Coveralls, and Barn Attire', page: 13 },
    { lvl: 2, text: '4.3  Proper Housing and Litter Management Between Flocks', page: 14 },
    { lvl: 1, text: 'Section 5: Safe Processing and Storage', page: 15 },
    { lvl: 2, text: '5.1  On-Farm Handling and Pre-Harvest Preparation', page: 15 },
    { lvl: 2, text: '5.2  Temperature Control for Meat and Eggs', page: 16 },
    { lvl: 2, text: '5.3  Egg Safety: On-Farm Practices for Layer Operations', page: 16 },
    { lvl: 2, text: '5.4  Protection from Contamination During Direct Sales', page: 17 },
    ...
    { lvl: 2, text: '6.2  Documentation and Record-Keeping', page: 18 },
    { lvl: 2, text: '6.3  Daily Flock Walks and Monitoring', page: 19 },
    { lvl: 2, text: '6.4  Key Takeaways: Ensuring Safe Products for Your Customers', page: 21 },
