...
function buildSection3() {
  return {
    ...
    children: [
      ...
      para([
        { text: 'One more is worth knowing about, and it is the opposite kind of story. ' },
        { text: 'Mycoplasma gallisepticum', italics: true },
        { text: ', or MG, is not new to anybody. It is an old bacterial infection that causes chronic respiratory disease, and the industry has spent decades building a system to keep it out. What makes it serious is not how fast it kills, because it usually does not. It is that a bird which gets it stays infected for life, and a positive breeder passes it down through a small share of her hatching eggs to the next generation [28]. That is why the whole control system rests on sourcing chicks from MG-free breeder flocks and proving they stay that way with regular blood testing and tight biosecurity [28]. Get MG into the top of the pyramid and you are not dealing with one barn, you are dealing with everything that hatches from it.' },
      ]),
      para('That is not a theoretical worry in British Columbia at the moment. As this course goes out, CPC veterinarians are working with MG-positive breeder flocks in the province. This is a BC picture, not a national one, and it has not been reported as a Canada-wide problem. But it is the clearest example in this course of a re-emerging disease, the old foe from Section 3.1 coming back and putting pressure on a control system that has held for years. If you take chicks from a BC breeder source, this is a conversation to have with your veterinarian and your hatchery now rather than later: know the status of the flock your chicks come from, know when it was last tested, and watch your own birds for the slow respiratory picture and the quiet production drop that MG causes. For the clinical signs and the serology behind MG testing, see Course 15 (Serology 101) in this series.'),
...
function buildReferencesSection() {
  return {
    ...
    children: [
      ...
      numberedRef('Merck Veterinary Manual. Mycoplasma gallisepticum infection in poultry. Rahway, NJ: Merck & Co.; [cited 2026 Sep]. Available from: merckvetmanual.com'),
      numberedRef([
