...
function buildSection4() {
  return {
    ...
    children: [
      ...
      para('The poultry industry did not wait to be forced. Through the Chicken Farmers of Canada Responsible Antimicrobial Use Strategy, the chicken sector eliminated the preventive use of the antibiotic categories most important to human medicine, starting with the highest-priority Category I drugs in 2014 and Category II in 2018 [31]. The plan to drop preventive use of the next tier, Category III, was reassessed. Rather than a hard ban, the sector chose to keep pushing those numbers down through voluntary work with hatcheries, feed companies, and veterinarians [31]. The payoff has been real drops in resistance in the bacteria that surveillance tracks, which is the whole point of the exercise.'),
