...
function buildSection2() {
  return {
    ...
    children: [
      ...
      para('The strain behind this is an H5N1 from clade 2.3.4.4b. It reached North America in late 2021 and has not left. More than 650 Canadian farms and flocks have been hit, roughly 17.5 million birds are gone, and British Columbia accounts for more than half of them. 2025 cost another 82 commercial flocks, and 2026 has been quieter without being over [5].'),
      para('What sets it apart is how far it has moved beyond birds. Since 2024 it has spread cow to cow through the milking process in American dairy herds, and it has killed mammals from cats and foxes to marine mammals [6]. The cattle part has not happened here. Canada has never had a confirmed case in cattle, and the American dairy strain has never been found in any animal or person in this country [7]. The CFIA has tested nearly 12,000 raw milk samples off trucks at plants in every province. All negative [8].'),
      para('People get infected too, almost always after close contact with sick animals. Canada’s record is two people. In November 2024 a 13-year-old girl in the Fraser Valley became the first to catch it inside this country. She was critically ill and she recovered [9]. She was not a poultry worker, and nobody ever found her source. The closest genetic match was the virus circulating in local wild birds [10]. The other was a traveler who brought it home from China in 2014 [11]. Neither came out of barn work or a cull, after hundreds of infected farms and millions of destroyed birds.'),
      para('The American numbers are bigger, and they show where the risk sits. About 70 cases since 2024, most of them mild, one fatal, and no spread between people [12]. Around 41 came from dairy cattle and two dozen from poultry, mostly barn workers and culling crews [12]. Both American deaths were in backyard flock owners. The one in November 2025 is worth knowing. A Washington State owner died of H5N5, the first time that virus had been found in a person [13]. It came from the owner’s own ducks. Two died. The rest of the flock tested positive while looking perfectly normal [13]. Waterfowl can carry this and show you nothing. H5N5 is here too, and it killed a backyard layer flock in Newfoundland and Labrador in early 2025 [14].'),
      para('For you the risk stays occupational, not a reason for panic. Wear protective equipment for sick or dead birds, and treat a barn with heavy unexplained death loss as a place to cover up before you walk in. Watch for fever, cough, or sore or watery eyes for a few days afterward, and if you get sick, tell your physician you work with poultry. That changes what they test you for. Get your seasonal flu shot too. It will not stop bird flu, but it lowers the odds of a human virus and a bird virus meeting in you. Canada has authorized a human H5N1 vaccine and lists people involved in poultry culling among the priority groups, though each province decides whether to offer it [15,16]. For the full protective-equipment routine, see Course 8 (Fundamentals of Poultry Vaccination and Treatment) in this series.'),
      ...image(figBuf('fig2.jpg'), 'Figure 2.1: The widening reach of H5N1 clade 2.3.4.4b, from its wild bird reservoir out into farmed and wild mammals and, rarely, into people. Source: CPC Short Courses.'),

      h2('2.2 How It Spreads and Gets Onto Farms'),
      para('The natural home of avian influenza is wild waterfowl. Ducks and geese carry the virus and shed it in their droppings, often without looking sick at all [1,17]. That is what makes it so hard to keep out. The reservoir is flying overhead and landing on the pond next to your barn, and it gives no warning. Those birds do not wander at random. North America has four migration corridors, and every Canadian province and territory sits under one of them [18]. The virus comes in by more than one door. It arrived from northwestern Europe into the Atlantic and showed up first in St. John’s, Newfoundland, in December 2021 [19]. Seven more introductions came out of Asia through the Pacific in 2022, and one of those re-emerged in late 2024 as D1.1, the genotype that then spread west to east [18,20]. This strain also kills wild birds, across species that used to carry influenza without much trouble [20].'),
      ...image(figBuf('fig18_flyways_map.png'), 'Figure 2.2: The four flyways that bring avian influenza to Canada, and the two directions it has arrived from. The colored areas are administrative flyway regions, not exact migration corridors. Source: CPC Short Courses.'),
      ...
      para('When the CFIA confirms HPAI on a farm, it moves quickly to stamp it out before it spreads. Your farm goes under quarantine, formally called a Declaration of Infected Place, and no birds, eggs, or manure move on or off the property without CFIA permission [22]. The agency also draws a primary control zone around the area and controls movement inside it [23]. That zone normally reaches 10 kilometers out from the infected barn: an infected zone covering the first 3 kilometers, then a restricted zone from 3 to 10 [24]. Those distances are a starting point rather than a fixed rule. The CFIA adjusts them for local topography and how densely poultry sits around the site, and the zones grow and merge as more farms break [24]. The flock is humanely destroyed, then the barn is stripped of litter and manure and wet cleaned and disinfected. New birds normally cannot come in until at least 14 days after the final cleaning and disinfection inspection is approved [22].'),
      para('Now the part that catches far more farms than the disease itself. When a control zone goes up, every poultry farm inside it is affected, not just the infected one. If your flock is healthy and your neighbor is the one who broke, you are still inside the zone. Being inside it does not mean your birds are destroyed. The CFIA depopulates positive flocks and the barns tied to them as one unit, not every farm within a set distance [24]. Birds, hatching eggs, table eggs, manure, litter, feed, and anything else that has been around birds cannot move into, out of, within, or through that zone without CFIA permission [25]. Some movements run under a general permit and some need a specific one, and the CFIA runs an online tool that tells you which applies to the move you need to make [25]. This is the outbreak experience most producers actually have. Know before it happens who at your processor, hatchery, and feed mill handles permits, because the week your neighbor breaks is a bad week to be working that out from scratch.'),
      para('Be clear-eyed about compensation too. The CFIA pays for animals and things it orders destroyed and for the cost of disposing of them, at market value up to maximum amounts set in the regulations [26]. Those maximums are ceilings, and the agency says plainly that compensation may not cover full replacement value. Two things it does not cover are worth knowing before you need them: loss of future revenue, and anything ordered cleaned and disinfected [26]. So the birds are paid for within limits, but the empty weeks, the lost production, and the cleanout labor largely sit with you. Talk to your marketing board and your insurance provider about that gap while things are calm.'),
      para('One more thing that does not appear in any CFIA document. Watching a flock you raised get depopulated is hard, and it is harder still when it is your family farm, your barn, and your year of work. Producers who have been through it describe it as a grief, and the quiet weeks afterward with empty barns can be worse than the day itself. That reaction is normal and it is common. The Do More Agriculture Foundation runs mental health support built for Canadian farmers, including a moderated peer support community, and most provinces have a farm-specific help line as well [27]. Use them, and watch for it in your staff and your neighbors too.'),
      h2('2.5 The Vaccination Question'),
      para('The question the whole sector is watching is whether vaccination will ever join that response. Canada\'s answer to bird flu has always been to stamp it out, not to vaccinate. Part of the reason is trade, because vaccinating a flock can complicate exports and has to be weighed against its effect on surveillance, so Canada has stayed cautious [28]. But the sheer length of this outbreak has pushed the question back onto the table. A CFIA task force formed in 2023 has been weighing whether vaccination could earn a place in the response [23], and that work has now moved off paper. In August 2026 the CFIA launched a confined field trial on two commercial farms in Manitoba, starting with an egg-laying operation, with a turkey operation expected to join in 2027 [29]. The agency is blunt about what this is and is not. It is there to gather evidence on whether the vaccines work and how you would even deliver them on a working farm. It is not a decision to vaccinate, not a national program, and not a change to any current control measure [29]. Vaccinated birds can still be infected and still spread the virus, so vaccination would sit on top of biosecurity, never in place of it [29]. None of this makes vaccination an option on your farm today, and any real change would arrive with new rules and trade talks attached. It is the live policy question in the sector, so keep an eye on the CFIA for where it lands [28].'),
      h2('2.6 Surveillance and Protecting Your Flock'),
      para('Behind the scenes, Canada runs a national surveillance program called the Canadian Notifiable Avian Influenza Surveillance System, or CanNAISS. It watches for the virus through testing in flocks that show signs, before slaughter, and in hatcheries, and it is what lets Canada prove to trading partners that its flocks are monitored [30]. That surveillance, plus a fast, organized response, is what keeps an outbreak from spreading farm to farm.'),
      para('Your part is prevention, and it matters most when the risk is highest. Raise your guard during spring and fall migration, when wild birds are moving and the virus is most active. The CPC Learning Centre Spotting Disease Early guide reinforces the habit that protects you: walk the barn every day, know your normal numbers, and act the moment something looks off [31]. Keep wild birds away from your feed and water, tighten who and what comes through your door, and never let a suspicious death loss sit unreported.'),
    ],
  };
}
...
function buildSection3() {
  return {
    ...
    children: [
      ...
      para('An emerging disease is one that is new, newly arrived in an area, or suddenly behaving worse than it used to. A re-emerging disease is an old foe coming back, often in a changed form that the usual vaccines or management do not fully cover [17]. The two ideas blur together in practice, and both keep landing on Canadian farms.'),
      ...
      para('It works like this. Your daily observations, and the birds and samples your veterinarian sends to a provincial diagnostic laboratory, are how new and unusual problems first get spotted. The work that identified the DMV/1639 strain in Canada came out of exactly this kind of laboratory testing of field cases [32]. Those labs feed their results into national systems, including the avian influenza surveillance run through CanNAISS, so that a threat appearing on scattered farms is recognized as a pattern early rather than discovered one barn at a time [30]. The earlier the pattern is seen, the faster vaccines, alerts, and management advice can catch up to it.'),

      h2('3.4 What Farmers Should Do'),
      para('For all the science and surveillance behind it, the most powerful early-warning tool in the country is still a farmer who walks the barn every day and reports what does not look right. You are the first link in the chain, and a problem you catch and report on Monday is far cheaper for everyone than the same problem found across the region a month later [31].'),
...
function buildSection4() {
  return {
    ...
    children: [
      ...
      para('The last hot topic in this course is not a disease at all. It is antimicrobial resistance, or AMR, and it builds quietly behind every antibiotic treatment given, on farms and in hospitals alike. It has gone from a background worry to a front-page issue for the whole poultry industry, and it is one of the few topics where what you do in your barn is directly connected to human health.'),
      ...
      para([
        ...
        { text: ', which turned up in Canada in an Ontario broiler flock in 2008 and shows itself as lameness, sore joints, and birds going down on their legs [45]. Both are getting harder to treat. Canadian surveillance running from the farm through to retail keeps finding ' },
        { text: 'E. coli', italics: true },
        { text: ' carrying resistance to antimicrobials that matter in human medicine [46], and broiler ' },
        { text: 'E. cecorum', italics: true },
        { text: ' isolates carry resistance genes for tetracycline, lincomycin, spectinomycin, tylosin, and even vancomycin, sitting on mobile pieces of DNA that pass between bacteria [47]. That is the thing stewardship is really protecting: the day the usual treatment stops working on a bug that is already in your barn.' },
      ]),
...
function buildReferencesSection() {
  return {
    ...
    children: [
      ...
      numberedRef('Public Health Agency of Canada. Avian Influenza A(H5Nx) public health knowledge gaps and research needs. Ottawa, ON: Public Health Agency of Canada; 2025. Available from: publications.gc.ca'),
      numberedRef('Canadian Food Inspection Agency. Milk sampling and testing for highly pathogenic avian influenza (HPAI) in Canada. Ottawa: CFIA; [cited 2026 Sep]. Available from: inspection.canada.ca'),
      numberedRef('MacBain E, Znait A, Edwards L, Jassem A, Barakauskas VE, Harris KC, et al. Management of critical illness in an adolescent caused by highly pathogenic avian influenza A(H5N1) virus infection in British Columbia, Canada. Lancet Infect Dis. 2026;26(7):e326-e334. doi:10.1016/S1473-3099(25)00773-X'),
      numberedRef('Himsworth CG, Caleta JM, Jassem AN, Yang KC, Zlosnik JEA, Tyson JR, et al. Highly pathogenic avian influenza A(H5N1) in wild birds and a human, British Columbia, Canada, 2024. Emerg Infect Dis. 2025;31(6):1216-1221. doi:10.3201/eid3106.241862'),
      numberedRef('Public Health Agency of Canada. Human Emerging Respiratory Pathogens Bulletin. Issue 96. Ottawa: PHAC; 2024 Dec. Cat. No.: HP38-6E-PDF. Available from: publications.gc.ca'),
      ...
      numberedRef('Canadian Poultry Magazine. H5N5 bird flu detected on backyard farm in Newfoundland and Labrador. Simcoe, ON: Annex Business Media; 2025 Feb 20 [cited 2026 Sep]. Available from: canadianpoultrymag.com'),
      ...
      numberedRef('National Advisory Committee on Immunization. NACI rapid response: preliminary guidance on human vaccination against avian influenza in a non-pandemic context as of December 2024. Ottawa: Public Health Agency of Canada; 2025 Feb 19. Available from: canada.ca'),
      numberedRef('Thomas NJ, Hunter DB, Atkinson CT, editors. Infectious Diseases of Wild Birds. Ames, IA: Blackwell Publishing; 2007.'),
      numberedRef('Scotch M, Faleye TOC, Urquidez-Negrete A, Varsani A, Fan A, Justice-Allen A. Rapid expansion of highly pathogenic avian influenza A(H5N1) clade 2.3.4.4b genotype D1.1 virus across flyway regions, North America, fall 2024. Emerg Infect Dis. 2026;32(8):1241-1250. doi:10.3201/eid3208.260205'),
      numberedRef('Caliendo V, Lewis NS, Pohlmann A, Baillie SR, Banyard AC, Beer M, et al. Transatlantic spread of highly pathogenic avian influenza H5N1 by wild birds from Europe to North America in 2021. Sci Rep. 2022;12(1):11729. doi:10.1038/s41598-022-13447-z'),
      numberedRef('Damodaran L, Jaeger AS, Moncla LH. Ecology and spread of the North American H5N1 epizootic. Nature. 2025;649(8096):432-441. doi:10.1038/s41586-025-09737-x'),
      ...
      numberedRef('Chicken Farmers of Canada. Avian Influenza Handbook: a guide to events and protocols when Avian Influenza is detected. Version 1.6. Ottawa: Chicken Farmers of Canada; 2024 [cited 2026 Sep]. Available from: chickenfarmers.ca'),
      ...
      numberedRef([
        { text: 'Dutil L, Irwin R, Finley R, Ng LK, Avery B, Boerlin P, et al. Ceftiofur resistance in ' },
      ...
      numberedRef([
        { text: 'Stalker MJ, Brash ML, Weisz A, Ouckama RM, Slavic D. Arthritis and osteomyelitis associated with ' },
        { text: 'Enterococcus cecorum', italics: true },
        { text: ' infection in broiler and broiler breeder chickens in Ontario, Canada. J Vet Diagn Invest. 2010;22(4):643-645. doi:10.1177/104063871002200426' },
      ]),
      numberedRef([
        { text: 'Medrano H, Hill S, Boulianne M, Cereno T, Deckert AE, Charlebois A, et al. Widespread dissemination of ' },
        { text: 'Salmonella', italics: true }, { text: ', ' },
        { text: 'Escherichia coli', italics: true }, { text: ' and ' },
        { text: 'Campylobacter', italics: true },
        { text: ' resistant to medically important antimicrobials in the poultry production continuum in Canada. PLOS One. 2025;20(2):e0319086. doi:10.1371/journal.pone.0319086' },
      ]),
      numberedRef([
        { text: 'Huang Y, Boyen F, Antonissen G, Vereecke N, Van Immerseel F. The genetic landscape of antimicrobial resistance genes in ' },
        { text: 'Enterococcus cecorum', italics: true },
        { text: ' broiler isolates. Antibiotics (Basel). 2024;13(5):409. doi:10.3390/antibiotics13050409' },
      ]),
    ],
  };
}
...
async function main() {
  ...
  const entriesWithAnchor = [
    ...
    { lvl: 2, text: '2.3 Recognizing It and Your Legal Duty to Report', page: 10 },
    { lvl: 2, text: '2.4 The Outbreak Response and What Happens to Your Farm', page: 11 },
    { lvl: 2, text: '2.5 The Vaccination Question', page: 12 },
    { lvl: 2, text: '2.6 Surveillance and Protecting Your Flock', page: 13 },
    { lvl: 1, text: 'Section 3: Emerging and Re-Emerging Disease Issues', page: 14 },
    { lvl: 2, text: '3.1 What Emerging Means and What Drives It', page: 14 },
    { lvl: 2, text: '3.2 Diseases on the Radar in Canada', page: 14 },
    { lvl: 2, text: '3.3 Surveillance and Early Warning', page: 17 },
    { lvl: 2, text: '3.4 What Farmers Should Do', page: 18 },
    { lvl: 1, text: 'Section 4: Antimicrobial Resistance (AMR)', page: 19 },
    { lvl: 2, text: '4.1 What AMR Is and Why It Is a Hot Topic', page: 19 },
    { lvl: 2, text: '4.2 What Canada and the Poultry Industry Are Doing About It', page: 19 },
    { lvl: 2, text: '4.3 What It Means for Your Farm', page: 20 },
