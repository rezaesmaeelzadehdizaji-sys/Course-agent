...
function buildSection2() {
  return {
    ...
    children: [
      ...
      para('People have been infected too, almost always after close contact with sick animals. Start with Canada, because that is the record that applies to you. In November 2024 a 13-year-old girl in the Fraser Valley became the first person to catch this virus inside this country. She spent weeks in intensive care and recovered [9]. She was not a poultry worker, and public health never found where she picked it up. The closest genetic match was what was circulating in the local wild birds [10]. That is the whole Canadian list, along with one traveler who brought it home from China in 2014 [11]. Now read what is not on it. Hundreds of infected farms and millions of destroyed birds since 2021, and not one confirmed human illness out of barn work or a cull.'),
      para('The American picture is bigger, and it shows where the risk actually sits. The United States has counted about 70 human H5N1 cases since 2024, most of them mild, one fatal, and no spread between people [12]. Around 41 came from dairy cattle and two dozen from poultry, most of those barn work and culling crews on commercial farms [12]. Both American deaths, though, were in people keeping birds at home. The second one, in November 2025, is the one to know. A Washington State backyard flock owner died of H5N5, the first time that virus had been found in a person [13]. It was traced to the owner’s own ducks and the sediment in their watering basin. Two ducks sickened and died. The rest of the flock tested positive while looking perfectly normal [13]. That is the part to take home: waterfowl can carry this and show you next to nothing. About 135 contacts were monitored and not one tested positive [13].'),
      para('And H5N5 is not only an American problem. In early 2025 it killed a backyard layer flock in Newfoundland and Labrador, a close relative of an H5N5 already here in 2023 and part of the same 2.3.4.4b family as the H5N1 hitting Canadian barns [14]. For the average farmer the human risk is still an occupational one, tied to close contact with birds and the wet ground they live on, not a reason for panic.'),
