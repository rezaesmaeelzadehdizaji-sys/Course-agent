...
function buildSection2() {
  return {
    ...
    children: [
      ...
      ...image(figBuf('fig18_flyways_map.png'), 'Figure 2.2: The four flyways that bring avian influenza to Canada. Every province and territory sits under one, and Saskatchewan sits under two. The virus has come in from northwestern Europe on the Atlantic side and repeatedly out of East Asia by way of Alaska on the Pacific side. Birds move north to breed in spring and south to winter in fall, mixing on shared water at both ends. The colored areas are administrative flyway regions, not exact migration corridors. Source: CPC Short Courses.'),
      ...
      ...image(figBuf('fig1-new.jpg'), 'Figure 2.3: How avian influenza reaches your barn. The virus starts in wild birds and rides onto the farm on contaminated water and feed, on people and clothing, on shared equipment, and on rodents and small wild birds. Source: CPC Short Courses.'),
