...
function buildSection2() {
  return {
    ...
    children: [
      ...
      para('What makes this strain different is how far it has spread beyond birds. Since 2024 it has infected dairy cattle in the United States, passing from cow to cow through the milking process, something never seen with this virus before [6]. It has killed cats, foxes, skunks, and marine mammals, and it has turned up in sheep, goats, and other farmed mammals [6]. The dairy part has not happened here. Canada has never had a confirmed case in cattle, and the strain behind the American dairy outbreak has never turned up in any animal or person in this country [7]. The CFIA has been testing milk for it since 2024. By September 2026 it had run nearly 12,000 raw milk samples off trucks arriving at plants in every province. All negative [8].'),
      para('People have been infected too, almost always after close contact with sick animals. Start with Canada, because that is the record that applies to you, and it happened right in poultry country. In November 2024 a 13-year-old girl in the Fraser Valley became the first person to catch this virus inside this country [9]. She got very sick. She spent weeks in intensive care, first on a ventilator and then on a machine that took over for her lungs. She recovered and went home [9]. Two things about her case are worth carrying with you. She was not a poultry worker, and public health never did find where she picked it up. What they could say is that the virus in her samples was closest to what was circulating in the local wild birds at the time [10]. The obvious exposure is not always the real one, and in a valley carrying that much virus in the wild bird population, the barn is not the only place it lives.'),
      para('Set that beside the size of the outbreak and the Canadian human record is a short list. Two people in this country have been confirmed with H5N1, ever. The girl in the Fraser Valley, and one traveler who brought it home from China back in 2014 [11]. Federal reporting a year on still showed the same single home-grown case, with her source still unknown [7]. Now read what is not on that list. Canada has been through hundreds of infected farms and millions of destroyed birds since 2021, and not one confirmed human illness has come out of barn work or a cull. That is a record worth protecting.'),
      para('The American picture is bigger, and it is worth knowing because it shows you where the risk actually sits. By the middle of 2026 the United States had reported about 70 human H5N1 cases since 2024, most of them mild, one of them fatal, and no sign of the virus passing from person to person [12]. Those people were not mostly backyard keepers. Around 41 caught it from infected dairy cattle. Another two dozen or so caught it from poultry, and most of those were people working in barns or on culling crews during an outbreak [12]. Those were commercial operations and paid workers. Both of the American deaths, though, were in people keeping birds at home. The second one, in November 2025, is the one worth knowing about. A Washington State backyard flock owner died after catching a related virus called H5N5, the first time that virus had ever been found in a person [13]. Investigators traced it back to the owner’s own ducks and the sediment in their watering basin [13]. Two ducks did sicken and die. The rest of the flock tested positive while looking perfectly normal [13]. That is the part to take home: waterfowl can be carrying a dangerous virus and show you next to nothing. About 135 people connected to that case were monitored. Fifteen came down with something that looked like it, and not one of them tested positive [13]. For the average farmer the human risk is still an occupational one, tied to close contact with birds and the wet ground they live on, not a reason for panic.'),
      para('One thing about that Washington virus is closer to home than it sounds. H5N5 is already in Canada. In early 2025 it killed a backyard layer flock in Newfoundland and Labrador [14]. The strain was a close relative of an H5N5 that had been in this country back in 2023, and it belongs to the same 2.3.4.4b family as the H5N1 that has been hitting Canadian barns [14]. So the subtype making headlines somewhere else can already be sitting in a flock on the other side of this country.'),
      para('So what do you actually do about it? Wear protective equipment when you handle sick or dead birds, and treat a barn with heavy unexplained death loss as a place to cover up before you walk in. Watch yourself for fever, cough, or sore or watery eyes for a few days after that kind of exposure, and if you get sick, tell your physician you work with poultry. That one sentence changes what they test you for. Get your seasonal flu shot too. It does not protect you against bird flu, but it lowers the chance of a human flu virus and a bird flu virus meeting in the same person, which is how a virus that spreads between people could be built. Canada has also authorized a human H5N1 vaccine and holds a supply of it [15,16]. The national immunization committee names people involved in poultry culling as one of the groups to prioritize for it [16]. Do not read that as a dose with your name on it. The recommendation is discretionary, and each province decides whether to offer the vaccine and to whom [16]. If you expect to be on a cull crew, ask your provincial health authority where that stands before you need it. For the full protective-equipment routine, see Course 8 (Fundamentals of Poultry Vaccination and Treatment) in this series.'),
      ...
      para('When the CFIA confirms HPAI on a farm, it moves quickly to stamp it out before it spreads. Your farm goes under quarantine, formally called a Declaration of Infected Place, and no birds, eggs, or manure move on or off the property without CFIA permission [19]. The agency also draws a primary control zone around the area and controls movement inside it [20]. The flock is humanely destroyed, then the barn is stripped of litter and manure and wet cleaned and disinfected. New birds normally cannot come in until at least 14 days after the final cleaning and disinfection inspection is approved [19].'),
      para('Now the part that catches far more farms than the disease itself. When a control zone goes up, every poultry farm inside it is affected, not just the infected one. If your flock is healthy and your neighbor is the one who broke, you are still inside the zone. Birds, hatching eggs, table eggs, manure, litter, feed, and anything else that has been around birds cannot move into, out of, within, or through that zone without CFIA permission [21]. Some movements run under a general permit and some need a specific one, and the CFIA runs an online tool that tells you which applies to the move you need to make [21]. This is the outbreak experience most producers actually have. Know before it happens who at your processor, hatchery, and feed mill handles permits, because the week your neighbor breaks is a bad week to be working that out from scratch.'),
      para('Be clear-eyed about compensation too. The CFIA pays for animals and things it orders destroyed and for the cost of disposing of them, at market value up to maximum amounts set in the regulations [22]. Those maximums are ceilings, and the agency says plainly that compensation may not cover full replacement value. Two things it does not cover are worth knowing before you need them: loss of future revenue, and anything ordered cleaned and disinfected [22]. So the birds are paid for within limits, but the empty weeks, the lost production, and the cleanout labor largely sit with you. Talk to your marketing board and your insurance provider about that gap while things are calm.'),
      para('One more thing that does not appear in any CFIA document. Watching a flock you raised get depopulated is hard, and it is harder still when it is your family farm, your barn, and your year of work. Producers who have been through it describe it as a grief, and the quiet weeks afterward with empty barns can be worse than the day itself. That reaction is normal and it is common. The Do More Agriculture Foundation runs mental health support built for Canadian farmers, including a moderated peer support community, and most provinces have a farm-specific help line as well [23]. Use them, and watch for it in your staff and your neighbors too.'),
      h2('2.5 The Vaccination Question'),
      para('The question the whole sector is watching is whether vaccination will ever join that response. Canada\'s answer to bird flu has always been to stamp it out, not to vaccinate. Part of the reason is trade, because vaccinating a flock can complicate exports and has to be weighed against its effect on surveillance, so Canada has stayed cautious [24]. But the sheer length of this outbreak has pushed the question back onto the table. A CFIA task force formed in 2023 has been weighing whether vaccination could earn a place in the response [20], and that work has now moved off paper. In August 2026 the CFIA launched a confined field trial on two commercial farms in Manitoba, starting with an egg-laying operation, with a turkey operation expected to join in 2027 [25]. The agency is blunt about what this is and is not. It is there to gather evidence on whether the vaccines work and how you would even deliver them on a working farm. It is not a decision to vaccinate, not a national program, and not a change to any current control measure [25]. Vaccinated birds can still be infected and still spread the virus, so vaccination would sit on top of biosecurity, never in place of it [25]. None of this makes vaccination an option on your farm today, and any real change would arrive with new rules and trade talks attached. It is the live policy question in the sector, so keep an eye on the CFIA for where it lands [24].'),
      h2('2.6 Surveillance and Protecting Your Flock'),
      para('Behind the scenes, Canada runs a national surveillance program called the Canadian Notifiable Avian Influenza Surveillance System, or CanNAISS. It watches for the virus through testing in flocks that show signs, before slaughter, and in hatcheries, and it is what lets Canada prove to trading partners that its flocks are monitored [26]. That surveillance, plus a fast, organized response, is what keeps an outbreak from spreading farm to farm.'),
      para('Your part is prevention, and it matters most when the risk is highest. Raise your guard during spring and fall migration, when wild birds are moving and the virus is most active. The CPC Learning Centre Spotting Disease Early guide reinforces the habit that protects you: walk the barn every day, know your normal numbers, and act the moment something looks off [27]. Keep wild birds away from your feed and water, tighten who and what comes through your door, and never let a suspicious death loss sit unreported.'),
    ],
  };
}
...
function buildSection3() {
  return {
    ...
    children: [
      ...
      para('DMV/1639 is also not the end of the story for infectious bronchitis. This virus is a shape-shifter that swaps pieces of its genetic code with other strains, and Canadian diagnostic labs keep turning up brand-new versions. As recently as 2024, two previously unrecognized IBV variants were found in Canadian flocks hit by drops in egg production, each one a recombinant that had blended parts of other viruses into something new [30]. The worry with any new variant is always the same. The vaccine that protected your birds against last year’s strain may not fully cover this year’s, which is why a strain your program handled five years ago is worth rechecking with your veterinarian today.'),
      para('A different disease has been climbing in Canadian broiler barns: inclusion body hepatitis, or IBH. It is caused by fowl adenoviruses, and it usually hits broilers between three and five weeks old as a sudden jump in deaths, with pale, swollen, mottled livers showing up at post-mortem [31]. What marks it as a genuine emerging disease is the trend. IBH outbreaks have been rising in Canada and worldwide since about 2015 [31], and the mix of virus types behind them has shifted. FAdV8b is now the strain found most often, where FAdV8a and FAdV11 used to share the load [32]. IBH has long been the kind of disease that moves in after something else has weakened the birds, usually infectious bursal disease or chicken anemia virus. It now turns up in flocks as a primary problem on its own too [31]. Either way, it is a reminder to look past the liver and ask what else is going on in that flock.'),
      ...
      para([
        ...
        { text: ' than usual behind it [34]. Vaccines are in limited use in Canada under CFIA-approved doses while full licensing is worked out, so this is a live conversation to have with your veterinarian rather than a settled program [34]. The lesson to take from aMPV is the one this whole section is built on. A disease that was somebody else\u2019s problem in 2023 was in Canadian barns in 2024 and endemic by 2025. That is how fast the map changes.' },
      ]),
      ...
      para('It works like this. Your daily observations, and the birds and samples your veterinarian sends to a provincial diagnostic laboratory, are how new and unusual problems first get spotted. The work that identified the DMV/1639 strain in Canada came out of exactly this kind of laboratory testing of field cases [28]. Those labs feed their results into national systems, including the avian influenza surveillance run through CanNAISS, so that a threat appearing on scattered farms is recognized as a pattern early rather than discovered one barn at a time [26]. The earlier the pattern is seen, the faster vaccines, alerts, and management advice can catch up to it.'),

      h2('3.4 What Farmers Should Do'),
      para('For all the science and surveillance behind it, the most powerful early-warning tool in the country is still a farmer who walks the barn every day and reports what does not look right. You are the first link in the chain, and a problem you catch and report on Monday is far cheaper for everyone than the same problem found across the region a month later [27].'),
  ...
  return {
    ...
    children: [
      ...
      para([
        ...
        { text: ', which turned up in Canada in an Ontario broiler flock in 2008 and shows itself as lameness, sore joints, and birds going down on their legs [41]. Both are getting harder to treat. Canadian surveillance running from the farm through to retail keeps finding ' },
        { text: 'E. coli', italics: true },
        { text: ' carrying resistance to antimicrobials that matter in human medicine [42], and broiler ' },
        { text: 'E. cecorum', italics: true },
        { text: ' isolates carry resistance genes for tetracycline, lincomycin, spectinomycin, tylosin, and even vancomycin, sitting on mobile pieces of DNA that pass between bacteria [43]. That is the thing stewardship is really protecting: the day the usual treatment stops working on a bug that is already in your barn.' },
      ]),
