...
function buildSection2() {
  return {
    ...
    children: [
      ...
      para('The natural home of avian influenza is wild waterfowl. Ducks and geese carry the virus and shed it in their droppings, often without looking sick at all [1,18]. That is what makes it so hard to keep out. The reservoir is flying overhead and landing on the pond next to your barn, and it gives no warning. Those birds do not wander at random. North America has four migration corridors, and between them they cover every Canadian province and territory [19]. The virus comes in by more than one door. It arrived from northwestern Europe into the Atlantic and showed up first in St. John’s, Newfoundland, in December 2021 [20]. Seven more introductions came out of Asia through the Pacific in 2022, and one of those re-emerged in late 2024 as D1.1, the genotype that then spread west to east [19,21]. This strain also kills wild birds, across species that used to carry influenza without much trouble [21].'),
      ...
      para('When the CFIA confirms HPAI on a farm, it moves quickly to stamp it out before it spreads. Your farm goes under quarantine, formally called a Declaration of Infected Place, and no birds, eggs, or manure move on or off the property without CFIA permission [23]. The agency also draws a primary control zone around the area and controls movement inside it [24]. That zone normally reaches 10 kilometers out from the infected barn: an infected zone covering the first 3 kilometers, then a restricted zone from 3 to 10 [25]. Those distances are a starting point rather than a fixed rule. The CFIA adjusts them for local topography and how densely poultry sits around the site, and the zones grow and merge as more farms break [25]. The flock is humanely destroyed, then the barn is stripped of litter and manure and wet cleaned and disinfected. New birds normally cannot come in until at least 14 days after the final cleaning and disinfection inspection is approved [23].'),
      para('Now the part that catches far more farms than the disease itself. When a control zone goes up, every poultry farm inside it is affected, not just the infected one. If your flock is healthy and your neighbor is the one who broke, you are still inside the zone. Being inside it does not mean your birds are destroyed. The CFIA depopulates positive flocks and the barns tied to them as one unit, not every farm within a set distance [25]. Birds, hatching eggs, table eggs, manure, litter, feed, and anything else that has been around birds cannot move into, out of, within, or through that zone without CFIA permission [26]. Some movements run under a general permit and some need a specific one, and the CFIA runs an online tool that tells you which applies to the move you need to make [26]. This is the outbreak experience most producers actually have. Know before it happens who at your processor, hatchery, and feed mill handles permits, because the week your neighbor breaks is a bad week to be working that out from scratch.'),
      para('Be clear-eyed about compensation too. The CFIA pays for animals and things it orders destroyed and for the cost of disposing of them, at market value up to maximum amounts set in the regulations [27]. Those maximums are ceilings, and the agency says plainly that compensation may not cover full replacement value. Two things it does not cover are worth knowing before you need them: loss of future revenue, and anything ordered cleaned and disinfected [27]. So the birds are paid for within limits, but the empty weeks, the lost production, and the cleanout labor largely sit with you. Talk to your marketing board and your insurance provider about that gap while things are calm.'),
      para('One more thing that does not appear in any CFIA document. Watching a flock you raised get depopulated is hard, and it is harder still when it is your family farm, your barn, and your year of work. Producers who have been through it describe it as a grief, and the quiet weeks afterward with empty barns can be worse than the day itself. That reaction is normal and it is common. The Do More Agriculture Foundation runs mental health support built for Canadian farmers, including a moderated peer support community, and most provinces have a farm-specific help line as well [28]. Use them, and watch for it in your staff and your neighbors too.'),
      h2('2.5 The Vaccination Question'),
      para('The question the whole sector is watching is whether vaccination will ever join that response. Canada\'s answer to bird flu has always been to stamp it out, not to vaccinate. Part of the reason is trade, because vaccinating a flock can complicate exports and has to be weighed against its effect on surveillance, so Canada has stayed cautious [29]. But the sheer length of this outbreak has pushed the question back onto the table. A CFIA task force formed in 2023 has been weighing whether vaccination could earn a place in the response [24], and that work has now moved off paper. In August 2026 the CFIA launched a confined field trial on two commercial farms in Manitoba, starting with an egg-laying operation, with a turkey operation expected to join in 2027 [30]. The agency is blunt about what this is and is not. It is there to gather evidence on whether the vaccines work and how you would even deliver them on a working farm. It is not a decision to vaccinate, not a national program, and not a change to any current control measure [30]. Vaccinated birds can still be infected and still spread the virus, so vaccination would sit on top of biosecurity, never in place of it [30]. None of this makes vaccination an option on your farm today, and any real change would arrive with new rules and trade talks attached. It is the live policy question in the sector, so keep an eye on the CFIA for where it lands [29].'),
      h2('2.6 Surveillance and Protecting Your Flock'),
      para('Behind the scenes, Canada runs a national surveillance program called the Canadian Notifiable Avian Influenza Surveillance System, or CanNAISS. It watches for the virus through testing in flocks that show signs, before slaughter, and in hatcheries, and it is what lets Canada prove to trading partners that its flocks are monitored [31]. That surveillance, plus a fast, organized response, is what keeps an outbreak from spreading farm to farm.'),
      para('Your part is prevention, and it matters most when the risk is highest. Raise your guard during spring and fall migration, when wild birds are moving and the virus is most active. The CPC Learning Centre Spotting Disease Early guide reinforces the habit that protects you: walk the barn every day, know your normal numbers, and act the moment something looks off [32]. Keep wild birds away from your feed and water, tighten who and what comes through your door, and never let a suspicious death loss sit unreported.'),
    ],
  };
}
...
function buildSection3() {
  return {
    ...
    children: [
      ...
      para('An emerging disease is one that is new, newly arrived in an area, or suddenly behaving worse than it used to. A re-emerging disease is an old foe coming back, often in a changed form that the usual vaccines or management do not fully cover [18]. The two ideas blur together in practice, and both keep landing on Canadian farms.'),
      ...
      para('Avian influenza jumping into dairy cattle and other mammals, covered in Section 2, is itself a textbook case of a virus emerging into new territory. But it is not the only one on the Canadian radar. A clear, closer-to-home example is a variant strain of infectious bronchitis virus known as DMV/1639. This is the re-emerging kind: infectious bronchitis is an old foe in Canadian barns, back in a form the usual vaccines do not fully cover. It was first picked up in Canada in 2015, in an Ontario layer flock with production problems and rising mortality. It spread fast. By 2016 it was the most important viral chicken pathogen in the province, and it is now the most frequently detected infectious bronchitis variant in Canadian diagnostic submissions [33]. That picture leans east, where DMV/1639 has been the dominant strain since 2015 [34]. A 2015 to 2016 study of Alberta and Saskatchewan layer flocks found mostly Massachusetts type virus [35], and for British Columbia nobody has published enough genotyping to name a leading strain [33]. If you farm west, ask your veterinarian what is circulating near you rather than assuming the Ontario picture is yours.'),
      para('What makes DMV/1639 a good lesson is how quietly it does its damage. It can infect young pullets and harm the developing reproductive tract, producing what is called false layer syndrome. The hens look perfectly healthy but never lay the way they should, so the loss shows up as missing eggs rather than sick birds [34]. It is a reminder that emerging diseases do not always announce themselves with dramatic death loss.'),
      ...
      para('Infectious bronchitis is also a shape-shifter. It swaps pieces of its genetic code with other strains, and Canadian labs keep turning up new versions. In 2024 alone, two previously unrecognized recombinant variants turned up in Canadian flocks with egg production drops [36]. The worry is always the same: the vaccine that covered last year’s strain may not cover this year’s. A program that worked five years ago is worth rechecking with your veterinarian today.'),
      para('A different disease has been climbing in Canadian broiler barns: inclusion body hepatitis, or IBH. It is caused by fowl adenoviruses, and it usually hits broilers between three and five weeks old as a sudden jump in deaths, with pale, swollen, mottled livers showing up at post-mortem [37]. What marks it as a genuine emerging disease is the trend. IBH outbreaks have been rising in Canada and worldwide since about 2015 [37,38], and the mix of virus types behind them has shifted. Canada has been here before: breeder vaccination against FAdV8a and FAdV11, brought in across Ontario in 2010, pushed IBH down for a few years, until FAdV8b arrived and largely displaced both [38]. FAdV8b is now the strain found most often, which makes it worth asking your veterinarian whether your breeder program still covers what is circulating [38]. IBH has long been the kind of disease that moves in after something else has weakened the birds, usually infectious bursal disease or chicken anemia virus. It now turns up in flocks as a primary problem on its own too [37]. Either way, it is a reminder to look past the liver and ask what else is going on in that flock.'),
      ...
      para([
        ...
        { text: ' than usual behind it [40]. Vaccines are in limited use in Canada under CFIA-approved doses while full licensing is worked out, so this is a live conversation to have with your veterinarian rather than a settled program [40]. The lesson to take from aMPV is the one this whole section is built on. A disease that was somebody else\u2019s problem in 2023 was in Canadian barns in 2024 and endemic by 2025. That is how fast the map changes.' },
      ]),
      ...
      para('It works like this. Your daily observations, and the birds and samples your veterinarian sends to a provincial diagnostic laboratory, are how new and unusual problems first get spotted. The work that identified the DMV/1639 strain in Canada came out of exactly this kind of laboratory testing of field cases [33]. Those labs feed their results into national systems, including the avian influenza surveillance run through CanNAISS, so that a threat appearing on scattered farms is recognized as a pattern early rather than discovered one barn at a time [31]. The earlier the pattern is seen, the faster vaccines, alerts, and management advice can catch up to it.'),

      h2('3.4 What Farmers Should Do'),
      para('For all the science and surveillance behind it, the most powerful early-warning tool in the country is still a farmer who walks the barn every day and reports what does not look right. You are the first link in the chain, and a problem you catch and report on Monday is far cheaper for everyone than the same problem found across the region a month later [32].'),
...
function buildSection4() {
  return {
    ...
    children: [
      ...
      para('It is worth being honest about what happens when the antibiotics come out. Gut health is where it shows first. Necrotic enteritis and coccidiosis are the two that press hardest, and in Canadian broilers the great majority of medically important antibiotic use has been aimed at necrotic enteritis in the first place [46]. Take the drug away and put nothing in its place and you will meet that disease. What fills the gap is not one product but a program: coccidiosis vaccination or a proper rotation, clean water, and dry litter. Feed that does not swing on the birds helps too, and so does the biosecurity that keeps the challenge low in the first place [46].'),
      para([
        { text: 'Two bugs on a broiler farm are worth knowing by name. ' },
        { text: 'Escherichia coli', italics: true },
        { text: ' is behind colibacillosis, the everyday loss that follows a viral knock or a bad air week. ' },
        { text: 'Enterococcus cecorum', italics: true },
        { text: ' has been in Canadian broilers since 2008 and shows itself as lameness, sore joints, and birds going down on their legs [47]. Both are getting harder to treat. Canadian surveillance from farm to retail keeps finding ' },
        { text: 'E. coli', italics: true },
        { text: ' resistant to antimicrobials that matter in human medicine [48], and broiler ' },
        { text: 'E. cecorum', italics: true },
        { text: ' isolates carry transferable resistance genes, vancomycin among them [49]. That is what stewardship is really protecting: the day the usual treatment stops working on a bug already in your barn.' },
      ]),
...
function buildReferencesSection() {
  return {
    ...
    children: [
      ...
      numberedRef('Canadian Food Inspection Agency. Status of ongoing avian influenza response by province. Ottawa: CFIA; 2026 [cited 2026 Sep]. Available from: inspection.canada.ca'),
      ...
      numberedRef('Amarasinghe A, Popowich S, De Silva Senapathi U, Abdul-Cader MS, Marshall F, Van der Meer F, Cork SC, Gomis S, Abdul-Careem MF. Shell-less egg syndrome (SES) widespread in Western Canadian layer operations is linked to a Massachusetts (Mass) type infectious bronchitis virus (IBV) isolate. Viruses. 2018;10(8):437. doi:10.3390/v10080437'),
      ...
      numberedRef('Ojkić D, Lopes J, Sandrock C, Rätsep E, Brouwer E, Brooks A, Rossi T, Martin E. Fowl adenovirus infection and inclusion body hepatitis in Canada: genotyping trends from 2008 to 2024. J Vet Diagn Invest. 2026;38(2):168-173. doi:10.1177/10406387251412366'),
