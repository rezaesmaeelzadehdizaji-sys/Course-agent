...
function buildReferencesSection() {
  return {
    ...
    children: [
      ...
      numberedRef('Hassan MSH, Buharideen SM, Ali A, Najimudeen SM, Goldsmith D, Coffin CS, Cork SC, van der Meer F, Abdul-Careem MF. Efficacy of commercial infectious bronchitis vaccines against Canadian Delmarva (DMV/1639) infectious bronchitis virus infection in layers. Vaccines (Basel). 2022;10(8):1194. doi:10.3390/vaccines10081194'),
