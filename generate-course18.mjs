...
function buildSection2() {
  return {
    ...
    children: [
      ...
      para('The American numbers are bigger, and they show where the risk sits. About 70 cases since 2024, most of them mild, one fatal, and no spread between people [13]. Around 41 came from dairy cattle and two dozen from poultry, mostly barn workers and culling crews [13]. Both American deaths were in backyard flock owners. The one in November 2025 is worth knowing. A Washington State owner died of H5N5, the first time that virus had been found in a person [14]. It came from the owner’s own ducks. Two died. The rest of the flock tested positive while looking perfectly normal [14]. Waterfowl can carry this and show you nothing. H5N5 is here too, and it killed a backyard layer flock in Newfoundland and Labrador in early 2025 [15].'),
...
function buildSection3() {
  return {
    ...
    children: [
      ...
      para('A different disease has been climbing in Canadian broiler barns: inclusion body hepatitis, or IBH. It is caused by fowl adenoviruses, and it usually hits broilers between three and five weeks old as a sudden jump in deaths, with pale, swollen, mottled livers showing up at post-mortem [37]. What marks it as a genuine emerging disease is the trend. IBH outbreaks have been rising in Canada and worldwide since about 2015 [37], and the mix of virus types behind them has shifted. FAdV8b is now the strain found most often, where FAdV8a and FAdV11 used to share the load [38]. IBH has long been the kind of disease that moves in after something else has weakened the birds, usually infectious bursal disease or chicken anemia virus. It now turns up in flocks as a primary problem on its own too [37]. Either way, it is a reminder to look past the liver and ask what else is going on in that flock.'),
  ...
  return {
    ...
    children: [
      ...
      para([
        ...
        { text: ', which turned up in Canada in an Ontario broiler flock in 2008 and shows itself as lameness, sore joints, and birds going down on their legs [47]. Both are getting harder to treat. Canadian surveillance running from the farm through to retail keeps finding ' },
        { text: 'E. coli', italics: true },
        { text: ' carrying resistance to antimicrobials that matter in human medicine [48], and broiler ' },
        { text: 'E. cecorum', italics: true },
        { text: ' isolates carry resistance genes for tetracycline, lincomycin, spectinomycin, tylosin, and even vancomycin, sitting on mobile pieces of DNA that pass between bacteria [49]. That is the thing stewardship is really protecting: the day the usual treatment stops working on a bug that is already in your barn.' },
      ]),
