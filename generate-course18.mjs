...
function buildSection2() {
  return {
    ...
    children: [
      ...
      para('The natural home of avian influenza is wild waterfowl. Ducks and geese carry the virus and shed it in their droppings, often without looking sick at all [1,12]. That is what makes it so hard to keep out. The reservoir is flying overhead and landing on the pond next to your barn, and it gives no warning.'),
      ...
      para('When the CFIA confirms HPAI on a farm, it moves quickly to stamp it out before it spreads. Your farm goes under quarantine, formally called a Declaration of Infected Place, and no birds, eggs, or manure move on or off the property without CFIA permission [14]. The agency also draws a primary control zone around the area and controls movement inside it [15]. The flock is humanely destroyed, then the barn is stripped of litter and manure and wet cleaned and disinfected. New birds normally cannot come in until at least 14 days after the final cleaning and disinfection inspection is approved [14].'),
      para('Now the part that catches far more farms than the disease itself. When a control zone goes up, every poultry farm inside it is affected, not just the infected one. If your flock is healthy and your neighbor is the one who broke, you are still inside the zone. Birds, hatching eggs, table eggs, manure, litter, feed, and anything else that has been around birds cannot move into, out of, within, or through that zone without CFIA permission [16]. Some movements run under a general permit and some need a specific one, and the CFIA runs an online tool that tells you which applies to the move you need to make [16]. This is the outbreak experience most producers actually have. Know before it happens who at your processor, hatchery, and feed mill handles permits, because the week your neighbor breaks is a bad week to be working that out from scratch.'),
      para('Be clear-eyed about compensation too. The CFIA pays for animals and things it orders destroyed and for the cost of disposing of them, at market value up to maximum amounts set in the regulations [17]. Those maximums are ceilings, and the agency says plainly that compensation may not cover full replacement value. Two things it does not cover are worth knowing before you need them: loss of future revenue, and anything ordered cleaned and disinfected [17]. So the birds are paid for within limits, but the empty weeks, the lost production, and the cleanout labor largely sit with you. Talk to your marketing board and your insurance provider about that gap while things are calm.'),
      para('One more thing that does not appear in any CFIA document. Watching a flock you raised get depopulated is hard, and it is harder still when it is your family farm, your barn, and your year of work. Producers who have been through it describe it as a grief, and the quiet weeks afterward with empty barns can be worse than the day itself. That reaction is normal and it is common. The Do More Agriculture Foundation runs mental health support built for Canadian farmers, including a moderated peer support community, and most provinces have a farm-specific help line as well [18]. Use them, and watch for it in your staff and your neighbors too.'),
      h2('2.5 The Vaccination Question'),
      para('The question the whole sector is watching is whether vaccination will ever join that response. Canada\'s answer to bird flu has always been to stamp it out, not to vaccinate. Part of the reason is trade, because vaccinating a flock can complicate exports and has to be weighed against its effect on surveillance, so Canada has stayed cautious [19]. But the sheer length of this outbreak has pushed the question back onto the table. A CFIA task force formed in 2023 has been weighing whether vaccination could earn a place in the response [15], and that work has now moved off paper. In August 2026 the CFIA launched a confined field trial on two commercial farms in Manitoba, starting with an egg-laying operation, with a turkey operation expected to join in 2027 [20]. The agency is blunt about what this is and is not. It is there to gather evidence on whether the vaccines work and how you would even deliver them on a working farm. It is not a decision to vaccinate, not a national program, and not a change to any current control measure [20]. Vaccinated birds can still be infected and still spread the virus, so vaccination would sit on top of biosecurity, never in place of it [20]. None of this makes vaccination an option on your farm today, and any real change would arrive with new rules and trade talks attached. It is the live policy question in the sector, so keep an eye on the CFIA for where it lands [19].'),
      h2('2.6 Surveillance and Protecting Your Flock'),
      para('Behind the scenes, Canada runs a national surveillance program called the Canadian Notifiable Avian Influenza Surveillance System, or CanNAISS. It watches for the virus through testing in flocks that show signs, before slaughter, and in hatcheries, and it is what lets Canada prove to trading partners that its flocks are monitored [21]. That surveillance, plus a fast, organized response, is what keeps an outbreak from spreading farm to farm.'),
      para('Your part is prevention, and it matters most when the risk is highest. Raise your guard during spring and fall migration, when wild birds are moving and the virus is most active. The CPC Learning Centre Spotting Disease Early guide reinforces the habit that protects you: walk the barn every day, know your normal numbers, and act the moment something looks off [22]. Keep wild birds away from your feed and water, tighten who and what comes through your door, and never let a suspicious death loss sit unreported.'),
    ],
  };
}
...
function buildSection3() {
  return {
    ...
    children: [
      ...
      para('An emerging disease is one that is new, newly arrived in an area, or suddenly behaving worse than it used to. A re-emerging disease is an old foe coming back, often in a changed form that the usual vaccines or management do not fully cover [12]. The two ideas blur together in practice, and both keep landing on Canadian farms.'),
      ...
      para('DMV/1639 is also not the end of the story for infectious bronchitis. This virus is a shape-shifter that swaps pieces of its genetic code with other strains, and Canadian diagnostic labs keep turning up brand-new versions. As recently as 2024, two previously unrecognized IBV variants were found in Canadian flocks hit by drops in egg production, each one a recombinant that had blended parts of other viruses into something new [25]. The worry with any new variant is always the same. The vaccine that protected your birds against last year’s strain may not fully cover this year’s, which is why a strain your program handled five years ago is worth rechecking with your veterinarian today.'),
      para('A different disease has been climbing in Canadian broiler barns: inclusion body hepatitis, or IBH. It is caused by fowl adenoviruses, and it usually hits broilers between three and five weeks old as a sudden jump in deaths, with pale, swollen, mottled livers showing up at post-mortem [26]. What marks it as a genuine emerging disease is the trend. IBH outbreaks have been rising in Canada and worldwide since about 2015, and the mix of virus types behind them has shifted. FAdV8b is now the strain found most often, where FAdV8a and FAdV11 used to share the load [27]. IBH has long been the kind of disease that moves in after something else has weakened the birds, usually infectious bursal disease or chicken anemia virus. It now turns up in flocks as a primary problem on its own too [26]. Either way, it is a reminder to look past the liver and ask what else is going on in that flock.'),
      ...
      para([
        ...
        { text: ' than usual behind it [29]. Vaccines are in limited use in Canada under CFIA-approved doses while full licensing is worked out, so this is a live conversation to have with your veterinarian rather than a settled program [29]. The lesson to take from aMPV is the one this whole section is built on. A disease that was somebody else\u2019s problem in 2023 was in Canadian barns in 2024 and endemic by 2025. That is how fast the map changes.' },
      ]),
      ...
      para('It works like this. Your daily observations, and the birds and samples your veterinarian sends to a provincial diagnostic laboratory, are how new and unusual problems first get spotted. The work that identified the DMV/1639 strain in Canada came out of exactly this kind of laboratory testing of field cases [23]. Those labs feed their results into national systems, including the avian influenza surveillance run through CanNAISS, so that a threat appearing on scattered farms is recognized as a pattern early rather than discovered one barn at a time [21]. The earlier the pattern is seen, the faster vaccines, alerts, and management advice can catch up to it.'),

      h2('3.4 What Farmers Should Do'),
      para('For all the science and surveillance behind it, the most powerful early-warning tool in the country is still a farmer who walks the barn every day and reports what does not look right. You are the first link in the chain, and a problem you catch and report on Monday is far cheaper for everyone than the same problem found across the region a month later [22].'),
  ...
  return {
    ...
    children: [
      ...
      para([
        ...
        { text: ', which turned up in Canada in an Ontario broiler flock in 2008 and shows itself as lameness, sore joints, and birds going down on their legs [36]. Both are getting harder to treat. Canadian surveillance running from the farm through to retail keeps finding ' },
        { text: 'E. coli', italics: true },
        { text: ' carrying resistance to antimicrobials that matter in human medicine [37], and broiler ' },
        { text: 'E. cecorum', italics: true },
        { text: ' isolates carry resistance genes for tetracycline, lincomycin, spectinomycin, tylosin, and even vancomycin, sitting on mobile pieces of DNA that pass between bacteria [38]. That is the thing stewardship is really protecting: the day the usual treatment stops working on a bug that is already in your barn.' },
      ]),
