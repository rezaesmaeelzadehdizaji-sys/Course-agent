...
function buildIntroSection() {
  return {
    ...
    children: [
      ...
      para('A quick word on currency. By its nature, a hot-topics course goes out of date. The numbers and the disease situation in these pages reflect August 2026. The big picture should hold for a while, but the details move fast. Always confirm the current situation with the CFIA and your own veterinarian before you act on it.'),
...
function buildSection2() {
  return {
    ...
    children: [
      ...
      para('The strain driving the current crisis is an H5N1 virus from a group scientists label clade 2.3.4.4b. It first reached North America in late 2021, spread across Canada through 2022, and has not left since [4]. The toll has been heavy. Since it arrived, more than 650 Canadian farms and flocks have been infected and roughly 17.5 million birds have been lost. British Columbia alone accounts for more than half of those birds [4]. In 2025 the country lost 82 commercial flocks. The first half of 2026 has been quieter, but cases have still turned up in several provinces, so nobody is calling it over [4]. Spring and fall, when wild birds migrate, are the riskiest times.'),
      para('What makes this strain different is how far it has spread beyond birds. Since 2024 it has infected dairy cattle in the United States, passing from cow to cow through the milking process, something never seen with this virus before [5]. It has killed cats, foxes, skunks, and marine mammals, and it has turned up in sheep, goats, and other farmed mammals [5].'),
      para('People have been infected too, almost always after close contact with sick animals. By the middle of 2026 the United States had reported about 70 human H5N1 cases since 2024, most of them mild, one of them fatal, and no sign of the virus passing from person to person [6]. A second death, in November 2025, is the one worth knowing about. A Washington State backyard flock owner died after catching a related virus called H5N5, the first time that virus had ever been found in a person [7]. Investigators traced it back to the owner’s own ducks and the sediment in their watering basin, and those ducks looked perfectly healthy [7]. That is the part to take home: waterfowl can be carrying a dangerous virus and show you nothing at all. About 135 people connected to that case were monitored and none of them got sick [7]. For the average farmer the human risk is still an occupational one, tied to close contact with birds and the wet ground they live on, not a reason for panic.'),
      ...
      para('The natural home of avian influenza is wild waterfowl. Ducks and geese carry the virus and shed it in their droppings, often without looking sick at all [1,8]. That is what makes it so hard to keep out. The reservoir is flying overhead and landing on the pond next to your barn, and it gives no warning.'),
      ...
      para('When the CFIA confirms HPAI on a farm, it moves quickly to stamp it out before it spreads. The infected premises is placed under quarantine, and the agency draws control zones around it. Within those zones, the movement of birds, eggs, equipment, and anything else that could carry the virus is tightly controlled, into, out of, and within the zone [9]. Affected flocks are humanely depopulated, the barn is cleaned and disinfected, and there is a required downtime before any new birds come in. Federal compensation is available for birds that are ordered destroyed [9].'),
      para('One question worth watching is whether vaccination will ever join that toolbox. Canada\'s answer to bird flu has always been to stamp it out, not to vaccinate. Part of the reason is trade, because vaccinating a flock can complicate exports and has to be weighed against its effect on surveillance, so Canada has stayed cautious [10]. But the sheer length of this outbreak has pushed the question back onto the table. A CFIA task force formed in 2023 has been weighing whether vaccination could earn a place in the response [9], and the agency has moved to test it in a small, confined field trial on a limited basis [10]. None of this makes vaccination a routine option on Canadian farms today, and any real change would arrive with new rules and trade talks attached. It is one to watch, so keep an eye on the CFIA for where it lands [10].'),
      para('Behind the scenes, Canada runs a national surveillance program called the Canadian Notifiable Avian Influenza Surveillance System, or CanNAISS. It watches for the virus through testing in flocks that show signs, before slaughter, and in hatcheries, and it is what lets Canada prove to trading partners that its flocks are monitored [11]. That surveillance, plus a fast, organized response, is what keeps an outbreak from spreading farm to farm.'),
      para('Your part is prevention, and it matters most when the risk is highest. Raise your guard during spring and fall migration, when wild birds are moving and the virus is most active. The CPC Learning Centre Spotting Disease Early guide reinforces the habit that protects you: walk the barn every day, know your normal numbers, and act the moment something looks off [12]. Keep wild birds away from your feed and water, tighten who and what comes through your door, and never let a suspicious death loss sit unreported.'),
    ],
  };
}
...
function buildSection3() {
  return {
    ...
    children: [
      ...
      para('An emerging disease is one that is new, newly arrived in an area, or suddenly behaving worse than it used to. A re-emerging disease is an old foe coming back, often in a changed form that the usual vaccines or management do not fully cover [8]. The two ideas blur together in practice, and both keep landing on Canadian farms.'),
      ...
      para('DMV/1639 is also not the end of the story for infectious bronchitis. This virus is a shape-shifter that swaps pieces of its genetic code with other strains, and Canadian diagnostic labs keep turning up brand-new versions. As recently as 2024, two previously unrecognized IBV variants were found in Canadian flocks hit by drops in egg production, each one a recombinant that had blended parts of other viruses into something new [15]. The worry with any new variant is always the same. The vaccine that protected your birds against last year’s strain may not fully cover this year’s, which is why a strain your program handled five years ago is worth rechecking with your veterinarian today.'),
      para('A different disease has been climbing in Canadian broiler barns: inclusion body hepatitis, or IBH. It is caused by fowl adenoviruses, and it usually hits young broilers around three to five weeks old as a sudden jump in deaths, with pale, swollen, mottled livers showing up at post-mortem [16]. What marks it as a genuine emerging disease is the trend. Across Canada, testing and confirmed cases have climbed steeply over the past decade, and the mix of virus types behind it has shifted, with one type now the most common where several used to share the load [16]. IBH often takes hold after something else has already weakened the birds’ immune systems, so it is also a reminder that emerging diseases frequently ride in on the back of other problems.'),
      ...
      para('It works like this. Your daily observations, and the birds and samples your veterinarian sends to a provincial diagnostic laboratory, are how new and unusual problems first get spotted. The work that identified the DMV/1639 strain in Canada came out of exactly this kind of laboratory testing of field cases [13]. Those labs feed their results into national systems, including the avian influenza surveillance run through CanNAISS, so that a threat appearing on scattered farms is recognized as a pattern early rather than discovered one barn at a time [11]. The earlier the pattern is seen, the faster vaccines, alerts, and management advice can catch up to it.'),

      h2('3.4 What Farmers Should Do'),
      para('For all the science and surveillance behind it, the most powerful early-warning tool in the country is still a farmer who walks the barn every day and reports what does not look right. You are the first link in the chain, and a problem you catch and report on Monday is far cheaper for everyone than the same problem found across the region a month later [12].'),
...
function buildReferencesSection() {
  return {
    ...
    children: [
      h1('References'),
      para('References are listed in order of first appearance in the text. Sources are the Canadian Food Inspection Agency and other government agencies, peer-reviewed veterinary literature, standard reference texts, and the CPC Learning Centre. Disease-situation figures reflect August 2026 and should be re-confirmed against current CFIA reporting.'),
      numberedRef('Canadian Food Inspection Agency. Facts about avian influenza. Ottawa: CFIA; [cited 2026 Aug]. Available from: inspection.canada.ca'),
      ...
      numberedRef('Canadian Food Inspection Agency. Avian influenza: latest bird flu situation. Ottawa: CFIA; [cited 2026 Aug]. Available from: inspection.canada.ca'),
      numberedRef('American Veterinary Medical Association. Avian influenza virus type A (H5N1) in U.S. dairy cattle. Schaumburg, IL: AVMA; [cited 2026 Aug]. Available from: avma.org'),
      numberedRef('Centers for Disease Control and Prevention. H5 bird flu: current situation. Atlanta, GA: CDC; [cited 2026 Aug]. Available from: cdc.gov'),
      ...
      numberedRef('Canadian Food Inspection Agency. Overview of how Canada prevents, prepares and responds to bird flu outbreaks. Ottawa: CFIA; [cited 2026 Aug]. Available from: inspection.canada.ca'),
      numberedRef('Canadian Food Inspection Agency. Exploring avian influenza vaccination in poultry in Canada. Ottawa: CFIA; [cited 2026 Aug]. Available from: inspection.canada.ca/en/animal-health/terrestrial-animals/diseases/reportable/avian-influenza/vaccination'),
      numberedRef('Canadian Food Inspection Agency. Avian influenza surveillance: Canadian Notifiable Avian Influenza Surveillance System (CanNAISS). Ottawa: CFIA; [cited 2026 Aug]. Available from: inspection.canada.ca'),
      ...
      numberedRef('Public Health Agency of Canada. Canadian Integrated Program for Antimicrobial Resistance Surveillance (CIPARS): annual report. Guelph, ON: PHAC; [cited 2026 Aug]. Available from: canada.ca'),
      numberedRef('Health Canada. Responsible use of medically important antimicrobials in animals. Ottawa: Health Canada; [cited 2026 Aug]. Available from: canada.ca'),
...
async function main() {
  ...
  const entriesWithAnchor = [
    ...
    { lvl: 2, text: '2.3 Recognizing It and Your Legal Duty to Report', page: 8 },
    { lvl: 2, text: '2.4 The Outbreak Response and Protecting Your Farm', page: 9 },
    { lvl: 1, text: 'Section 3: Emerging and Re-Emerging Disease Issues', page: 11 },
    { lvl: 2, text: '3.1 What Emerging Means and What Drives It', page: 11 },
    { lvl: 2, text: '3.2 Diseases on the Radar in Canada', page: 11 },
    { lvl: 2, text: '3.3 Surveillance and Early Warning', page: 13 },
    { lvl: 2, text: '3.4 What Farmers Should Do', page: 14 },
    { lvl: 1, text: 'Section 4: Antimicrobial Resistance (AMR)', page: 15 },
    { lvl: 2, text: '4.1 What AMR Is and Why It Is a Hot Topic', page: 15 },
    { lvl: 2, text: '4.2 What Canada and the Poultry Industry Are Doing About It', page: 15 },
    { lvl: 2, text: '4.3 What It Means for Your Farm', page: 16 },
