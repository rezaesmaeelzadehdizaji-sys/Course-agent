...
function buildSection3() {
  return {
    ...
    children: [
      ...
      para('DMV/1639 is also not the end of the story for infectious bronchitis. This virus is a shape-shifter that swaps pieces of its genetic code with other strains, and Canadian diagnostic labs keep turning up brand-new versions. As recently as 2024, two previously unrecognized IBV variants were found in Canadian flocks hit by drops in egg production, each one a recombinant that had blended parts of other viruses into something new [13]. The worry with any new variant is always the same. The vaccine that protected your birds against last year’s strain may not fully cover this year’s, which is why a strain your program handled five years ago is worth rechecking with your veterinarian today.'),
      para('A different disease has been climbing in Canadian broiler barns: inclusion body hepatitis, or IBH. It is caused by fowl adenoviruses, and it usually hits young broilers around three to five weeks old as a sudden jump in deaths, with pale, swollen, mottled livers showing up at post-mortem [14]. What marks it as a genuine emerging disease is the trend. Across Canada, testing and confirmed cases have climbed steeply over the past decade, and the mix of virus types behind it has shifted, with one type now the most common where several used to share the load [14]. IBH often takes hold after something else has already weakened the birds’ immune systems, so it is also a reminder that emerging diseases frequently ride in on the back of other problems.'),
