...
function buildSection2() {
  return {
    ...
    children: [
      ...
      para('People have been infected too, almost always after close contact with sick animals. By the middle of 2026 the United States had reported about 70 human H5N1 cases since 2024, most of them mild, one of them fatal, and no sign of the virus passing from person to person [7]. It is worth knowing who those people were, because it was not mostly backyard keepers. Around 41 of them caught it from infected dairy cattle. Another two dozen or so caught it from poultry, and most of those were people working in barns or on culling crews during an outbreak [7]. Those were commercial operations and paid workers. Both of the deaths, though, were in people keeping birds at home. The second one, in November 2025, is the one worth knowing about. A Washington State backyard flock owner died after catching a related virus called H5N5, the first time that virus had ever been found in a person [8]. Investigators traced it back to the owner’s own ducks and the sediment in their watering basin [8]. Two ducks did sicken and die. The rest of the flock tested positive while looking perfectly normal [8]. That is the part to take home: waterfowl can be carrying a dangerous virus and show you next to nothing. About 135 people connected to that case were monitored. Fifteen came down with something that looked like it, and not one of them tested positive [8]. For the average farmer the human risk is still an occupational one, tied to close contact with birds and the wet ground they live on, not a reason for panic.'),
      para('Canada has had a case of its own, and it happened right in poultry country. In November 2024 a 13-year-old girl in the Fraser Valley became the first person to catch this virus inside this country [9]. She got very sick. She spent weeks in intensive care, first on a ventilator and then on a machine that took over for her lungs. She recovered and went home [9]. Two things about her case are worth carrying with you. She was not a poultry worker, and public health never did find where she picked it up. What they could say is that the virus in her samples was closest to what was circulating in the local wild birds at the time [10]. So the same lesson lands here as with those Washington ducks. The obvious exposure is not always the real one, and in a valley carrying that much virus in the wild bird population, the barn is not the only place it lives.'),
      para('Put the whole Canadian record beside the American one and it is a short list. Two people in this country have been confirmed with H5N1, ever. The girl in the Fraser Valley, and one traveler who brought it home from China back in 2014 [11]. Federal reporting a year on still showed the same single home-grown case, with her source still unknown [12]. Now read what is not on that list. Canada has been through hundreds of infected farms and millions of destroyed birds since 2021, and not one confirmed human illness has come out of barn work or a cull. That is a record worth protecting, and the next few lines are how you protect it.'),
