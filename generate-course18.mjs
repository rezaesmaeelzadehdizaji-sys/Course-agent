...
function buildSection2() {
  return {
    ...
    children: [
      ...
      para('The natural home of avian influenza is wild waterfowl. Ducks and geese carry the virus and shed it in their droppings, often without looking sick at all [1,9]. That is what makes it so hard to keep out. The reservoir is flying overhead and landing on the pond next to your barn, and it gives no warning.'),
...
function buildSection3() {
  return {
    ...
    children: [
      ...
      para('An emerging disease is one that is new, newly arrived in an area, or suddenly behaving worse than it used to. A re-emerging disease is an old foe coming back, often in a changed form that the usual vaccines or management do not fully cover [9]. The two ideas blur together in practice, and both keep landing on Canadian farms.'),
      ...
      para('DMV/1639 is also not the end of the story for infectious bronchitis. This virus is a shape-shifter that swaps pieces of its genetic code with other strains, and Canadian diagnostic labs keep turning up brand-new versions. As recently as 2024, two previously unrecognized IBV variants were found in Canadian flocks hit by drops in egg production, each one a recombinant that had blended parts of other viruses into something new [17]. The worry with any new variant is always the same. The vaccine that protected your birds against last year’s strain may not fully cover this year’s, which is why a strain your program handled five years ago is worth rechecking with your veterinarian today.'),
      para('A different disease has been climbing in Canadian broiler barns: inclusion body hepatitis, or IBH. It is caused by fowl adenoviruses, and it usually hits broilers between three and five weeks old as a sudden jump in deaths, with pale, swollen, mottled livers showing up at post-mortem [18]. What marks it as a genuine emerging disease is the trend. IBH outbreaks have been rising in Canada and worldwide since about 2015, and the mix of virus types behind them has shifted. FAdV8b is now the strain found most often, where FAdV8a and FAdV11 used to share the load [19]. IBH has long been the kind of disease that moves in after something else has weakened the birds, usually infectious bursal disease or chicken anemia virus, though it now turns up in flocks as a primary problem on its own [18]. Either way, it is a reminder to look past the liver and ask what else is going on in that flock.'),
      ...
      para('It works like this. Your daily observations, and the birds and samples your veterinarian sends to a provincial diagnostic laboratory, are how new and unusual problems first get spotted. The work that identified the DMV/1639 strain in Canada came out of exactly this kind of laboratory testing of field cases [15]. Those labs feed their results into national systems, including the avian influenza surveillance run through CanNAISS, so that a threat appearing on scattered farms is recognized as a pattern early rather than discovered one barn at a time [13]. The earlier the pattern is seen, the faster vaccines, alerts, and management advice can catch up to it.'),

      h2('3.4 What Farmers Should Do'),
      para('For all the science and surveillance behind it, the most powerful early-warning tool in the country is still a farmer who walks the barn every day and reports what does not look right. You are the first link in the chain, and a problem you catch and report on Monday is far cheaper for everyone than the same problem found across the region a month later [14].'),
...
async function main() {
  ...
  const entriesWithAnchor = [
    ...
    { lvl: 2, text: '2.2 How It Spreads and Gets Onto Farms', page: 7 },
    ...
    { lvl: 1, text: 'Section 3: Emerging and Re-Emerging Disease Issues', page: 12 },
    { lvl: 2, text: '3.1 What Emerging Means and What Drives It', page: 12 },
    { lvl: 2, text: '3.2 Diseases on the Radar in Canada', page: 12 },
    { lvl: 2, text: '3.3 Surveillance and Early Warning', page: 14 },
    { lvl: 2, text: '3.4 What Farmers Should Do', page: 15 },
    { lvl: 1, text: 'Section 4: Antimicrobial Resistance (AMR)', page: 16 },
    { lvl: 2, text: '4.1 What AMR Is and Why It Is a Hot Topic', page: 16 },
    { lvl: 2, text: '4.2 What Canada and the Poultry Industry Are Doing About It', page: 16 },
    { lvl: 2, text: '4.3 What It Means for Your Farm', page: 17 },
    { lvl: 1, text: 'Recommended Peer-Reviewed Journals', page: 18 },
