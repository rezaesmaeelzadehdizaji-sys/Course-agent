...
function buildSection3() {
  return {
    ...
    children: [
      ...
      para('It works like this. Your daily observations, and the birds and samples your veterinarian sends to a provincial diagnostic laboratory, are how new and unusual problems first get spotted. The work that identified the DMV/1639 strain in Canada came out of exactly this kind of laboratory testing of field cases [12]. Those labs feed their results into national systems, including the avian influenza surveillance run through CanNAISS, so that a threat appearing on scattered farms is recognized as a pattern early rather than discovered one barn at a time [10]. The earlier the pattern is seen, the faster vaccines, alerts, and management advice can catch up to it.'),

      h2('3.4 What Farmers Should Do'),
      para('For all the science and surveillance behind it, the most powerful early-warning tool in the country is still a farmer who walks the barn every day and reports what does not look right. You are the first link in the chain, and a problem you catch and report on Monday is far cheaper for everyone than the same problem found across the region a month later [11].'),
...
function buildReferencesSection() {
  return {
    ...
    children: [
      ...
      numberedRef('Canadian Food Inspection Agency. Exploring avian influenza vaccination in poultry in Canada. Ottawa: CFIA; [cited 2026 Jul]. Available from: inspection.canada.ca/en/animal-health/terrestrial-animals/diseases/reportable/avian-influenza/vaccination'),
...
async function main() {
  ...
  const entriesWithAnchor = [
    ...
    { lvl: 1, text: 'Section 3: Emerging and Re-Emerging Disease Issues', page: 10 },
    { lvl: 2, text: '3.1 What Emerging Means and What Drives It', page: 10 },
    { lvl: 2, text: '3.2 Diseases on the Radar in Canada', page: 10 },
    { lvl: 2, text: '3.3 Surveillance and Early Warning', page: 11 },
    { lvl: 2, text: '3.4 What Farmers Should Do', page: 12 },
    { lvl: 1, text: 'Section 4: Antimicrobial Resistance (AMR)', page: 13 },
    { lvl: 2, text: '4.1 What AMR Is and Why It Is a Hot Topic', page: 13 },
    { lvl: 2, text: '4.2 What Canada and the Poultry Industry Are Doing About It', page: 13 },
    { lvl: 2, text: '4.3 What It Means for Your Farm', page: 14 },
    { lvl: 1, text: 'Recommended Peer-Reviewed Journals', page: 15 },
