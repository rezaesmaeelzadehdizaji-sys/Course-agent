...
function buildSection1() {
  return {
    ...
    children: [
      ...
      para([
        { text: 'All three production types are the same species, ' },
        { text: 'Gallus gallus domesticus', italics: true },
        { text: ', but decades of selective breeding have pushed them in fundamentally different directions.' },
      ]),
...
function buildSection2() {
  return {
    ...
    children: [
      ...
      ...embedPhoto(imgFile('Poultry foot pads  normal.jpg'), 'Photo 2.2: Healthy chicken foot. Foot pad with smooth shanks and an intact, unblemished plantar surface (left) and palmar surface (right). Source: Aviagen.'),
...
function buildSection3() {
  return {
    ...
    children: [
      ...
      labeled('Cloaca:', [
        { text: 'The shared exit point for the gut, kidneys, and reproductive tract. Feces, urine, and eggs all pass through the cloaca. Because of this shared exit, egg contamination can occur when hens have enteric disease, which is one reason ' },
        { text: 'Salmonella', italics: true },
        { text: ' control requires managing gut health as well as external hygiene.' },
      ]),
      ...
      ...embedPhoto(imgFile('Chicken urinary System.JPG'), 'Figure 3.5: The avian urinary system (left). Two kidneys sit tight against the backbone and drain through the ureters directly to the cloaca; there is no bladder. Nitrogen leaves the body as uric acid, the white cap on a normal dropping (right). Source: USDA, Happy Morning Farm LLC.'),

      para('Here is what goes wrong. When the kidneys cannot keep up, when a bird is short of water, or when non-laying birds get a high-calcium layer ration, uric acid builds up in the blood and crystallizes out as chalky white deposits. On the organs, that is visceral gout; in the joints, articular gout [22,23].'),
...
async function main() {
  ...
  const entriesWithAnchor = [
    ...
    { lvl: 2, text: '2.2  Reading the Bird: Signs of Health from the Outside',                 page: 8  },
    ...
    { lvl: 1, text: 'Section 4: Meat Birds (Broilers)',                                        page: 20 },
    { lvl: 2, text: '4.1  Built for Rapid Muscle Growth',                                      page: 20 },
    { lvl: 2, text: '4.2  Feed Conversion and Metabolism',                                     page: 21 },
    { lvl: 2, text: '4.3  Common Health Challenges in Broilers',                               page: 21 },
    { lvl: 2, text: '4.4  Key Management Considerations',                                      page: 22 },
    { lvl: 1, text: 'Section 5: Layers and Breeders',                                          page: 23 },
    { lvl: 2, text: '5.1  Built for Egg Production and Reproduction',                          page: 23 },
    { lvl: 2, text: '5.2  The Reproductive Tract and Egg Formation',                           page: 24 },
    { lvl: 2, text: '5.3  Nutritional Needs for Laying and Fertility',                         page: 25 },
    { lvl: 2, text: '5.4  Health Issues Specific to Layers and Breeders',                      page: 25 },
    { lvl: 1, text: 'Section 6: Comparing the Physiology of Meat Birds, Layers, and Breeders',  page: 27 },
    { lvl: 2, text: '6.1  Growth Patterns',                                                    page: 27 },
    { lvl: 2, text: '6.2  Body Structure',                                                     page: 27 },
    { lvl: 2, text: '6.3  Metabolic Differences',                                              page: 28 },
    { lvl: 2, text: '6.4  Housing and Management Implications',                                page: 28 },
    { lvl: 1, text: 'Section 7: Practical Application for Farmers',                            page: 29 },
    { lvl: 2, text: '7.1  Feeding Strategies',                                                 page: 29 },
    { lvl: 2, text: '7.2  Housing Adjustments',                                                page: 30 },
    { lvl: 2, text: '7.3  Health Monitoring',                                                  page: 30 },
    { lvl: 2, text: '7.4  Handling and Welfare Considerations',                                page: 31 },
    { lvl: 1, text: 'Summary and Key Takeaways',                                               page: 32 },
    { lvl: 2, text: 'The Bird\'s Design Purpose',                                              page: 32 },
    { lvl: 2, text: 'External Anatomy as a Health Tool',                                       page: 32 },
    { lvl: 2, text: 'The Digestive System',                                                    page: 32 },
    { lvl: 2, text: 'The Respiratory System',                                                  page: 32 },
    { lvl: 2, text: 'The Circulatory System',                                                  page: 32 },
    { lvl: 2, text: 'The Skeletal and Muscular Systems',                                       page: 33 },
    { lvl: 2, text: 'The Reproductive System',                                                 page: 33 },
    { lvl: 2, text: 'The Urinary System',                                                      page: 33 },
    { lvl: 2, text: 'The Immune System',                                                       page: 33 },
    { lvl: 2, text: 'Management Takeaways',                                                    page: 33 },
    { lvl: 1, text: 'Recommended Peer-Reviewed Journals',                                      page: 35 },
    { lvl: 1, text: 'References',                                                              page: 35 },
