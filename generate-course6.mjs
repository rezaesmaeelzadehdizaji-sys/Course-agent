...
function buildSection3() {
  return {
    ...
    children: [
      ...
      para('A chicken\'s heart is four-chambered, like a mammal\'s, and it works extremely hard. The resting heart rate is approximately 250 to 300 beats per minute [20]. The left ventricle is by far the largest chamber, built with far thicker walls than the right ventricle, because it must push blood to the entire body at high pressure. The right ventricle only needs to move blood through the nearby lungs, which offer much less resistance.'),
      ...
      para('Only the left ovary and oviduct develop to functional size in female chickens. The right side shuts down before hatch and stays dormant for life [3]. At hatch, a pullet already carries all the ova she will ever lay, tens of thousands of potential eggs, though only a small fraction will mature over her productive life. No new ova develop after hatching.'),
...
function buildSection7() {
  return {
    ...
    children: [
      ...
      para('Duct placement and ceiling height affect how evenly fresh air moves through the flock. A bird breathing stale air in a corner near the floor has the same anatomy as a bird breathing clean air at the inlet. The environmental history of each bird is different, and the cilia damage in the corner bird builds up over time. Commissioning and adjusting ventilation to achieve even air distribution across the floor is as important as hitting the target ventilation rate.'),
