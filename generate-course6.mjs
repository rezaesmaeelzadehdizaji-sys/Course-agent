...
function buildSection6() {
  return {
    ...
    children: [
      ...
      para('Broilers grow faster than any other farm animal in the first five to six weeks. A modern broiler reaches 2.5 kg or more in about 38 days; a heritage bird of the 1950s would have needed over 100 days for the same weight [22]. By six weeks, a good layer pullet will usually weigh around 400 to 500 g. A broiler breeder pullet at the same age is heavier, often 700 to 900 g, because she is already on a feed-restricted program to keep her on the target weight chart [23].'),
