...
function buildSection3() {
  return {
    ...
    children: [
      ...
      ...embedPhoto(imgFile('Chicken Digestive System.JPG'), 'Figure 3.2: The digestive tract, from the gizzard outlet to the vent. The small intestine absorbs nutrients, the two ceca ferment fiber and reclaim water, and everything exits through the cloaca. Source: Illustrated Guide to Poultry Necropsy and Diagnosis, United States Department of Agriculture, Foreign Agricultural Service.'),
      ...
      ...embedPhoto(imgFile('Poultry reproductive System.JPG'), 'Figure 3.4: (a) The hen\'s reproductive tract. Only the left ovary and oviduct develop. The yolk is released from the ovary, caught by the infundibulum, then wrapped in egg white, membranes, and finally the calcium shell as it moves down the tract. (b) The rooster\'s reproductive system. The two testes lie inside the abdominal cavity near the kidneys, unlike mammals where the testes are usually located outside the body. Source: Illustrated Guide to Poultry Necropsy and Diagnosis, United States Department of Agriculture, Foreign Agricultural Service.'),
      ...
      ...embedPhoto(imgFile('Chicken urinary System.JPG'), 'Figure 3.5: The avian urinary system. Two kidneys sit tight against the backbone and drain through the ureters directly to the cloaca; there is no bladder. Nitrogen leaves the body as uric acid, the white cap on a normal dropping. Source: Illustrated Guide to Poultry Necropsy and Diagnosis, United States Department of Agriculture, Foreign Agricultural Service.'),
