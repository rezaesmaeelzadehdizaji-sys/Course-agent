...
function buildSection4() {
  return {
    ...
    children: [
      ...
      para('A commercial broiler today reaches 2.5 to 3 kg in 38 to 45 days. A heritage bird from the 1950s would have needed over 100 days to reach the same market weight [22]. The driver is genetics: the muscle cells of a broiler multiply and develop faster than those of any other chicken type, and breeding selection has pushed that advantage relentlessly [12].'),
      ...
      bullet('Lighting and early feed programs can slightly slow growth in the first seven days, giving the heart and lungs a chance to keep up. Some integrators use short dark periods or alternate-day lighting protocols for this purpose. For the full lighting protocol, see the CPC Learning Centre Lighting Program Guidelines for Broilers 2026 [19].'),
...
function buildSection5() {
  return {
    ...
    children: [
      ...
      labeled('Internal laying:', 'Eggs that rupture into the abdominal cavity instead of traveling down the oviduct cause yolk peritonitis. The abdominal cavity fills with egg yolk material and becomes infected. It is a slow, progressive condition and eventually fatal. Birds with internal laying often show a swollen, fluid-filled abdomen and progressive weight loss. It is more common in heavy layers and in breeders that have been over-stimulated or are past their productive prime.'),
...
function buildSection6() {
  return {
    ...
    children: [
      ...
      para('Broilers grow faster than any other farm animal in the first five to six weeks. A modern broiler reaches 2.5 kg or more in about 38 days; a heritage bird of the 1950s would have needed over 100 days for the same weight [22]. A layer pullet at six weeks weighs 350 to 500 g. A broiler breeder at six weeks weighs about 600 to 800 g because she has been feed-restricted to slow her growth toward the target body weight chart [16].'),
      ...
      para('Broilers put most of what they eat toward laying down protein and growing muscle fast. Their muscle cells multiply and develop faster than those in layers or breeders [12].'),
      ...
      para('Breeders must balance both: enough muscle and body condition to be a functional broiler-genetics bird, and enough laying performance to produce the required fertile eggs across 40 weeks of production. This balance is maintained entirely through feed restriction and body weight monitoring.'),
...
function buildSection7() {
  return {
    ...
    children: [
      ...
      para('Duct placement and ceiling height affect how evenly fresh air moves through the flock. A bird breathing stale air in a corner near the floor has the same anatomy as a bird breathing clean air at the inlet. The environmental history of each bird is different, and the cilia damage in the corner bird builds up over time. Getting even air distribution across the floor is as important as hitting the target ventilation rate.'),
