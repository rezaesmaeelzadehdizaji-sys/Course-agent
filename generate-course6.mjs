...
function buildSection3() {
  return {
    ...
    children: [
      ...
      ...embedPhoto(imgFile('Chick immune system edited.jpg'), 'Figure 3.6: The main immune organs of the chicken. The bursa of Fabricius and the thymus train new defense cells and are largest in young birds; the spleen, cecal tonsils, and Harderian gland are where those cells stand guard. Maternal antibodies passed through the yolk protect the chick early but fade, which is why vaccination timing is built around them. Source: CPC Short Courses.'),
    ],
  };
}
...
function buildSection8() {
  return {
    ...
    children: [
      ...
      bullet('The bursa of Fabricius (unique to birds) and the thymus train the bird\'s defense cells, and both are largest in young birds. The bursa is the target of infectious bursal disease (IBD), which is why immunosuppressive diseases hurt every vaccine [24].'),
