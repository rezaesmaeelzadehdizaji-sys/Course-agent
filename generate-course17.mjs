...
function buildSection4() {
  return {
    ...
    children: [
      ...
      para('You lean on your veterinarian for treatment decisions, so it helps to know that the veterinarian is a regulated professional in their own right. Veterinarians in Canada are licensed and held to a standard of practice by the veterinary college in their own province, such as the College of Veterinarians of British Columbia. That college, not the CFIA, is the body a veterinarian answers to for how they practice [18].'),
      para('The change that matters most to you came on the drug side, and it came from Health Canada, not the CFIA. Since December 1, 2018, every medically important antibiotic used in animals has needed a veterinary prescription, so you can no longer buy these products over the counter [19]. To write that prescription, your veterinarian needs a genuine working relationship with your farm, one built on real knowledge of your flock and how you manage it. From there the responsibility is theirs: pick the right drug for the problem, set the withdrawal time so no residues reach the meat or eggs you ship, and keep antibiotic use to real need rather than routine. That professional judgment is the backstop behind the industry antimicrobial strategy above, and it is why your medication records and your veterinarian direction always go together.'),
      para('Sometimes the right treatment means using a drug in a way its label does not cover, what is called extra-label use, and the usual withdrawal time no longer fits. Canada has a dedicated resource for exactly those cases. The Canadian global Food Animal Residue Avoidance Databank, or CgFARAD, gives licensed veterinarians a science-based withdrawal interval so your birds and eggs still clear residue limits before they ship [20]. It is a service your veterinarian uses on your behalf, and it is one more reason the withdrawal time on your treatment record is a number you can trust.'),
    ],
  };
}
