...
function buildSection7() {
  return {
    ...
    children: [
      ...
      ...image(figBuf('fig 7.1 new.jpg'), 'Figure 7.1: The BC chicken authority hierarchy, from the provincial Act down to the farm that holds the quota. Source: CPC Short Courses.'),
