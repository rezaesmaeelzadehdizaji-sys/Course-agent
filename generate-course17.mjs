...
function buildSection5() {
  return {
    ...
    children: [
      ...
      para('It is worth knowing what each of those claims actually commits you to, because they are not the same job. Organic is the heaviest lift. It runs under the Canada Organic Regime in Part 13 of the Safe Food for Canadians Regulations, and it takes third-party certification, certified organic feed, no antibiotics, and outdoor access for the birds [29]. Raised without antibiotics is narrower. There is no special feed to buy, but the birds cannot have received an antibiotic by any route, from egg injection at the hatchery through to the plant [30]. Vaccines are fine, and so are chemical coccidiostats such as amprolium and decoquinate. Ionophores are not. They count as antibiotics for this purpose and they will cost you the claim [30].'),
      para('One point to be clear about. None of this means leaving a sick flock untreated. If your birds need antibiotics, you treat them, and that call belongs with your veterinarian. What you lose is the claim on those birds, not the right to look after them [30].'),
...
function buildSection7() {
  return {
    ...
    children: [
      ...
      para('Provinces also carry their own animal welfare law, and this is where the welfare Codes from Section 3 gain real legal teeth. In British Columbia, the Prevention of Cruelty to Animals Act, the PCA Act, is the main law protecting farm animals from distress [35]. It is enforced by the BC SPCA, the British Columbia Society for the Prevention of Cruelty to Animals, whose officers are appointed as special provincial constables for that purpose [36]. Here is the part that matters most for a farmer: under the PCA Act, following the generally accepted NFACC Code of Practice is recognized as a defense against a charge of causing distress. In plain terms, raising your birds to the Code is not just good practice. It is your legal protection.'),
      para('The same multi-board structure covers every poultry type in the province. Alongside the BC Chicken Marketing Board sit BC Egg, the British Columbia Broiler Hatching Egg Commission, and the BC Turkey Marketing Board, each regulating its own sector under the same provincial Act and the same supervisory board [37]. The exact board names and some details differ from province to province, but the shape is the same everywhere: a provincial marketing law, a supervisory body, a commodity board for each poultry type, and a provincial welfare law backing the national Codes. Learn the pattern in one province and you can find your way around any of them.'),
    ],
  };
}
