...
function buildSection1() {
  return {
    ...
    children: [
      ...
      bullet([{ text: 'Agriculture and Agri-Food Canada (AAFC): ', bold: true }, { text: 'the federal farming department. Sets agricultural policy, funds research and risk-management programs, handles trade, and is the department responsible for the national supply management system [1].' }]),
...
async function main() {
  ...
  const entriesWithAnchor = [
    ...
    { lvl: 1, text: 'Section 6: Record-Keeping, Audits, and Compliance', page: 16 },
    { lvl: 2, text: '6.1 What Records Need to Be Maintained', page: 16 },
    { lvl: 2, text: '6.2 How Audits, Inspections, and Compliance Checks Are Carried Out', page: 17 },
    { lvl: 1, text: 'Section 7: Provincial Variation in British Columbia', page: 18 },
    { lvl: 2, text: '7.1 How Provincial Regulations Overlay Federal and Industry Rules', page: 18 },
    ...
    { lvl: 2, text: '8.2 The Advantages: Market Access, Consumer Trust, and Better Birds', page: 19 },
