...
function buildSection1() {
  return {
    ...
    children: [
      ...
      para('Start with the federal government, because it sets the rules everyone else builds on. Two bodies matter most. Agriculture and Agri-Food Canada is the federal department responsible for farming policy, research, and trade. It sets the broader agricultural policy environment that supply management operates within, and the Farm Products Council of Canada, which oversees the system directly, sits within its portfolio [1]. Alongside it sits the Canadian Food Inspection Agency, usually just called the CFIA. The CFIA is the federal regulator for food safety, animal health, and plant health, and for poultry that means it runs the rules on meat and egg inspection, humane transport, on-farm biosecurity standards, and the control of serious animal diseases [2].'),
      ...
      bullet([{ text: 'Agriculture and Agri-Food Canada (AAFC): ', bold: true }, { text: 'the federal farming department. Sets agricultural policy, funds research and risk-management programs, handles trade, and sets the broader policy environment that supply management operates within [1].' }]),
...
function buildSection2() {
  return {
    ...
    children: [
      ...
      para('One more point worth knowing: going over your quota is not free. Boards give you a small tolerance, but past that, over-quota production carries a penalty, and that is the mechanism that keeps everyone production matched to the market. Section 7.1 shows exactly how that penalty works, and the numbers, in British Columbia.'),
    ],
  };
}
...
function buildSection4() {
  return {
    ...
    children: [
      ...
      para('Figure 4.1 walks through the sequence. The heart of it is what you do the moment you suspect trouble: call your veterinarian, report to the CFIA, and hold everything in place while you wait, with no birds, eggs, or equipment leaving the farm. If a disease like avian influenza is confirmed, the CFIA response can run to quarantine, humane depopulation, and cleaning and disinfection, with federal compensation for animals ordered destroyed [16]. Reporting fast is not only the law. It is the single best thing you can do to protect your own flock and the farms around you. For the clinical picture behind these diseases and how to recognize them, see Course 7 (Common Poultry Diseases) in this series.'),
...
function buildSection6() {
  return {
    ...
    children: [
      ...
      ...image(figBuf('Slide4.JPG'), 'Figure 6.1: The core records every poultry farm keeps, grouped by type. The paperwork an auditor wants is the same paperwork that runs a good barn. Source: CPC Short Courses.'),
...
function buildSection7() {
  return {
    ...
    children: [
      ...
      new Paragraph({
        children: [new TextRun({ text: 'Table 7.1: The most you can raise without quota in BC and Ontario, by poultry sector. Above these limits you need quota. Source: BC and Ontario poultry marketing boards.', italics: true, color: '555555', size: 20, font: 'Calibri' })],
...
function buildReferencesSection() {
  return {
    ...
    children: [
      ...
      numberedRef('National Farm Animal Care Council. Code of Practice for the Care and Handling of Hatching Eggs, Breeders, Chickens, and Turkeys. Ottawa: NFACC; 2016 [cited 2026 Aug]. Available from: nfacc.ca'),
      numberedRef('National Farm Animal Care Council. Code of Practice for the Care and Handling of Pullets and Laying Hens. Ottawa: NFACC; 2017 [cited 2026 Aug]. Available from: nfacc.ca'),
...
async function main() {
  ...
  const entriesWithAnchor = [
    ...
    { lvl: 1, text: 'Section 2: Supply Management and Market Regulation', page: 8 },
    { lvl: 2, text: '2.1 How Supply Management Works for Poultry and Eggs', page: 8 },
    { lvl: 2, text: '2.2 Relevant Legislation and Organizational Oversight', page: 9 },
    { lvl: 1, text: 'Section 3: Animal Welfare and Care Standards', page: 10 },
    { lvl: 2, text: '3.1 Codes of Practice for the Care and Handling of Poultry', page: 10 },
    { lvl: 2, text: '3.2 Mandated Housing, Environment, Feeding, Transport, and Handling Standards', page: 10 },
    { lvl: 1, text: 'Section 4: Biosecurity, Animal Health, and Disease Prevention', page: 12 },
    { lvl: 2, text: '4.1 On-Farm Biosecurity Standards and Disease-Control Regulations', page: 12 },
    { lvl: 2, text: '4.2 Reportable Diseases and Your Legal Duty to Report', page: 12 },
    { lvl: 2, text: '4.3 Regulatory Requirements for Hatcheries, Breeders, and Supply Flocks', page: 13 },
    { lvl: 2, text: '4.4 Who Oversees Your Veterinarian', page: 14 },
    { lvl: 1, text: 'Section 5: Food Safety, Processing, and Product Standards', page: 16 },
    { lvl: 2, text: '5.1 Regulation of Poultry Products for Slaughter, Processing, and Sale', page: 16 },
    { lvl: 2, text: '5.2 Standards for Labeling, Slaughter, Pathogen Control, and Processing', page: 17 },
    { lvl: 1, text: 'Section 6: Record-Keeping, Audits, and Compliance', page: 19 },
    { lvl: 2, text: '6.1 What Records Need to Be Maintained', page: 19 },
    { lvl: 2, text: '6.2 How Audits, Inspections, and Compliance Checks Are Carried Out', page: 19 },
    { lvl: 1, text: 'Section 7: Provincial Variation in British Columbia', page: 21 },
    { lvl: 2, text: '7.1 How Provincial Regulations Overlay Federal and Industry Rules', page: 21 },
    { lvl: 2, text: '7.2 The Role of Provincial Acts, Marketing Boards, and Welfare Laws', page: 22 },
