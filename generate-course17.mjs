...
function buildSection7() {
  return {
    ...
    children: [
      ...
      para('One detail worth pinning down is exactly where the line sits between a small lot you can run without quota and a commercial operation that needs it. That line is a bird count, and it differs by province and by sector. As of July 2026, here is the most you can raise before you need quota in British Columbia and in Ontario, side by side [28]:'),
...
function buildReferencesSection() {
  return {
    ...
    children: [
      ...
      numberedRef('Agriculture and Agri-Food Canada. About Agriculture and Agri-Food Canada: mandate and role. Ottawa: Government of Canada; [cited 2026 Jul]. Available from: agriculture.canada.ca'),
      numberedRef('Canadian Food Inspection Agency. About the CFIA: mandate, food safety, and animal health. Ottawa: Government of Canada; [cited 2026 Jul]. Available from: inspection.canada.ca'),
      numberedRef('Farm Products Council of Canada. Who we are and what we do. Ottawa: Government of Canada; [cited 2026 Jul]. Available from: canada.ca/en/farm-products-council'),
      numberedRef('Library of Parliament. Canada’s Supply Management System (Background paper, publication 2018-42-E). Ottawa: Library of Parliament; [cited 2026 Jul]. Available from: lop.parl.ca'),
      numberedRef('Farm Products Agencies Act (RSC 1985, c. F-4). Ottawa: Justice Laws Website, Government of Canada; [cited 2026 Jul]. Available from: laws-lois.justice.gc.ca'),
      numberedRef('National Farm Animal Care Council. Code of Practice for the Care and Handling of Hatching Eggs, Breeders, Chickens, and Turkeys. Ottawa: NFACC; 2016 [cited 2026 Jul]. Available from: nfacc.ca'),
      numberedRef('National Farm Animal Care Council. Code of Practice for the Care and Handling of Pullets and Laying Hens. Ottawa: NFACC; 2017 [cited 2026 Jul]. Available from: nfacc.ca'),
      numberedRef('Chicken Farmers of Canada. Raised by a Canadian Farmer Animal Care Program. Ottawa: Chicken Farmers of Canada; [cited 2026 Jul]. Available from: chickenfarmers.ca'),
      numberedRef('Egg Farmers of Canada. Start Clean-Stay Clean and Animal Care Program. Ottawa: Egg Farmers of Canada; [cited 2026 Jul]. Available from: eggfarmers.ca'),
      numberedRef('Turkey Farmers of Canada. Flock Care Program and On-Farm Food Safety Program. Ottawa: Turkey Farmers of Canada; [cited 2026 Jul]. Available from: turkeyfarmersofcanada.ca'),
      numberedRef('Canadian Food Inspection Agency. Health of Animals Regulations Part XII: Transport of Animals. Ottawa: CFIA; [cited 2026 Jul]. Available from: inspection.canada.ca'),
      numberedRef('Canadian Food Inspection Agency. National Avian On-Farm Biosecurity Standard. Ottawa: CFIA; [cited 2026 Jul]. Available from: inspection.canada.ca'),
      numberedRef('Chicken Farmers of Canada. Raised by a Canadian Farmer On-Farm Food Safety Program. Ottawa: Chicken Farmers of Canada; [cited 2026 Jul]. Available from: chickenfarmers.ca'),
      numberedRef('Spotting Disease Early [Flock Management Guide]. CPC Learning Centre. Available from: cpclearningcentre.ca'),
      numberedRef('Health of Animals Act (SC 1990, c. 21). Ottawa: Justice Laws Website, Government of Canada; [cited 2026 Jul]. Available from: laws-lois.justice.gc.ca'),
      numberedRef('Canadian Food Inspection Agency. Fact sheet: avian influenza (reportable disease). Ottawa: CFIA; [cited 2026 Jul]. Available from: inspection.canada.ca'),
      numberedRef('Chicken Farmers of Canada. Responsible Antimicrobial Use Strategy. Ottawa: Chicken Farmers of Canada; [cited 2026 Jul]. Available from: chickenfarmers.ca'),
      ...
      numberedRef('Canadian Food Inspection Agency, Canadian Centre for Veterinary Biologics. Regulation of veterinary biologics in Canada (licensing of vaccines under the Health of Animals Act). Ottawa: CFIA; [cited 2026 Jul]. Available from: inspection.canada.ca'),
      numberedRef('Canadian Veterinary Medical Association. Provincial and territorial veterinary regulatory bodies; veterinary-client-patient relationship (VCPR). Ottawa: CVMA; [cited 2026 Jul]. Available from: canadianveterinarians.net'),
      numberedRef('Health Canada. Responsible use of medically important antimicrobials in animals (veterinary prescription requirement effective 2018 Dec 1). Ottawa: Government of Canada; [cited 2026 Jul]. Available from: canada.ca/en/health-canada'),
      numberedRef('Canadian global Food Animal Residue Avoidance Databank (CgFARAD). Withdrawal interval recommendations for extra-label drug use in food animals. Saskatoon: University of Saskatchewan; [cited 2026 Jul]. Available from: cgfarad.ca'),
      numberedRef('Safe Food for Canadians Act (SC 2012, c. 24). Ottawa: Justice Laws Website, Government of Canada; [cited 2026 Jul]. Available from: laws-lois.justice.gc.ca'),
      numberedRef('Canadian Food Inspection Agency. Understanding the Safe Food for Canadians Regulations: a handbook for food businesses. Ottawa: CFIA; [cited 2026 Jul]. Available from: inspection.canada.ca'),
      ...
      numberedRef('British Columbia Chicken Marketing Board. Governance and our story; General Orders (over- and under-production rules). Abbotsford, BC: BCCMB; [cited 2026 Jul]. Available from: bcchicken.ca'),
      ...
      numberedRef('British Columbia Chicken Marketing Board. Small Lot Permit Program; BC Egg. Small lot and backyard flock guidelines; British Columbia Turkey Marketing Board. Direct Vendor (small lot) program; Chicken Farmers of Ontario. Family Food and Artisanal Chicken programs; Egg Farmers of Ontario. Small flock (99-hen) exemption; Turkey Farmers of Ontario. Small Scale Grower Program. BC and Ontario; [cited 2026 Jul]. Available from: bcchicken.ca; bcegg.com; bcturkey.com; ontariochicken.ca; eggfarmersofontario.ca; turkeyfarmers.on.ca'),
