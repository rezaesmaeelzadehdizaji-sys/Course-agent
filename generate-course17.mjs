...
function buildSection1() {
  return {
    ...
    children: [
      ...
      bullet([{ text: 'Agriculture and Agri-Food Canada (AAFC): ', bold: true }, { text: 'the federal farming department. Sets agricultural policy, funds research and risk-management programs, handles trade, and sets the broader policy environment that supply management operates within. The Farm Products Council of Canada, which oversees the system directly, is part of its portfolio [1].' }]),
...
function buildSection2() {
  return {
    ...
    children: [
      ...
      para('One more point worth knowing: going over your quota is not free. Boards allow a small tolerance, but beyond that you pay an overproduction levy on the extra birds, and the overage is deducted from your next allotment. Chasing volume you do not hold quota for ends up costing you, and that levy is the mechanism that keeps everyone production matched to the market. Section 7.1 shows the exact tolerance and how it works in British Columbia.'),
    ],
  };
}
