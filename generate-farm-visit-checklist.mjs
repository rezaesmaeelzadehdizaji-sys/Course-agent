...
C.push(readingsTable([
  ...
  ['Light intensity at bird level', 'First 7 days >=20 lux; check dark spots'],
  ['Photoperiod / dark period', 'After week 1 provide >=6 h dark per 24 h'],
...
C.push(refTable(['Parameter', 'Target guide'], [3400, 5960], [
  ...
  ['Light (first 7 days)', 'At least 20 lux; long day so chicks find feed and water'],
  ['Dark period (after week 1)', 'At least 6 hours dark per 24 hours'],
...
C.push(refTable(['Scale', 'Range', 'Quick meaning'], [2500, 1700, 5160], [
  ...
  ['Litter score', '1 to 4', '1 = dry and friable; 4 = wet, capped, or slick. Higher scores drive footpad and hock lesions.'],
