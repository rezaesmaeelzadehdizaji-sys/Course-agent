...
function buildBody() {
  ...
  return [
    ...
    bullet([{ text: 'Ocular form (grey eye):', bold: true }, { text: ' Lymphocytes infiltrate the iris and fade its normal orange-red color to a flat gray. The pupil turns irregular and off-center, the two eyes are often unequal, and vision fails partly or fully. Seen more in older birds [30].' }]),
