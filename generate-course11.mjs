  ...
  return [
    ...
    cocciTable(
      ...
      [
        ...
        ['E. brunetti', 'Lower small intestine, rectum', 'Hemorrhagic, necrotic mucosa in the lower gut. Watery bloody content. Mainly affects older birds (over 8 to 9 weeks), so it shows up in broiler breeders rather than young market broilers [19].', eBru],
    ...
    para('Leg problems in broilers cost the industry through mortality, reduced mobility, and downgrading at the plant. Three main conditions are identifiable at necropsy [23]:'),
    ...
    para('Egg yolk peritonitis is one of the most common causes of sporadic death in layers and breeder hens around peak production. The lesions are difficult to miss [24]:'),
    ...
    para([
      ...
      { text: ' (MS) are chronic respiratory and synovitis pathogens that cost the layer and breeder industry through reduced production, increased condemnation, and treatment costs rather than through acute mortality [27,28].' },
    ]),
    ...
    para('The liver dry matter in FLHS birds is at least 40% fat, which explains the friability [32]. These birds are often the heaviest in the flock. Management response: evaluate diet energy density, body weight targets, and whether feed restriction programs are being followed correctly.'),

    spacer(40),
    para([{ text: 'Calcium Deficiency and Cage Layer Fatigue', bold: true }]),
    para('Calcium deficiency in laying hens causes a progressive skeletal failure as bone calcium is mobilized to meet the demand for eggshell formation [33]. At necropsy:'),
