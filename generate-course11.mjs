...
function buildBody() {
  ...
  return [
    ...
    bullet([{ text: 'Eyes and head:', bold: true }, { text: ' Conjunctivitis with reddened, watery eyes, along with swelling around the eyes and head (periorbital edema). In severe velogenic cases you may also see hemorrhage in the conjunctiva and eye tissue.' }]),
    ...
    para('Blackhead has been re-emerging in recent years because there are no longer any approved drugs or vaccines to prevent or treat it, which keeps it a serious threat wherever turkeys are raised or share ground with chickens [48].'),
    pageBreak(),
