...
function buildBody() {
  ...
  return [
    ...
    para('When a laying hen runs short on calcium, her body pulls it out of her own bones to keep building eggshells. Over time the skeleton gives out [33]. At necropsy:'),
