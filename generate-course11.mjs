...
function buildBody() {
  ...
  return [
    ...
    para([
      ...
      { text: ' (MS) are slow, nagging infections rather than fast killers. They rarely cause a big die-off. What they cost you is steady: fewer eggs, more condemnations at the plant, and money spent on treatment [30,31].' },
    ]),
    ...
    para('MG and MS are often present together. PCR testing of tracheal or choanal swabs from live birds is the most sensitive diagnostic method, but the gross lesions at necropsy give you strong evidence to work with while you wait for lab results [30,31].'),

    h2('5.3  Viral Diseases'),
    para([{ text: "Marek's Disease", bold: true }]),
    para("Marek's is well controlled by hatchery vaccination in Canadian commercial flocks, so when it does appear it usually points to a vaccination failure rather than a new threat [32]. Marek's disease causes several distinct lesion patterns, and knowing which form you are dealing with matters for your vaccination audit:"),
    ...
    bullet([{ text: 'Ocular form (grey eye):', bold: true }, { text: ' Lymphocytes infiltrate the iris and fade its normal orange-red color to a flat gray. The pupil turns irregular and off-center, the two eyes are often unequal, and vision fails partly or fully. Seen more in older birds [33].' }]),
