  ...
  return [
    ...
    lesionTable(
      ...
      [
        ...
        ['Eye and iris', 'Clear iris (orange-red), round pupil', 'Gray, discolored iris with irregular pupil; swollen, inflamed conjunctiva', 'Marek\'s Disease (ocular), ILT (conjunctivitis)'],
