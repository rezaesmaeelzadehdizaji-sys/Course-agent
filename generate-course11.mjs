...
const tocEntries = [
  ...
  { lvl: 2, text: "5.4  Nutritional and Metabolic Issues", page: 33 },
  { lvl: 1, text: "6. Common Diseases in Ducks and Geese", page: 35 },
  { lvl: 2, text: "6.1  Viral Diseases", page: 35 },
  { lvl: 2, text: "6.2  Bacterial and Toxic Conditions", page: 36 },
  { lvl: 1, text: "7. Common Diseases in Turkeys", page: 38 },
  { lvl: 2, text: "7.1  Hemorrhagic Enteritis and Blackhead", page: 38 },
  { lvl: 1, text: "8. Cross-Species Disease Concerns", page: 39 },
  { lvl: 2, text: "8.1  Pigeon Paramyxovirus (PPMV-1)", page: 39 },
  { lvl: 1, text: "9. Necropsy Lesion Recognition by Body System", page: 40 },
  { lvl: 1, text: "10. Case Studies and Problem-Solving", page: 42 },
  { lvl: 2, text: "10.1  Case 1: Broiler Mortality Spike at 28 Days", page: 42 },
  { lvl: 2, text: "10.2  Case 2: Layer Flock with Production Drop and Deaths", page: 42 },
  { lvl: 2, text: "10.3  Case 3: Young Broiler Flock, Sudden Mortality at 3 Weeks", page: 43 },
  { lvl: 1, text: "11. Farmer-Friendly Diagnostic Pathway", page: 44 },
  { lvl: 2, text: "11.1  When to Submit Samples", page: 44 },
  { lvl: 2, text: "11.2  What to Tell the Veterinarian or Diagnostic Lab", page: 44 },
  { lvl: 2, text: "11.3  Using Necropsy Findings to Take Immediate Action", page: 45 },
  { lvl: 1, text: "Recommended Journals and Resources", page: 47 },
  { lvl: 1, text: "References", page: 48 },
];
